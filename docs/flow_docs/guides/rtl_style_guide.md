...
| Multiple Affixes           | -      | -             | multiple suffixes will not be separated with `_`. `n` should come first        |
...
***It is recommended to use symbolically named constants instead of raw numbers.***
