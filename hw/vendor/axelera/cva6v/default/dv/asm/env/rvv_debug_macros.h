...
#define PRINT_BUFFER_U64(A)                                                                   \
  do {                                                                                        \
    for (unsigned int i = 0; i < sizeof(A) / sizeof(uint64_t); i++) VPRINTF("%016x\n", A[i]); \
    MEMBARRIER;                                                                               \
  } while (0)

#define PRINT_BUFFER_U32(A)                                                                  \
  do {                                                                                       \
    for (unsigned int i = 0; i < sizeof(A) / sizeof(uint32_t); i++) VPRINTF("%08x\n", A[i]); \
    MEMBARRIER;                                                                              \
  } while (0)

#define PRINT_BUFFER_U16(A)                                                                  \
  do {                                                                                       \
    for (unsigned int i = 0; i < sizeof(A) / sizeof(uint16_t); i++) VPRINTF("%04x\n", A[i]); \
    MEMBARRIER;                                                                              \
  } while (0)

#define PRINT_BUFFER_U8(A)                                                                  \
  do {                                                                                      \
    for (unsigned int i = 0; i < sizeof(A) / sizeof(uint8_t); i++) VPRINTF("%02x\n", A[i]); \
    MEMBARRIER;                                                                             \
  } while (0)

#define PRINT_BUFFER_F64(A)                                                                                     \
  do {                                                                                                          \
    for (unsigned int i = 0; i < sizeof(A) / sizeof(double); i++) VPRINTF("Buffer Debug %d: %.17g\n", i, A[i]); \
    MEMBARRIER;                                                                                                 \
  } while (0)

#define PRINT_BUFFER_F32(A)                                                                                    \
  do {                                                                                                         \
    for (unsigned int i = 0; i < sizeof(A) / sizeof(float); i++) VPRINTF("Buffer Debug %d: %0.9g\n", i, A[i]); \
    MEMBARRIER;                                                                                                \
  } while (0)
