...
void TEST_CASE1(void) {
  ...
  asm volatile("vmfgt.vf v1, v2, %[A]" ::[A] "f"(fscalar_16));
  VSET(1, e16, m1);
  ...
  asm volatile("vmfgt.vf v2, v4, %[A]" ::[A] "f"(fscalar_32));
  VSET(1, e16, m1);
  VCMP_U16(2, v2, 0x0000);
};
...
void TEST_CASE2(void) {
  ...
  asm volatile("vmset.m v1");
  asm volatile("vmfgt.vf v1, v2, %[A], v0.t" ::[A] "f"(fscalar_16));
  VSET(1, e16, m1);
  VCMP_U16(4, v1, 0x555f);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vmset.m v2");
  asm volatile("vmfgt.vf v2, v4, %[A], v0.t" ::[A] "f"(fscalar_32));
  VSET(1, e16, m1);
  VCMP_U16(5, v2, 0x555d);
};
