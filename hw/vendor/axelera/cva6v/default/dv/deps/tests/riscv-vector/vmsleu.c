...
void TEST_CASE1(void) {
  ...
  VSET(16, e32, m2);
  VLOAD_32(v4, 50, 80, 2560, 19900, 12345, 80, 2560, 19900, 12345, 80, 2560, 19900, 12345, 80, 2560, 19900);
