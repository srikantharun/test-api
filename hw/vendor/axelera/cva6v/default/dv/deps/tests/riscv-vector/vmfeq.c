...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vmset.m v2");
  asm volatile("vmfeq.vv v2, v4, v6, v0.t");
  VSET(1, e16, m1);
  VCMP_U16(5, v2, 0xd555);
};
...
void TEST_CASE3(void) {
  ...
  asm volatile("vmset.m v2");
  asm volatile("vmfeq.vf v2, v4, %[A]" ::[A] "f"(fscalar_32));
  VSET(1, e16, m1);
  VCMP_U16(8, v2, 0x7ffe);
};
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vmset.m v2");
  asm volatile("vmfeq.vf v2, v4, %[A], v0.t" ::[A] "f"(fscalar_32));
  VSET(1, e16, m1);
  VCMP_U16(11, v2, 0x5557);
};
...
void TEST_CASE5(void) {
  ...
  asm volatile("vmfeq.vv v1, v2, v3");
  VSET(2, e32, m1);
  VCMP_U32(13, v1, 0xffff0001, 0xffffffff);
  ...
  asm volatile("vmfeq.vv v2, v4, v6");
  VSET(2, e32, m1);
  VCMP_U32(14, v2, 0xffff0004, 0xffffffff);
};
