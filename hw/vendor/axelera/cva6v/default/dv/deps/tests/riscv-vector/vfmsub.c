...
void TEST_CASE1(void) {
  ...
  //               -0.6509, -0.3940
  VLOAD_16(v2, 0x3975, 0x3a33, 0x27a5, 0x27a5, 0xb854, 0xb1f8, 0x3208, 0x25d8, 0xb854, 0x3216, 0xbb54, 0xb59e, 0xbb6e,
           0xbbf8, 0xb935, 0xb64e);
  //              -0.9048,  0.1698,  0.2411,  0.2411, -0.6147,  0.9580,  0.5117,
  //              0.8330, -0.6147,  0.5591,  0.7031, -0.1556,  0.2397,  0.8154,
  //              0.1646,  0.2693
  VLOAD_16(v3, 0xbb3d, 0x316f, 0x33b7, 0x33b7, 0xb8eb, 0x3baa, 0x3818, 0x3aaa, 0xb8eb, 0x3879, 0x39a0, 0xb0fb, 0x33ac,
           0x3a86, 0x3144, 0x344f);
  //              -0.2292,  0.7578, -0.7427, -0.7427,  0.1119,  0.2939, -0.2983,
  //              -0.3608,  0.1119, -0.5562, -0.0629, -0.1968, -0.8638, -0.2700,
  //              -0.7690,  0.4216
  VLOAD_16(v1, 0xb356, 0x3a10, 0xb9f1, 0xb9f1, 0x2f29, 0x34b4, 0xb4c6, 0xb5c6, 0x2f29, 0xb873, 0xac06, 0xb24c, 0xbae9,
           0xb452, 0xba27, 0x36bf);
  ...
  VCMP_U16(1, v1, 0x39fd, 0x36ae, 0xb436, 0xb436, 0x386f, 0xbc0d, 0xb88b, 0xbabb, 0x386f, 0xb952, 0xb92a, 0x3331,
           0x3880, 0xb85f, 0x3560, 0xb6f8);
  ...
  VLOAD_32(v4, 0xbf3edb83, 0xbe2b615c, 0xbdf3144a, 0xbf5bcdc4, 0xbf29508e, 0xbf2f11d2, 0xbee86538, 0xbe02add8,
           0xbf74deb9, 0x3f35f923, 0x3e77af49, 0x3c83dd45, 0xbf16b34c, 0xbf0d5ee8, 0xbf2c9690, 0xbd89bddf);
  ...
  VLOAD_32(v6, 0xbe333510, 0xbf50bc3a, 0xbea39d6f, 0x3e6916cc, 0x3efe4149, 0xbdc04bad, 0x3d6bd711, 0xbe0604f5,
           0xbf3afcf5, 0xbf4bef78, 0xbf77cffd, 0x3cf72932, 0x3f3524cb, 0xbeb64dd0, 0x3e38b39f, 0xbeb51bbc);
  ...
  VLOAD_32(v2, 0x3f6dc3b9, 0x3e3e2fab, 0xbed7cb1e, 0xbf4afb22, 0x3f68b8d9, 0x3d901ef6, 0x3d965009, 0x3e32552f,
           0xbf1eaa0e, 0xbd4a506e, 0x3f0fb6a5, 0xbf0419e2, 0xbf4e66a7, 0xbe9fe30c, 0x3f6a2cc3, 0x3f48c486);
  ...
  VCMP_U32(2, v2, 0xbf0475df, 0x3f48c717, 0x3ebd3a4c, 0x3ee80493, 0xbf8c85f3, 0x3d3b78f5, 0xbdba2584, 0x3dde85bc,
           0x3fa9608a, 0x3f42f27c, 0x3f8d4973, 0xbd1d9a4f, 0xbe6e9058, 0x3f074c92, 0xbf4c0cb5, 0x3e9a1a37);
};
...
void TEST_CASE2(void) {
  ...
  //               -0.6509, -0.3940
  VLOAD_16(v2, 0x3975, 0x3a33, 0x27a5, 0x27a5, 0xb854, 0xb1f8, 0x3208, 0x25d8, 0x39c6, 0x3216, 0xbb54, 0xb59e, 0xbb6e,
           0xbbf8, 0xb935, 0xb64e);
  //              -0.9048,  0.1698,  0.2411,  0.2411, -0.6147,  0.9580,  0.5117,
  //              0.8330, -0.8584,  0.5591,  0.7031, -0.1556,  0.2397,  0.8154,
  //              0.1646,  0.2693
  VLOAD_16(v3, 0xbb3d, 0x316f, 0x33b7, 0x33b7, 0xb8eb, 0x3baa, 0x3818, 0x3aaa, 0xbade, 0x3879, 0x39a0, 0xb0fb, 0x33ac,
           0x3a86, 0x3144, 0x344f);
  VLOAD_8(v0, 0xAA, 0xAA);
  //              -0.2292,  0.7578, -0.7427, -0.7427,  0.1119,  0.2939, -0.2983,
  //              -0.3608,  0.3169, -0.5562, -0.0629, -0.1968, -0.8638, -0.2700,
  //              -0.7690,  0.4216
  VLOAD_16(v1, 0xb356, 0x3a10, 0xb9f1, 0xb9f1, 0x2f29, 0x34b4, 0xb4c6, 0xb5c6, 0x3512, 0xb873, 0xac06, 0xb24c, 0xbae9,
           0xb452, 0xba27, 0x36bf);
  ...
  //              -0.7690, -0.4355
  VCMP_U16(4, v1, 0xb356, 0x36ae, 0xb9f1, 0xb436, 0x2f29, 0xbc0d, 0xb4c6, 0xbabb, 0x3512, 0xb952, 0xac06, 0x3331,
           0xbae9, 0xb85f, 0xba27, 0xb6f8);
  ...
  VCMP_U32(5, v2, 0x3f6dc3b9, 0x3f48c717, 0xbed7cb1e, 0x3ee80493, 0x3f68b8d9, 0x3d3b78f5, 0x3d965009, 0x3dde85bc,
           0xbf1eaa0e, 0x3f42f27c, 0x3f0fb6a5, 0xbd1d9a4f, 0xbf4e66a7, 0x3f074c92, 0x3f6a2cc3, 0x3e9a1a37);
};
...
void TEST_CASE3(void) {
  ...
  //               -0.8105,  0.0033
  VLOAD_16(v2, 0x3ad3, 0xb547, 0xb1ce, 0xb3a2, 0x3bf5, 0x393e, 0x3af8, 0xb91a, 0x36c2, 0xb1ce, 0x399f, 0x3490, 0x2b15,
           0x39e1, 0xba7c, 0x1abd);
  //              -0.2338, -0.2512,  0.0069,  0.0613, -0.1733,  0.8560, -0.2766,
  //              -0.0028, -0.1803,  0.0069,  0.7856, -0.0243, -0.1974,  0.6416,
  //              0.7109,  0.0817
  VLOAD_16(v1, 0xb37b, 0xb405, 0x1f06, 0x2bd8, 0xb18c, 0x3ad9, 0xb46d, 0x99d2, 0xb1c5, 0x1f06, 0x3a49, 0xa639, 0xb251,
           0x3922, 0x39b0, 0x2d3a);
  asm volatile("vfmsub.vf v1, %[A], v2" ::[A] "f"(fscalar_16));
  //              -0.8877,  0.2925,  0.1824,  0.2477, -1.0205, -0.5278, -0.9121,
  //              0.6372, -0.4492,  0.1824, -0.5854, -0.2888, -0.0847, -0.6392,
  //              0.9165,  0.0089
  VCMP_U16(7, v1, 0xbb1a, 0x34ae, 0x31d6, 0x33ed, 0xbc15, 0xb839, 0xbb4c, 0x3919, 0xb730, 0x31d6, 0xb8af, 0xb49f,
           0xad6c, 0xb91d, 0x3b55, 0x208b);
  ...
  VLOAD_32(v4, 0x3e9efadd, 0xbe0dc2e3, 0x3e6faaea, 0xbe9c641e, 0xbe93ddac, 0x3eecb745, 0xbf02d4be, 0xbdf13143,
           0xbecca444, 0x3f02ec66, 0x3f633341, 0xbe6474f6, 0x3f19e261, 0x3f15ac89, 0xbe128089, 0xbc95960e);
  ...
  VLOAD_32(v2, 0xbf049506, 0x3f45f5fd, 0xbf6263ee, 0x3ed13af8, 0xbf0129cf, 0x3e9dd5cc, 0xbe829371, 0x3d9e7424,
           0x3e52e7a6, 0xbeda48ab, 0x3f656ec5, 0x3d1ace01, 0x3f023fb0, 0x3f2dd0e6, 0xbe34e9c8, 0x3d8f0c42);
  ...
  VCMP_U32(8, v2, 0xbe79c546, 0x3d1fc94a, 0xbdf6765b, 0x3e817d07, 0x3eb514d5, 0xbf00814f, 0x3f0b39c8, 0x3ddcd18d,
           0x3ebf1529, 0xbee9c7b3, 0xbf8059aa, 0x3e5f7b10, 0xbf2aa1b0, 0xbf2c05eb, 0x3e29c388, 0x3c18073f);
};
...
void TEST_CASE4(void) {
  ...
  VLOAD_16(v1, 0xb37b, 0xb405, 0x1f06, 0x2bd8, 0xb18c, 0x3ad9, 0xb46d, 0x99d2, 0xb1c5, 0x1f06, 0x3a49, 0xa639, 0xb251,
           0x3922, 0x39b0, 0x2d3a);
  asm volatile("vfmsub.vf v1, %[A], v2, v0.t" ::[A] "f"(fscalar_16));
  //               -0.2338,  0.2925,  0.0069,  0.2477, -0.1733, -0.5278,
  //               -0.2766,  0.6372, -0.1803,  0.1824,  0.7856, -0.2888,
  //               -0.1974, -0.6392,  0.7109,  0.0089
  VCMP_U16(10, v1, 0xb37b, 0x34ae, 0x1f06, 0x33ed, 0xb18c, 0xb839, 0xb46d, 0x3919, 0xb1c5, 0x31d6, 0x3a49, 0xb49f,
           0xb251, 0xb91d, 0x39b0, 0x208b);
  ...
  VCMP_U32(11, v2, 0xbf049506, 0x3d1fc94a, 0xbf6263ee, 0x3e817d07, 0xbf0129cf, 0xbf00814f, 0xbe829371, 0x3ddcd18d,
           0x3e52e7a6, 0xbee9c7b3, 0x3f656ec5, 0x3e5f7b10, 0x3f023fb0, 0xbf2c05eb, 0xbe34e9c8, 0x3c18073f);
};
