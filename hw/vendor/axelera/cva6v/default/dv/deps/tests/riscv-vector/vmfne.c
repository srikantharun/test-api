...
void TEST_CASE3(void) {
  ...
  asm volatile("vmset.m v2");
  asm volatile("vmfne.vf v2, v4, %[A]" ::[A] "f"(fscalar_32));
  VSET(1, e16, m1);
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vmset.m v2");
  asm volatile("vmfne.vf v2, v4, %[A], v0.t" ::[A] "f"(fscalar_32));
  VSET(1, e16, m1);
  VCMP_U16(11, v2, 0xfffd);
};
...
void TEST_CASE5(void) {
  // Fill 64-bits with 1
  VSET(2, e32, m1);
  VLOAD_32(v1, 0xffffffff, 0xffffffff);
  ...
  //               0.0987,  0.1777,  0.3047,  0.2330, -0.3467, -0.4153,  0.7080,
  //               0.3142, -0.9492
  VLOAD_16(v3, 0x33ca, 0x2b8c, 0x3a13, 0xb949, 0xb79d, 0x3ad3, 0x29cc, 0x2e51, 0x31b0, 0x34e0, 0x3375, 0xb58c, 0xb6a5,
           0x39aa, 0x3041, 0xbb98);
  asm volatile("vmset.m v1");
  asm volatile("vmfne.vv v1, v2, v3");
  VSET(2, e32, m1);
  VCMP_U32(13, v1, 0xfffffffe, 0xffffffff);

  // Fill 64-bits with 1
  VSET(2, e32, m1);
  VLOAD_32(v2, 0xffffffff, 0xffffffff);
  // Perform vmfne.vv on 16 different elements, and then check that the last (64
  // - 16 = 48) bits were not overwritten with zeroes
  VSET(16, e32, m2);
  ...
  //              -0.30920035, -0.31596854, -0.92116749,  0.51336122,
  //              0.22002794,  0.48599416,  0.69166088,  0.85755372
  VLOAD_32(v4, 0x70000000, 0xffffffff, 0xbeb162ab, 0xbd7edebf, 0x3f75db3c, 0xbf4f6872, 0xbf3180f6, 0x3f3464fe,
           0xbe9e4f82, 0xbea1c6a1, 0xbf6bd1a2, 0x3f036ba4, 0x3e614f01, 0x3ef8d43a, 0x3f3110b0, 0x3f5b88a4);
  //               0.79994357,        sNaN, -0.34645590, -0.81853813,
  //               0.24656086, -0.71423489, -0.44735566, -0.25510681,
  //               -0.94378990, -0.30138883,  0.19188073, -0.29310879,
  //               -0.22981364, -0.58626360, -0.80913633, -0.00670803
  VLOAD_32(v6, 0x80000000, 0xffffffff, 0xbeb162ab, 0xbf518bb7, 0x3e7c7a73, 0xbf36d819, 0xbee50bcd, 0xbe829d5c,
           0xbf719c37, 0xbe9a4fa3, 0x3e447c62, 0xbe96125b, 0xbe6b5444, 0xbf16155f, 0xbf4f238f, 0xbbdbcefe);
  asm volatile("vmset.m v2");
  asm volatile("vmfne.vv v2, v4, v6");
  VSET(2, e32, m1);
  VCMP_U32(14, v2, 0xfffffffb, 0xffffffff);
};
...
void TEST_CASE6(void) {
  ...
  //               0.1659,  0.1659
  VLOAD_16(v2, 0x33ca, 0x39d4, 0x39cb, 0xb449, 0x1975, 0xb9b1, 0x3af6, 0x3af6, 0xb8a1, 0xb6c4, 0x3993, 0x3993, 0x39c6,
           0xb48c, 0x314f, 0x314f);
  //               0.2434,  0.7285, -0.2678, -0.2678,  0.0027, -0.7114,  0.2622,
  //               0.2622, -0.5786, -0.4229,  0.5981,  0.5981,  0.7217, -0.2842,
  //               0.1328,  0.1328
  VLOAD_16(v3, 0x33ca, 0x39d4, 0xb449, 0x39cb, 0x1975, 0xb9b1, 0x3432, 0x3432, 0xb8a1, 0xb6c4, 0x38c9, 0x38c9, 0x39c6,
           0xb48c, 0x3040, 0x3040);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vmfne.vv v0, v2, v3, v0.t");
  VSET(1, e16, m1);
  VCMP_U16(16, v0, 0xdddd);
  ...
  VLOAD_32(v6, 0x00000000, 0x3dcb7174, 0x3ec9be30, 0xbf518bb7, 0x3f75db3c, 0xbf4f6872, 0xbee50bcd, 0xbe829d5c,
           0xbe9e4f82, 0xbea1c6a1, 0x3e447c62, 0xbe96125b, 0x3e614f01, 0x3ef8d43a, 0xbf4f238f, 0xbe9a4fa3);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vmfne.vv v0, v4, v6, v0.t");
  VSET(1, e16, m1);
  VCMP_U16(17, v0, 0xdddd);
};
...
void TEST_CASE7(void) {
  ...
  VSET(16, e16, m1);
  CHECK_FFLAGS(0);
  VLOAD_16(v2, qNaNh, qNaNh, 0x39cb, qNaNh, 0x1975, 0xb9b1, 0x3af6, 0x3af6, 0xb8a1, 0xb6c4, 0x3993, 0x3993, qNaNh,
           0xb48c, qNaNh, qNaNh);
  VLOAD_16(v3, 0x33ca, qNaNh, qNaNh, 0x39cb, 0x1975, 0xb9b1, 0x3432, 0x3432, 0xb8a1, 0xb6c4, 0x38c9, 0x38c9, 0x39c6,
           qNaNh, qNaNh, 0x3040);
  VLOAD_8(v0, 0xAA, 0xAA);
  ...
  VSET(16, e32, m2);
  VLOAD_32(v4, 0x3f75db3c, qNaNf, qNaNf, qNaNf, 0x3f75db3c, 0xbf4f6872, 0xbf3180f6, 0x3f3464fe, 0xbe9e4f82, 0xbea1c6a1,
           0xbf6bd1a2, 0x3f036ba4, qNaNf, qNaNf, 0x3f3110b0, qNaNf);
  VLOAD_32(v6, 0x3f75db3c, 0x3dcb7174, qNaNf, 0xbf518bb7, 0x3f75db3c, 0xbf4f6872, 0xbee50bcd, 0xbe829d5c, 0xbe9e4f82,
           0xbea1c6a1, 0x3e447c62, 0xbe96125b, qNaNf, 0x3ef8d43a, qNaNf, qNaNf);
  VLOAD_8(v0, 0xAA, 0xAA);
  asm volatile("vmset.m v0");
  ...
  VSET(16, e32, m2);
  VLOAD_32(v4, 0x3f75db3c, sNaNf, sNaNf, qNaNf, 0x3f75db3c, 0xbf4f6872, 0xbf3180f6, 0x3f3464fe, 0xbe9e4f82, 0xbea1c6a1,
           0xbf6bd1a2, 0x3f036ba4, qNaNf, qNaNf, 0x3f3110b0, qNaNf);
  VLOAD_32(v6, 0x3f75db3c, 0x3dcb7174, qNaNf, 0xbf518bb7, 0x3f75db3c, 0xbf4f6872, 0xbee50bcd, 0xbe829d5c, 0xbe9e4f82,
           0xbea1c6a1, 0x3e447c62, 0xbe96125b, qNaNf, 0x3ef8d43a, qNaNf, qNaNf);
  VLOAD_8(v0, 0xAA, 0xAA);
