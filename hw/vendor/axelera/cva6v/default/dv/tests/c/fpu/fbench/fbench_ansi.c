...
const static float testcase[4][4] = {
...
int main()
{
      ...
      //   }
        ...
        gcc_warning_martinet = fgets(tbfr, sizeof tbfr);
        if (gcc_warning_martinet != NULL) {
           // Use the variable in some way
           printf("%s", gcc_warning_martinet); // Example usage
        }
        #endif
        ...
        gcc_warning_martinet = fgets(tbfr, sizeof tbfr);
        #endif
        gcc_warning_martinet++;     /* Purely to evade GCC -Wall warning */
