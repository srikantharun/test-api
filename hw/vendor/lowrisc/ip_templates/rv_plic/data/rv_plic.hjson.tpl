...
% if csr_bus_protocol == "axi":
    { name:"AXI_AW",   type:"int", default:"${axi_addr_width}"},
    { name:"AXI_IDW",  type:"int", default:"${axi_id_width}"},
    { name:"AXI_LENW", type:"int", default:"${axi_len_width}"}
% endif
  ],
...
% endfor
% for i in range(target):
    { skipto: "${"0x{:x}".format(0x00003000  + i * 0x1000)}" }
    { name: "THRESHOLD${i}",
