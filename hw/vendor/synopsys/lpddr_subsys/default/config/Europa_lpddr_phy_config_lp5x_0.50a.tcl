...
#            was used to capture the coreConsultant workspace 'lpddr5x_phy_0_50'.
...
create_workspace -name lpddr5x_phy_0_50 -installation /data/foundry/LIB/synopsys/dwc_ap_lpddr5x_phy_sssf5a/Latest/installed_coreKit/2.30a
