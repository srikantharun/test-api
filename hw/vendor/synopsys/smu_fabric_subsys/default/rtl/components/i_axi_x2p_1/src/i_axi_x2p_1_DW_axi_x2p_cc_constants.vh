...
// Revision: $Id: //dwh/DW_ocb/DW_axi_x2p/axi_dev_br/src/DW_axi_x2p_cc_constants.vh#23 $ 
*/
...
//==============================================================================
`ifndef __GUARD__DW_AXI_X2P_CC_CONSTANTS__VH__
...
// Values:       32, ..., 64
// 
// Address bus width of the AXI system to which the bridge is attached as an AXI subordinate. The legal values comprise the 
// full range from 32 bits to 64 bits. The full range is used for the psel select signals, but only the lower 32 bits are 
// passed on to paddr.
`define X2P_AXI_AW 40
...
// 
// Read and write ID width of the AXI system to which the bridge is attached as an AXI subordinate.
...
// 
// Read and write data bus width of the AXI system to which the bridge is attached as an AXI subordinate. Data bus width 
// for the AXI subordinate interface must be greater than or equal to that of the APB requester interface.
`define X2P_AXI_DW 64
...
// Values:       4 5 6 7 8
// 
// Width used for the AWLEN and ARLEN burst length field.
...
// 
// Data bus endianness of the AXI system to which the bridge is attached as an AXI subordinate. 
...
// Values:       32
// 
// Address bus width of the APB system to which the bridge is attached as an APB requester.
...
// Values:       8 16 32
// 
// Read and write data bus width of the APB system to which the bridge is attached as an APB requester. This width must be 
...
//  Interface. 
//  - False (0) - DW_axi_x2p generates an error response for sparse transfers. 
...
// Values:       0, ..., 16
// 
// Number of AXI Subordinate Ports.
...
// 
// Specifies the relationship between aclk and pclk. The AXI subordinate interface is clocked by aclk; the APB requester 
// interface is clocked by pclk.  
...
// 
// Start address for APB Completer i. Following are the default values: 
...
`define X2P_START_PADDR_S0 64'h0000000002060000
...
// 
// End address for APB Completer i. Following are the default values: 
...
`define X2P_END_PADDR_S0 64'h000000000206ffff
...
// Values:       false (0), true (1)
// 
// AMBA 3 support for APB completer. Completer 0 has the additional ports PREADY and PSLVERR according to the AMBA3 
// specification.
`define X2P_IS_APB3_S0 0


// Name:         APB_INTERFACE_TYPE_SLAVE_S0
// Default:      APB2 (X2P_IS_APB3_S0)
// Values:       APB2 (0), APB3 (1), APB4 (2)
// 
// Select between AMBA 4 APB Completer (APB4), AMBA 3 APB Completer (APB3), and AMBA 2 APB Completer (APB2) for Completer 
// i. 
// If AMBA 3 APB Completer is selected, the additional ports PREADY and PSLVERR are included. 
// If AMBA 4 APB Completer is selected, the additional ports PSTRB and PPROT are included.
`define APB_INTERFACE_TYPE_SLAVE_S0 2

//Creates a define for enabling APB3 in Completer 0
...
// 
// Start address for APB Completer 1. 
//  
...
// Enabled:      X2P_NUM_APB_SLAVES>1
// 
// End address for APB Completer 1. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>1
// 
// Completer 1 has the additional ports PREADY and PSLVERR 
// according to the AMBA3 specification.
`define X2P_IS_APB3_S1 0


// Name:         APB_INTERFACE_TYPE_SLAVE_S1
// Default:      APB2 (X2P_IS_APB3_S1)
// Values:       APB2 (0), APB3 (1), APB4 (2)
// Enabled:      X2P_NUM_APB_SLAVES>1
// 
// Select between AMBA 4 APB Completer (APB4), AMBA 3 APB Completer (APB3), and AMBA 2 APB completer (APB2) for Completer 
...
// If AMBA 3 APB Completer is selected, the additional ports PREADY and PSLVERR are included. 
// If AMBA 4 APB Completer is selected, the additional ports PSTRB and PPROT are included.
`define APB_INTERFACE_TYPE_SLAVE_S1 0

//Creates a define for enabling APB3 in Completer 1 
...
// 
// Start address for APB Completer 2. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>2
// 
// End address for APB Completer 2. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>2
// 
// Completer 2 has the additional ports PREADY and PSLVERR 
// according to the AMBA3 specification.
`define X2P_IS_APB3_S2 0


// Name:         APB_INTERFACE_TYPE_SLAVE_S2
// Default:      APB2 (X2P_IS_APB3_S2)
// Values:       APB2 (0), APB3 (1), APB4 (2)
// Enabled:      X2P_NUM_APB_SLAVES>2
// 
// Select between AMBA 4 APB completer (APB4), AMBA 3 APB completer (APB3), and AMBA 2 APB completer (APB2) for Completer 
...
// If AMBA 3 APB Completer is selected, the additional ports PREADY and PSLVERR are included. 
// If AMBA 4 APB Completer is selected, the additional ports PSTRB and PPROT are included.
`define APB_INTERFACE_TYPE_SLAVE_S2 0

//Creates a define for enabling APB3 in Completer 2
...
// 
// Start address for APB Completer 3. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>3
// 
// End address for APB Completer 3. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>3
// 
// Completer 3 has the additional ports PREADY and PSLVERR 
// according to the AMBA3 specification.
`define X2P_IS_APB3_S3 0


// Name:         APB_INTERFACE_TYPE_SLAVE_S3
// Default:      APB2 (X2P_IS_APB3_S3)
// Values:       APB2 (0), APB3 (1), APB4 (2)
// Enabled:      X2P_NUM_APB_SLAVES>3
// 
// Select between AMBA 4 APB completer (APB4), AMBA 3 APB completer (APB3), and AMBA 2 APB completer (APB2) for Completer 
...
// If AMBA 3 APB Completer is selected, the additional ports PREADY and PSLVERR are included. 
// If AMBA 4 APB Completer is selected, the additional ports PSTRB and PPROT are included.
`define APB_INTERFACE_TYPE_SLAVE_S3 0

//Creates a define for enabling APB3 in Completer 3
...
// 
// Start address for APB Completer 4. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>4
// 
// End address for APB Completer 4. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>4
// 
// Completer 4 has the additional ports PREADY and PSLVERR 
// according to the AMBA3 specification.
`define X2P_IS_APB3_S4 0


// Name:         APB_INTERFACE_TYPE_SLAVE_S4
// Default:      APB2 (X2P_IS_APB3_S4)
// Values:       APB2 (0), APB3 (1), APB4 (2)
// Enabled:      X2P_NUM_APB_SLAVES>4
// 
// Select between AMBA 4 APB completer (APB4), AMBA 3 APB completer (APB3), and AMBA 2 APB completer (APB2) for Completer 
...
// If AMBA 3 APB Completer is selected, the additional ports PREADY and PSLVERR are included. 
// If AMBA 4 APB Completer is selected, the additional ports PSTRB and PPROT are included.
`define APB_INTERFACE_TYPE_SLAVE_S4 0

//Creates a define for enabling APB3 in Completer 4
...
// 
// Start address for APB Completer 5. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>5
// 
// End address for APB Completer 5. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>5
// 
// Completer 5 has the additional ports PREADY and PSLVERR 
// according to the AMBA3 specification.
`define X2P_IS_APB3_S5 0


// Name:         APB_INTERFACE_TYPE_SLAVE_S5
// Default:      APB2 (X2P_IS_APB3_S5)
// Values:       APB2 (0), APB3 (1), APB4 (2)
// Enabled:      X2P_NUM_APB_SLAVES>5
// 
// Select between AMBA 4 APB completer (APB4), AMBA 3 APB completer (APB3), and AMBA 2 APB completer (APB2) for Completer 
...
// If AMBA 3 APB Completer is selected, the additional ports PREADY and PSLVERR are included. 
// If AMBA 4 APB Completer is selected, the additional ports PSTRB and PPROT are included.
`define APB_INTERFACE_TYPE_SLAVE_S5 0

//Creates a define for enabling APB3 in Completer 5
...
// 
// Start address for APB Completer 6. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>6
// 
// End address for APB Completer 6. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>6
// 
// Completer 6 has the additional ports PREADY and PSLVERR 
// according to the AMBA3 specification.
`define X2P_IS_APB3_S6 0


// Name:         APB_INTERFACE_TYPE_SLAVE_S6
// Default:      APB2 (X2P_IS_APB3_S6)
// Values:       APB2 (0), APB3 (1), APB4 (2)
// Enabled:      X2P_NUM_APB_SLAVES>6
// 
// Select between AMBA 4 APB completer (APB4), AMBA 3 APB completer (APB3), and AMBA 2 APB completer (APB2) for Completer 
...
// If AMBA 3 APB Completer is selected, the additional ports PREADY and PSLVERR are included. 
// If AMBA 4 APB Completer is selected, the additional ports PSTRB and PPROT are included.
`define APB_INTERFACE_TYPE_SLAVE_S6 0

//Creates a define for enabling APB3 in Completer 6
...
// 
// Start address for APB Completer 7. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>7
// 
// End address for APB Completer 7. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>7
// 
// Completer 7 has the additional ports PREADY and PSLVERR 
// according to the AMBA3 specification.
`define X2P_IS_APB3_S7 0


// Name:         APB_INTERFACE_TYPE_SLAVE_S7
// Default:      APB2 (X2P_IS_APB3_S7)
// Values:       APB2 (0), APB3 (1), APB4 (2)
// Enabled:      X2P_NUM_APB_SLAVES>7
// 
// Select between AMBA 4 APB completer (APB4), AMBA 3 APB completer (APB3), and AMBA 2 APB completer (APB2) for Completer 
...
// If AMBA 3 APB Completer is selected, the additional ports PREADY and PSLVERR are included. 
// If AMBA 4 APB Completer is selected, the additional ports PSTRB and PPROT are included.
`define APB_INTERFACE_TYPE_SLAVE_S7 0

//Creates a define for enabling APB3 in Completer 7
...
// 
// Start address for APB Completer 8. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>8
// 
// End address for APB Completer 8. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>8
// 
// Completer 8 has the additional ports PREADY and PSLVERR 
// according to the AMBA3 specification.
`define X2P_IS_APB3_S8 0


// Name:         APB_INTERFACE_TYPE_SLAVE_S8
// Default:      APB2 (X2P_IS_APB3_S8)
// Values:       APB2 (0), APB3 (1), APB4 (2)
// Enabled:      X2P_NUM_APB_SLAVES>8
// 
// Select between AMBA 4 APB completer (APB4), AMBA 3 APB completer (APB3), and AMBA 2 APB completer (APB2) for Completer 
...
// If AMBA 3 APB Completer is selected, the additional ports PREADY and PSLVERR are included. 
// If AMBA 4 APB Completer is selected, the additional ports PSTRB and PPROT are included.
`define APB_INTERFACE_TYPE_SLAVE_S8 0

//Creates a define for enabling APB3 in Completer 8
...
// 
// Start address for APB Completer 9. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>9
// 
// End address for APB Completer 9. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>9
// 
// Completer 9 has the additional ports PREADY and PSLVERR 
// according to the AMBA3 specification.
`define X2P_IS_APB3_S9 0


// Name:         APB_INTERFACE_TYPE_SLAVE_S9
// Default:      APB2 (X2P_IS_APB3_S9)
// Values:       APB2 (0), APB3 (1), APB4 (2)
// Enabled:      X2P_NUM_APB_SLAVES>9
// 
// Select between AMBA 4 APB completer (APB4), AMBA 3 APB completer (APB3), and AMBA 2 APB completer (APB2) for Completer 
...
// If AMBA 3 APB Completer is selected, the additional ports PREADY and PSLVERR are included. 
// If AMBA 4 APB Completer is selected, the additional ports PSTRB and PPROT are included.
`define APB_INTERFACE_TYPE_SLAVE_S9 0

//Creates a define for enabling APB3 in Completer 9
...
// 
// Start address for APB Completer 10. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>10
// 
// End address for APB Completer 10. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>10
// 
// Completer 10 has the additional ports PREADY and PSLVERR 
// according to the AMBA3 specification.
`define X2P_IS_APB3_S10 0


// Name:         APB_INTERFACE_TYPE_SLAVE_S10
// Default:      APB2 (X2P_IS_APB3_S10)
// Values:       APB2 (0), APB3 (1), APB4 (2)
// Enabled:      X2P_NUM_APB_SLAVES>10
// 
// Select between AMBA 4 APB completer (APB4), AMBA 3 APB completer (APB3), and AMBA 2 APB completer (APB2) for Completer 
...
// If AMBA 3 APB Completer is selected, the additional ports PREADY and PSLVERR are included. 
// If AMBA 4 APB Completer is selected, the additional ports PSTRB and PPROT are included.
`define APB_INTERFACE_TYPE_SLAVE_S10 0

//Creates a define for enabling APB3 in Completer 10
...
// 
// Start address for APB Completer 11. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>11
// 
// End address for APB Completer 11. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>11
// 
// Completer 11 has the additional ports PREADY and PSLVERR 
// according to the AMBA3 specification.
`define X2P_IS_APB3_S11 0


// Name:         APB_INTERFACE_TYPE_SLAVE_S11
// Default:      APB2 (X2P_IS_APB3_S11)
// Values:       APB2 (0), APB3 (1), APB4 (2)
// Enabled:      X2P_NUM_APB_SLAVES>11
// 
// Select between AMBA 4 APB completer (APB4), AMBA 3 APB completer (APB3), and AMBA 2 APB completer (APB2) for Completer 
...
// If AMBA 3 APB Completer is selected, the additional ports PREADY and PSLVERR are included. 
// If AMBA 4 APB Completer is selected, the additional ports PSTRB and PPROT are included.
`define APB_INTERFACE_TYPE_SLAVE_S11 0

//Creates a define for enabling APB3 in Completer 11
...
// 
// Start address for APB Completer 12. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>12
// 
// End address for APB Completer 12. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>12
// 
// Completer 12 has the additional ports PREADY and PSLVERR 
// according to the AMBA3 specification.
`define X2P_IS_APB3_S12 0


// Name:         APB_INTERFACE_TYPE_SLAVE_S12
// Default:      APB2 (X2P_IS_APB3_S12)
// Values:       APB2 (0), APB3 (1), APB4 (2)
// Enabled:      X2P_NUM_APB_SLAVES>12
// 
// Select between AMBA 4 APB completer (APB4), AMBA 3 APB completer (APB3), and AMBA 2 APB completer (APB2) for Completer 
...
// If AMBA 3 APB Completer is selected, the additional ports PREADY and PSLVERR are included. 
// If AMBA 4 APB Completer is selected, the additional ports PSTRB and PPROT are included.
`define APB_INTERFACE_TYPE_SLAVE_S12 0

//Creates a define for enabling APB3 in Completer 12
...
// 
// Start address for APB Completer 13. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>13
// 
// End address for APB Completer 13. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>13
// 
// Completer 13 has the additional ports PREADY and PSLVERR 
// according to the AMBA3 specification.
`define X2P_IS_APB3_S13 0


// Name:         APB_INTERFACE_TYPE_SLAVE_S13
// Default:      APB2 (X2P_IS_APB3_S13)
// Values:       APB2 (0), APB3 (1), APB4 (2)
// Enabled:      X2P_NUM_APB_SLAVES>13
// 
// Select between AMBA 4 APB completer (APB4), AMBA 3 APB completer (APB3), and AMBA 2 APB completer (APB2) for Completer 
...
// If AMBA 3 APB Completer is selected, the additional ports PREADY and PSLVERR are included. 
// If AMBA 4 APB Completer is selected, the additional ports PSTRB and PPROT are included.
`define APB_INTERFACE_TYPE_SLAVE_S13 0

//Creates a define for enabling APB3 in Completer 13
...
// 
// Start address for APB Completer 14. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>14
// 
// End address for APB Completer 14. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>14
// 
// Completer 14 has the additional ports PREADY and PSLVERR 
// according to the AMBA3 specification.
`define X2P_IS_APB3_S14 0


// Name:         APB_INTERFACE_TYPE_SLAVE_S14
// Default:      APB2 (X2P_IS_APB3_S14)
// Values:       APB2 (0), APB3 (1), APB4 (2)
// Enabled:      X2P_NUM_APB_SLAVES>14
// 
// Select between AMBA 4 APB completer (APB4), AMBA 3 APB completer (APB3), and AMBA 2 APB completer (APB2) for Completer 
...
// If AMBA 3 APB Completer is selected, the additional ports PREADY and PSLVERR are included. 
// If AMBA 4 APB Completer is selected, the additional ports PSTRB and PPROT are included.
`define APB_INTERFACE_TYPE_SLAVE_S14 0

//Creates a define for enabling APB3 in Completer 14
...
// 
// Start address for APB Completer 15. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>15
// 
// End address for APB Completer 15. 
//  
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
...
// Enabled:      X2P_NUM_APB_SLAVES>15
// 
// Completer 15 has the additional ports PREADY and PSLVERR 
// according to the AMBA3 specification.
`define X2P_IS_APB3_S15 0


// Name:         APB_INTERFACE_TYPE_SLAVE_S15
// Default:      APB2 (X2P_IS_APB3_S15)
// Values:       APB2 (0), APB3 (1), APB4 (2)
// Enabled:      X2P_NUM_APB_SLAVES>15
// 
// Select between AMBA 4 APB completer (APB4), AMBA 3 APB completer (APB3), and AMBA 2 APB completer (APB2) for Completer 
...
// If AMBA 3 APB Completer is selected, the additional ports PREADY and PSLVERR are included. 
// If AMBA 4 APB Completer is selected, the additional ports PSTRB and PPROT are included.
`define APB_INTERFACE_TYPE_SLAVE_S15 0

//Creates a define for enabling APB3 in Completer 15

// `define X2P_APB3_S15


`define X2P_AXI_START_ADDR 64'h2060000


`define X2P_AXI_END_ADDR 64'h206ffff



// Name:         X2P_START_PADDR_32_S0
// Default:      0x02060000 (X2P_START_PADDR_S0 & 0x00000000ffffffff)
// Values:       0x00000000, ..., 0xfffffc00
// Enabled:      0
// 
// Start Address for APB Completer #0 that the component will use to decode the addressed APB Completer. This parameter is 
// non-editable and is used for visual purposes only in the coreConsultant GUI.
`define X2P_START_PADDR_32_S0 32'h02060000


// Name:         X2P_END_PADDR_32_S0
// Default:      0x0206ffff (X2P_END_PADDR_S0 & 0x00000000ffffffff)
// Values:       0x000003ff, ..., 0xffffffff
// Enabled:      0
// 
// End Address for APB Completer #0 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define X2P_END_PADDR_32_S0 32'h0206ffff
...
// Enabled:      0
// 
// Start Address for APB Completer #1 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// End Address for APB Completer #1 that the component will use to decode the addressed APB Completer. This parameter is 
// non-editable and is used for visual purposes only in the coreConsultant GUI.
...
// Enabled:      0
// 
// Start Address for APB Completer #2 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// End Address for APB Completer #2 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// Start Address for APB Completer #3 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// End Address for APB Completer #3 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// Start Address for APB Completer #4 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// End Address for APB Completer #4 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// Start Address for APB Completer #5 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// End Address for APB Completer #5 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// Start Address for APB Completer #6 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// End Address for APB Completer #6 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// Start Address for APB Completer #7 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// End Address for APB Completer #7 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// Start Address for APB Completer #8 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// End Address for APB Completer #8 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// Start Address for APB Completer #9 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// End Address for APB Completer #9 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// Start Address for APB Completer #10 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// End Address for APB Completer #10 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// Start Address for APB Completer #11 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// End Address for APB Completer #11 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// Start Address for APB Completer #12 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// End Address for APB Completer #12 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// Start Address for APB Completer #13 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// End Address for APB Completer #13 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// Start Address for APB Completer #14 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// End Address for APB Completer #14 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// Start Address for APB Completer #15 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
// Enabled:      0
// 
// End Address for APB Completer #15 that the component will use 
// to decode the addressed APB Completer. This parameter 
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
...
//Creates a define for enabling Completer 1

// `define X2P_HAS_S1

//Creates a define for enabling Completer 2

// `define X2P_HAS_S2

//Creates a define for enabling Completer 3

// `define X2P_HAS_S3

//Creates a define for enabling Completer 4

// `define X2P_HAS_S4

//Creates a define for enabling Completer 5

// `define X2P_HAS_S5

//Creates a define for enabling Completer 6

// `define X2P_HAS_S6

//Creates a define for enabling Completer 7

// `define X2P_HAS_S7

//Creates a define for enabling Completer 8

// `define X2P_HAS_S8

//Creates a define for enabling Completer 9

// `define X2P_HAS_S9

//Creates a define for enabling Completer 10

// `define X2P_HAS_S10

//Creates a define for enabling Completer 11

// `define X2P_HAS_S11

//Creates a define for enabling Completer 12

// `define X2P_HAS_S12

//Creates a define for enabling Completer 13

// `define X2P_HAS_S13

//Creates a define for enabling Completer 14

// `define X2P_HAS_S14

//Creates a define for enabling Completer 15

// `define X2P_HAS_S15

//Creates a define for enabling PREADY Signal in Completer 0

`define X2P_PREADY_S0

//Creates a define for enabling SLVERR Signal in Completer 0

`define X2P_PSLVERR_S0

//Creates a define for enabling PREADY Signal in Completer 1

// `define X2P_PREADY_S1

//Creates a define for enabling SLVERR Signal in Completer 1

// `define X2P_PSLVERR_S1

//Creates a define for enabling PREADY Signal in Completer 2

// `define X2P_PREADY_S2

//Creates a define for enabling SLVERR Signal in Completer 2

// `define X2P_PSLVERR_S2

//Creates a define for enabling PREADY Signal in Completer 3

// `define X2P_PREADY_S3

//Creates a define for enabling SLVERR Signal in Completer 3

// `define X2P_PSLVERR_S3

//Creates a define for enabling PREADY Signal in Completer 4

// `define X2P_PREADY_S4

//Creates a define for enabling SLVERR Signal in Completer 4

// `define X2P_PSLVERR_S4

//Creates a define for enabling PREADY Signal in Completer 5

// `define X2P_PREADY_S5

//Creates a define for enabling SLVERR Signal in Completer 5

// `define X2P_PSLVERR_S5

//Creates a define for enabling PREADY Signal in Completer 6

// `define X2P_PREADY_S6

//Creates a define for enabling SLVERR Signal in Completer 6

// `define X2P_PSLVERR_S6

//Creates a define for enabling PREADY Signal in Completer 7

// `define X2P_PREADY_S7

//Creates a define for enabling SLVERR Signal in Completer 7

// `define X2P_PSLVERR_S7

//Creates a define for enabling PREADY Signal in Completer 8

// `define X2P_PREADY_S8

//Creates a define for enabling SLVERR Signal in Completer 8

// `define X2P_PSLVERR_S8

//Creates a define for enabling PREADY Signal in Completer 9

// `define X2P_PREADY_S9

//Creates a define for enabling SLVERR Signal in Completer 9

// `define X2P_PSLVERR_S9

//Creates a define for enabling PREADY Signal in Completer 10

// `define X2P_PREADY_S10

//Creates a define for enabling SLVERR Signal in Completer 10

// `define X2P_PSLVERR_S10

//Creates a define for enabling PREADY Signal in Completer 11

// `define X2P_PREADY_S11

//Creates a define for enabling SLVERR Signal in Completer 11

// `define X2P_PSLVERR_S11

//Creates a define for enabling PREADY Signal in Completer 12

// `define X2P_PREADY_S12

//Creates a define for enabling SLVERR Signal in Completer 12

// `define X2P_PSLVERR_S12

//Creates a define for enabling PREADY Signal in Completer 13

// `define X2P_PREADY_S13

//Creates a define for enabling SLVERR Signal in Completer 13

// `define X2P_PSLVERR_S13

//Creates a define for enabling PREADY Signal in Completer 14

// `define X2P_PREADY_S14

//Creates a define for enabling SLVERR Signal in Completer 14

// `define X2P_PSLVERR_S14

//Creates a define for enabling PREADY Signal in Completer 15

// `define X2P_PREADY_S15

//Creates a define for enabling SLVERR Signal in Completer 15
...
//the Bridge register bus interface.
...
`define SIM_A_START_ADDR_S1 32'h10000000  /* completer A1 */
...
`define SIM_A_START_ADDR_S3 32'h30000000  /* completer A3 */
`define SIM_A_END_ADDR_S3   32'h3fffffff

// secondary bus memory map
`define SIM_B_START_ADDR_S1 32'h20000000  /* completer B1 */
`define SIM_B_END_ADDR_S1   32'h27ffffff
`define SIM_B_START_ADDR_S3 32'h28000000  /* completer B3 */
...
// Name:         X2P_HAS_APB4
// Default:      1 (APB_INTERFACE_TYPE_SLAVE_S0 == 2) || 
//               (APB_INTERFACE_TYPE_SLAVE_S1 == 2) || (APB_INTERFACE_TYPE_SLAVE_S2 == 2) || 
//               (APB_INTERFACE_TYPE_SLAVE_S3 == 2) || (APB_INTERFACE_TYPE_SLAVE_S4 == 2) || 
//               (APB_INTERFACE_TYPE_SLAVE_S5 == 2) || (APB_INTERFACE_TYPE_SLAVE_S6 == 2) || 
//               (APB_INTERFACE_TYPE_SLAVE_S7 == 2) || (APB_INTERFACE_TYPE_SLAVE_S8 == 2) || 
//               (APB_INTERFACE_TYPE_SLAVE_S9 == 2) || (APB_INTERFACE_TYPE_SLAVE_S10 
//               == 2) || (APB_INTERFACE_TYPE_SLAVE_S11 == 2) || 
//               (APB_INTERFACE_TYPE_SLAVE_S12 == 2) || (APB_INTERFACE_TYPE_SLAVE_S13 == 2) || 
//               (APB_INTERFACE_TYPE_SLAVE_S14 == 2) || (APB_INTERFACE_TYPE_SLAVE_S15 == 2)
// Values:       -2147483648, ..., 2147483647
// 
// IF X2P HAS A APB4 COMPLETER
`define X2P_HAS_APB4 1
...
`define X2P_CMD_QUEUE_WIDTH 32 + `X2P_AXI_SIDW + `X2P_AXI_BLW + 2 + 2 + `X2P_HAS_APB4*3 + 1
...
// Name:         X2P_HAS_APB3
// Default:      1 (APB_INTERFACE_TYPE_SLAVE_S0 > 0) || (APB_INTERFACE_TYPE_SLAVE_S1 
//               > 0) || (APB_INTERFACE_TYPE_SLAVE_S2 > 0) || 
//               (APB_INTERFACE_TYPE_SLAVE_S3 > 0) || (APB_INTERFACE_TYPE_SLAVE_S4 > 0) || 
//               (APB_INTERFACE_TYPE_SLAVE_S5 > 0) || (APB_INTERFACE_TYPE_SLAVE_S6 > 0) || 
//               (APB_INTERFACE_TYPE_SLAVE_S7 > 0) || (APB_INTERFACE_TYPE_SLAVE_S8 > 0) || 
//               (APB_INTERFACE_TYPE_SLAVE_S9 > 0) || (APB_INTERFACE_TYPE_SLAVE_S10 > 0) || 
//               (APB_INTERFACE_TYPE_SLAVE_S11 > 0) || (APB_INTERFACE_TYPE_SLAVE_S12 > 
//               0) || (APB_INTERFACE_TYPE_SLAVE_S13 > 0) || 
//               (APB_INTERFACE_TYPE_SLAVE_S14 > 0) || (APB_INTERFACE_TYPE_SLAVE_S15 > 0)
// Values:       -2147483648, ..., 2147483647
// 
// IF X2P HAS A APB3 COMPLETER
