...
//==============================================================================
`ifndef __GUARD__DW_AXI_CONSTANTS__VH__
...
`define ACT_ID_BUF_POINTER_W_AW_M1 88


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M1 5


`define ACT_ID_BUF_POINTER_W_AR_M1 32


`define LOG2_ACT_ID_BUF_POINTER_W_AR_M1 3


`define ACT_ID_BUF_POINTER_W_AW_M2 8


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M2 1


`define ACT_ID_BUF_POINTER_W_AR_M2 32


`define LOG2_ACT_ID_BUF_POINTER_W_AR_M2 3


`define ACT_ID_BUF_POINTER_W_AW_M3 8


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M3 1


`define ACT_ID_BUF_POINTER_W_AR_M3 32


`define LOG2_ACT_ID_BUF_POINTER_W_AR_M3 3


`define ACT_ID_BUF_POINTER_W_AW_M4 8


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M4 1


`define ACT_ID_BUF_POINTER_W_AR_M4 32


`define LOG2_ACT_ID_BUF_POINTER_W_AR_M4 3


`define ACT_ID_BUF_POINTER_W_AW_M5 8


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M5 1


`define ACT_ID_BUF_POINTER_W_AR_M5 32


`define LOG2_ACT_ID_BUF_POINTER_W_AR_M5 3


`define ACT_ID_BUF_POINTER_W_AW_M6 8


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M6 1


`define ACT_ID_BUF_POINTER_W_AR_M6 32


`define LOG2_ACT_ID_BUF_POINTER_W_AR_M6 3


`define ACT_ID_BUF_POINTER_W_AW_M7 8


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M7 1


`define ACT_ID_BUF_POINTER_W_AR_M7 32


`define LOG2_ACT_ID_BUF_POINTER_W_AR_M7 3


`define ACT_ID_BUF_POINTER_W_AW_M8 8


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M8 1


`define ACT_ID_BUF_POINTER_W_AR_M8 32


`define LOG2_ACT_ID_BUF_POINTER_W_AR_M8 3


`define ACT_ID_BUF_POINTER_W_AW_M9 8


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M9 1


`define ACT_ID_BUF_POINTER_W_AR_M9 32


`define LOG2_ACT_ID_BUF_POINTER_W_AR_M9 3


`define ACT_ID_BUF_POINTER_W_AW_M10 8


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M10 1


`define ACT_ID_BUF_POINTER_W_AR_M10 32


`define LOG2_ACT_ID_BUF_POINTER_W_AR_M10 3


`define ACT_ID_BUF_POINTER_W_AW_M11 8


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M11 1


`define ACT_ID_BUF_POINTER_W_AR_M11 32


`define LOG2_ACT_ID_BUF_POINTER_W_AR_M11 3


`define ACT_ID_BUF_POINTER_W_AW_M12 8


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M12 1


`define ACT_ID_BUF_POINTER_W_AR_M12 32


`define LOG2_ACT_ID_BUF_POINTER_W_AR_M12 3


`define ACT_ID_BUF_POINTER_W_AW_M13 8


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M13 1


`define ACT_ID_BUF_POINTER_W_AR_M13 32


`define LOG2_ACT_ID_BUF_POINTER_W_AR_M13 3


`define ACT_ID_BUF_POINTER_W_AW_M14 8


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M14 1


`define ACT_ID_BUF_POINTER_W_AR_M14 32


`define LOG2_ACT_ID_BUF_POINTER_W_AR_M14 3


`define ACT_ID_BUF_POINTER_W_AW_M15 8


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M15 1


`define ACT_ID_BUF_POINTER_W_AR_M15 32


`define LOG2_ACT_ID_BUF_POINTER_W_AR_M15 3


`define ACT_ID_BUF_POINTER_W_AW_M16 8


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M16 1


`define ACT_ID_BUF_POINTER_W_AR_M16 32
