...
// Revision: $Id: //dwh/DW_ocb/DW_axi/axi_dev_br/sim/testbench/sim_svte/tb_axi_assignment.sv#6 $ 
...
`else
 ...
 //Converting the AXI REGION defines
 `ifdef AXI_HAS_AXI4
   `ifdef AXI_HAS_S1
     assign axi_has_region[0] = `AXI_HAS_REGIONS_S1;
   `endif
   `ifdef AXI_HAS_S2
     assign axi_has_region[1] = `AXI_HAS_REGIONS_S2;
   `endif
   `ifdef AXI_HAS_S3
     assign axi_has_region[2] = `AXI_HAS_REGIONS_S3;
   `endif
   `ifdef AXI_HAS_S4
     assign axi_has_region[3] = `AXI_HAS_REGIONS_S4;
   `endif
   `ifdef AXI_HAS_S5
     assign axi_has_region[4] = `AXI_HAS_REGIONS_S5;
   `endif
   `ifdef AXI_HAS_S6
     assign axi_has_region[5] = `AXI_HAS_REGIONS_S6;
   `endif
   `ifdef AXI_HAS_S7
     assign axi_has_region[6] = `AXI_HAS_REGIONS_S7;
   `endif
   `ifdef AXI_HAS_S8
     assign axi_has_region[7] = `AXI_HAS_REGIONS_S8;
   `endif
   `ifdef AXI_HAS_S9
     assign axi_has_region[8] = `AXI_HAS_REGIONS_S9;
   `endif
   `ifdef AXI_HAS_S10
     assign axi_has_region[9] = `AXI_HAS_REGIONS_S10;
   `endif
   `ifdef AXI_HAS_S11
     assign axi_has_region[10] = `AXI_HAS_REGIONS_S11;
   `endif
   `ifdef AXI_HAS_S12
     assign axi_has_region[11] = `AXI_HAS_REGIONS_S12;
   `endif
   `ifdef AXI_HAS_S13
     assign axi_has_region[12] = `AXI_HAS_REGIONS_S13;
   `endif
   `ifdef AXI_HAS_S14
     assign axi_has_region[13] = `AXI_HAS_REGIONS_S14;
   `endif
   `ifdef AXI_HAS_S15
     assign axi_has_region[14] = `AXI_HAS_REGIONS_S15;
   `endif
   `ifdef AXI_HAS_S16
     assign axi_has_region[15] = `AXI_HAS_REGIONS_S16;
   `endif
 `endif

 // Required for QoS checker
 `ifdef SNPS_INTERNAL_ON
 `ifdef AXI_QOS
  `ifdef AXI_HAS_S1
    assign qos_awarb_chk_en_s[1] = (`AXI_AW_ARB_TYPE_S1 == 4);
    assign qos_ararb_chk_en_s[1] = (`AXI_AR_ARB_TYPE_S1 == 4);
    assign aw_shared_en      [1] = (`AXI_S1_ON_AW_SHARED_ONLY_VAL == 1);     
    assign ar_shared_en      [1] = (`AXI_S1_ON_AR_SHARED_ONLY_VAL == 1);     
  `endif
  `ifdef AXI_HAS_S2
    assign qos_awarb_chk_en_s[2] = (`AXI_AW_ARB_TYPE_S2 == 4);
    assign qos_ararb_chk_en_s[2] = (`AXI_AR_ARB_TYPE_S2 == 4);
    assign aw_shared_en      [2] = (`AXI_S2_ON_AW_SHARED_ONLY_VAL == 1);     
    assign ar_shared_en      [2] = (`AXI_S2_ON_AR_SHARED_ONLY_VAL == 1);
  `endif
  `ifdef AXI_HAS_S3
    assign qos_awarb_chk_en_s[3] = (`AXI_AW_ARB_TYPE_S3 == 4);
    assign qos_ararb_chk_en_s[3] = (`AXI_AR_ARB_TYPE_S3 == 4);
    assign aw_shared_en      [3] = (`AXI_S3_ON_AW_SHARED_ONLY_VAL == 1);     
    assign ar_shared_en      [3] = (`AXI_S3_ON_AR_SHARED_ONLY_VAL == 1);
  `endif
  `ifdef AXI_HAS_S4
    assign qos_awarb_chk_en_s[4] = (`AXI_AW_ARB_TYPE_S4 == 4);
    assign qos_ararb_chk_en_s[4] = (`AXI_AR_ARB_TYPE_S4 == 4);
    assign aw_shared_en      [4] = (`AXI_S4_ON_AW_SHARED_ONLY_VAL == 1);     
    assign ar_shared_en      [4] = (`AXI_S4_ON_AR_SHARED_ONLY_VAL == 1);
  `endif
  `ifdef AXI_HAS_S5
    assign qos_awarb_chk_en_s[5] = (`AXI_AW_ARB_TYPE_S5 == 4);
    assign qos_ararb_chk_en_s[5] = (`AXI_AR_ARB_TYPE_S5 == 4);
    assign aw_shared_en      [5] = (`AXI_S5_ON_AW_SHARED_ONLY_VAL == 1);     
    assign ar_shared_en      [5] = (`AXI_S5_ON_AR_SHARED_ONLY_VAL == 1);
  `endif
  `ifdef AXI_HAS_S6
    assign qos_awarb_chk_en_s[6] = (`AXI_AW_ARB_TYPE_S6 == 4);
    assign qos_ararb_chk_en_s[6] = (`AXI_AR_ARB_TYPE_S6 == 4);
    assign aw_shared_en      [6] = (`AXI_S6_ON_AW_SHARED_ONLY_VAL == 1);     
    assign ar_shared_en      [6] = (`AXI_S6_ON_AR_SHARED_ONLY_VAL == 1);
  `endif
  `ifdef AXI_HAS_S7
    assign qos_awarb_chk_en_s[7] = (`AXI_AW_ARB_TYPE_S7 == 4);
    assign qos_ararb_chk_en_s[7] = (`AXI_AR_ARB_TYPE_S7 == 4);
    assign aw_shared_en      [7] = (`AXI_S7_ON_AW_SHARED_ONLY_VAL == 1);     
    assign ar_shared_en      [7] = (`AXI_S7_ON_AR_SHARED_ONLY_VAL == 1);
  `endif
  `ifdef AXI_HAS_S8
    assign qos_awarb_chk_en_s[8] = (`AXI_AW_ARB_TYPE_S8 == 4);
    assign qos_ararb_chk_en_s[8] = (`AXI_AR_ARB_TYPE_S8 == 4);
    assign aw_shared_en      [8] = (`AXI_S8_ON_AW_SHARED_ONLY_VAL == 1);     
    assign ar_shared_en      [8] = (`AXI_S8_ON_AR_SHARED_ONLY_VAL == 1);
  `endif
  `ifdef AXI_HAS_S9
    assign qos_awarb_chk_en_s[9] = (`AXI_AW_ARB_TYPE_S9 == 4);
    assign qos_ararb_chk_en_s[9] = (`AXI_AR_ARB_TYPE_S9 == 4);
    assign aw_shared_en      [9] = (`AXI_S9_ON_AW_SHARED_ONLY_VAL == 1);     
    assign ar_shared_en      [9] = (`AXI_S9_ON_AR_SHARED_ONLY_VAL == 1);
  `endif
  `ifdef AXI_HAS_S10
    assign qos_awarb_chk_en_s[10] = (`AXI_AW_ARB_TYPE_S10 == 4);
    assign qos_ararb_chk_en_s[10] = (`AXI_AR_ARB_TYPE_S10 == 4);
    assign aw_shared_en      [10] = (`AXI_S10_ON_AW_SHARED_ONLY_VAL == 1);     
    assign ar_shared_en      [10] = (`AXI_S10_ON_AR_SHARED_ONLY_VAL == 1);
  `endif
  `ifdef AXI_HAS_S11
    assign qos_awarb_chk_en_s[11] = (`AXI_AW_ARB_TYPE_S11 == 4);
    assign qos_ararb_chk_en_s[11] = (`AXI_AR_ARB_TYPE_S11 == 4);
    assign aw_shared_en      [11] = (`AXI_S11_ON_AW_SHARED_ONLY_VAL == 1);     
    assign ar_shared_en      [11] = (`AXI_S11_ON_AR_SHARED_ONLY_VAL == 1);
  `endif
  `ifdef AXI_HAS_S12
    assign qos_awarb_chk_en_s[12] = (`AXI_AW_ARB_TYPE_S12 == 4);
    assign qos_ararb_chk_en_s[12] = (`AXI_AR_ARB_TYPE_S12 == 4);
    assign aw_shared_en      [12] = (`AXI_S12_ON_AW_SHARED_ONLY_VAL == 1);     
    assign ar_shared_en      [12] = (`AXI_S12_ON_AR_SHARED_ONLY_VAL == 1);
  `endif
  `ifdef AXI_HAS_S13
    assign qos_awarb_chk_en_s[13] = (`AXI_AW_ARB_TYPE_S13 == 4);
    assign qos_ararb_chk_en_s[13] = (`AXI_AR_ARB_TYPE_S13 == 4);
    assign aw_shared_en      [13] = (`AXI_S13_ON_AW_SHARED_ONLY_VAL == 1);     
    assign ar_shared_en      [13] = (`AXI_S13_ON_AR_SHARED_ONLY_VAL == 1);
  `endif
  `ifdef AXI_HAS_S14
    assign qos_awarb_chk_en_s[14] = (`AXI_AW_ARB_TYPE_S14 == 4);
    assign qos_ararb_chk_en_s[14] = (`AXI_AR_ARB_TYPE_S14 == 4);
    assign aw_shared_en      [14] = (`AXI_S14_ON_AW_SHARED_ONLY_VAL == 1);     
    assign ar_shared_en      [14] = (`AXI_S14_ON_AR_SHARED_ONLY_VAL == 1);
  `endif
  `ifdef AXI_HAS_S15
    assign qos_awarb_chk_en_s[15] = (`AXI_AW_ARB_TYPE_S15 == 4);
    assign qos_ararb_chk_en_s[15] = (`AXI_AR_ARB_TYPE_S15 == 4);
    assign aw_shared_en      [15] = (`AXI_S15_ON_AW_SHARED_ONLY_VAL == 1);     
    assign ar_shared_en      [15] = (`AXI_S15_ON_AR_SHARED_ONLY_VAL == 1);
  `endif
  `ifdef AXI_HAS_S16
    assign qos_awarb_chk_en_s[16] = (`AXI_AW_ARB_TYPE_S16 == 4);
    assign qos_ararb_chk_en_s[16] = (`AXI_AR_ARB_TYPE_S16 == 4);
    assign aw_shared_en      [16] = (`AXI_S16_ON_AW_SHARED_ONLY_VAL == 1);     
    assign ar_shared_en      [16] = (`AXI_S16_ON_AR_SHARED_ONLY_VAL == 1);
  `endif
