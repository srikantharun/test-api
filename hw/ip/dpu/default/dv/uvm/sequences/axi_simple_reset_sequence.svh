...
`ifndef GUARD_AI_CORE_DPU_AXI_SIMPLE_RESET_SEQUENCE_SV
`define GUARD_AI_CORE_DPU_AXI_SIMPLE_RESET_SEQUENCE_SV
...
`endif
  ...
  virtual task body();
    ...
    repeat(40) @(posedge p_sequencer.reset_mp.clk);
    p_sequencer.reset_mp.reset <= 1'b1;
...
`endif // GUARD_AI_CORE_DPU_AXI_SIMPLE_RESET_SEQUENCE_SV
