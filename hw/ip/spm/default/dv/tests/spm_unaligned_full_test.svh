`ifndef GUARD_SPM_UNALIGNED_FULL_TEST_SV
`define GUARD_SPM_UNALIGNED_FULL_TEST_SV


class spm_unaligned_full_test extends spm_base_test;
    ...
    `uvm_component_utils(spm_unaligned_full_test)

    /** Class Constructor */
    function new(string name = "spm_unaligned_full_test", uvm_component parent);
...
`endif // GUARD_SPM_UNALIGNED_FULL_TEST_SV
