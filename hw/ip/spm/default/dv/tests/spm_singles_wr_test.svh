`ifndef GUARD_SPM_SINGLES_WR_TEST_SV
`define GUARD_SPM_SINGLES_WR_TEST_SV


class spm_singles_wr_test extends spm_base_test;
    ...
    `uvm_component_utils(spm_singles_wr_test)

    /** Class Constructor */
    function new(string name = "spm_singles_wr_test", uvm_component parent);
...
`endif // GUARD_SPM_SINGLES_WR_TEST_SV
