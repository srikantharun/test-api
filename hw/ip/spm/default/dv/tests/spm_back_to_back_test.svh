`ifndef GUARD_SPM_BACK_TO_BACK_TEST_SV
`define GUARD_SPM_BACK_TO_BACK_TEST_SV


class spm_back_to_back_test extends spm_base_test;
    ...
    `uvm_component_utils(spm_back_to_back_test)

    /** Class Constructor */
    function new(string name = "spm_back_to_back_test", uvm_component parent);
    ...
    virtual function void build_phase(uvm_phase phase);
        ...
        wr_seq.unique_random_address = 1;
        wr_seq.randomize();
...
`endif // GUARD_SPM_BACK_TO_BACK_TEST_SV
