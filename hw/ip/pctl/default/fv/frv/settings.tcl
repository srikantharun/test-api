...
proc proc_set_design_blackboxes {} {
  ...
  set_blackbox -designs {pctl_ppmu}
}
...
proc proc_set_rsts {} {
  # Defining resets
  create_reset pctl.o_ao_rst_sync_n -async -type load -sense low -disable_assertions_db
  create_reset pctl.global_rst_sync_n -async -type load -sense low -disable_assertions_db
}
