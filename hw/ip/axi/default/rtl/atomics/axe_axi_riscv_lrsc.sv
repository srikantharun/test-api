...
module axe_axi_riscv_lrsc #(
  ...
  /// The number of reservation table entries
...
`endif
  ...
  id_queue #(
    ...
    .data_t             (b_cmd_e),
    .FULL_BW            (FullBandwidth),
    .CUT_OUP_POP_INP_GNT(1'b1) // https://github.com/pulp-platform/axi_riscv_atomics/pull/34
  ) u_b_status_queue (
    .clk_i           (i_clk),
    .rst_ni          (i_rst_n),
