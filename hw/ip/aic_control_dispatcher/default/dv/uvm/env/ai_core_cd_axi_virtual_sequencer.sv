...
`ifndef AI_CORE_CD_AXI_VIRTUAL_SEQUENCER_SV
`define AI_CORE_CD_AXI_VIRTUAL_SEQUENCER_SV

class ai_core_cd_axi_virtual_sequencer extends uvm_sequencer;
  ...
  //--//svt_axi_master_sequencer cfg_seqr;
  //--//svt_axi_master_sequencer in_stream_seqr;

  `uvm_component_utils(ai_core_cd_axi_virtual_sequencer)
  function new(string name = "ai_core_cd_axi_virtual_sequencer", uvm_component parent = null);
...
`endif  // AI_CORE_CD_AXI_VIRTUAL_SEQUENCER_SV
