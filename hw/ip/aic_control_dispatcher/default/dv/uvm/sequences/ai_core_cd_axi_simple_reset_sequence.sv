...
/**
 * Abstract:
 * class ai_core_cd_axi_simple_reset_sequence defines a virtual sequence.
 *
 * The ai_core_cd_axi_simple_reset_sequence drives the reset pin through one
 * activation cycle.
 *
 * The ai_core_cd_axi_simple_reset_sequence is configured as the default sequence for the
 ...
 * Sequencer: ai_core_cd_axi_virtual_sequencer in testbench environment
 */

`ifndef AI_CORE_CD_AXI_SIMPLE_RESET_SEQUENCE_SV
`define AI_CORE_CD_AXI_SIMPLE_RESET_SEQUENCE_SV

class ai_core_cd_axi_simple_reset_sequence extends uvm_sequence;

  ai_core_cd_env_cfg m_env_cfg_h;
  ...
  `uvm_object_utils(ai_core_cd_axi_simple_reset_sequence)

  /** Declare a typed sequencer object that the sequence can access */
  `uvm_declare_p_sequencer(ai_core_cd_axi_virtual_sequencer)

  /** Class Constructor */
  function new(string name = "ai_core_cd_axi_simple_reset_sequence");
    super.new(name);
  endfunction : new
...
`endif
    ...
    if (!uvm_config_db #(ai_core_cd_env_cfg)::get(null, "", "AI_CORE_CD_ENV_CFG", m_env_cfg_h)) begin
...
endclass : ai_core_cd_axi_simple_reset_sequence

`endif  // AI_CORE_CD_AXI_SIMPLE_RESET_SEQUENCE_SV
