`ifndef AI_CORE_CD_INSTR_TKN_SMOKE_TEST_SV
`define AI_CORE_CD_INSTR_TKN_SMOKE_TEST_SV


class ai_core_cd_mem_manager__tkn_smoke_test#(int CMD_L_MAX=64, INSTR_L_MAX=256) extends ai_core_cd_mem_manager#(.CMD_L_MAX(CMD_L_MAX), .INSTR_L_MAX(INSTR_L_MAX));
    `uvm_component_utils(ai_core_cd_mem_manager__tkn_smoke_test)
...
endclass : ai_core_cd_mem_manager__tkn_smoke_test

// AI CORE CD base test class
class ai_core_cd_instr_tkn_smoke_test extends ai_core_cd_base_test;
  `uvm_component_utils(ai_core_cd_instr_tkn_smoke_test)

  // --- INHERITED METHODS - UVM_COMPONENT --- //
    /** Class Constructor */
    function new(string name = "ai_core_cd_instr_tkn_smoke_test", uvm_component parent=null);
      super.new(name,parent);
    ...
    virtual function void build_phase(uvm_phase phase);
      ...
      set_type_override_by_type(ai_core_cd_mem_manager#(64, 256)::get_type(),  ai_core_cd_mem_manager__tkn_smoke_test#(64, 256)::get_type(), 1'b1);
    endfunction: build_phase


endclass:ai_core_cd_instr_tkn_smoke_test

`endif // AI_CORE_CD_INSTR_TKN_SMOKE_TEST_SV
