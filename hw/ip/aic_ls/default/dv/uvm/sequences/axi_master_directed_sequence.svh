...
`define SVT_AXI_MAX_BURST_LENGTH_WIDTH_1
...
class axi_master_directed_sequence extends svt_axi_master_base_sequence;
  ...
  virtual task body();
    ...
    for (int i = 0; i < sequence_length; i++) begin
      ...
      write_tran.addr        = m_env_h.m_env_cfg.m_l1_full_start_addr + (i*'d64);
...
`endif
      ...
      foreach (write_tran.data[i]) begin
        write_tran.data[i] = {16{$urandom}} &
                             {$urandom_range(0,16384), $urandom_range(1,16384), $urandom_range(2,16384), $urandom_range(3,16384),
                              $urandom_range(0,16384), $urandom_range(1,16384), $urandom_range(2,16384), $urandom_range(3,16384),
                              $urandom_range(0,16384), $urandom_range(1,16384), $urandom_range(2,16384), $urandom_range(3,16384),
                              $urandom_range(0,16384), $urandom_range(1,16384), $urandom_range(2,16384), $urandom_range(3,16384),
                              $urandom_range(0,16384), $urandom_range(1,16384), $urandom_range(2,16384), $urandom_range(3,16384),
      ...
      read_tran.addr        = m_env_h.m_env_cfg.m_l1_full_start_addr + (i*'d64);
