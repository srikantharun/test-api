...
//
// Description:  Simple 1D testcase : 1D Aligned Start Address. Aligned END Address. INCR=1
// Owner: Sultan Khan

`ifndef GUARD_DMA_IP_1D_CH0_ALIGN_ALIGN_XINC1_TSIZE0_128B_CONT_TEST_SV
`define GUARD_DMA_IP_1D_CH0_ALIGN_ALIGN_XINC1_TSIZE0_128B_CONT_TEST_SV

class dma_ip_1D_ch0_align_align_xinc1_tsize0_128b_cont_test extends dma_ip_rand_transfers_test;
  ...
  constraint xbytesize_values_c {
    src_xbytesize  inside {128};    
    dst_xbytesize  inside {128};
  }
  ...
  `uvm_component_utils(dma_ip_1D_ch0_align_align_xinc1_tsize0_128b_cont_test)


  // Class constructor
  function new (string name="dma_ip_1D_ch0_align_align_xinc1_tsize0_128b_cont_test", uvm_component parent);
  ...
  virtual function void build_phase(uvm_phase phase);
    `uvm_info ("dma_ip_1D_ch0_align_align_xinc1_tsize0_128b_cont_test", "Build phase entered", UVM_HIGH)
    super.build_phase(phase);
  endfunction


endclass:dma_ip_1D_ch0_align_align_xinc1_tsize0_128b_cont_test



`endif // GUARD_DMA_IP_1D_CH0_ALIGN_ALIGN_XINC1_TSIZE0_128B_CONT_TEST_SV
