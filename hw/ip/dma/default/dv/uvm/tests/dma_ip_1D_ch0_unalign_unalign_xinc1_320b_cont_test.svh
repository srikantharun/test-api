...
//
// Description:  Simple 1D testcase : 1D UNAligned Start Address. UNAligned END Address. INCR=1. TRANSIZE=0 (8 bits). 320 bytes
// Owner: Sultan Khan

`ifndef GUARD_DMA_IP_1D_CH0_UNALIGN_UNALIGN_XINC1_320B_CONT_TEST_SV
`define GUARD_DMA_IP_1D_CH0_UNALIGN_UNALIGN_XINC1_320B_CONT_TEST_SV

class dma_ip_1D_ch0_unalign_unalign_xinc1_320b_cont_test extends dma_ip_rand_transfers_test;
  ...
  constraint xbytesize_values_c {
    src_xbytesize  inside {320};    
    dst_xbytesize  inside {320};
  }
  ...
  `uvm_component_utils(dma_ip_1D_ch0_unalign_unalign_xinc1_320b_cont_test)


  // Class constructor
  function new (string name="dma_ip_1D_ch0_unalign_unalign_xinc1_320b_cont_test", uvm_component parent);
  ...
  virtual function void build_phase(uvm_phase phase);
    `uvm_info ("dma_ip_1D_ch0_unalign_unalign_xinc1_320b_cont_test", "Build phase entered", UVM_HIGH)
    super.build_phase(phase);
  endfunction


endclass:dma_ip_1D_ch0_unalign_unalign_xinc1_320b_cont_test



`endif // GUARD_DMA_IP_1D_CH0_UNALIGN_UNALIGN_XINC1_320B_CONT_TEST_SV
