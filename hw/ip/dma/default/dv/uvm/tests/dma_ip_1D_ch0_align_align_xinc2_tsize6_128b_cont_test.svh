...
`ifndef GUARD_DMA_IP_1D_CH0_ALIGN_ALIGN_XINC2_TSIZE6_128B_CONT_TEST_SV
`define GUARD_DMA_IP_1D_CH0_ALIGN_ALIGN_XINC2_TSIZE6_128B_CONT_TEST_SV

class dma_ip_1D_ch0_align_align_xinc2_tsize6_128b_cont_test extends dma_ip_rand_transfers_test;
  ...
  `uvm_component_utils(dma_ip_1D_ch0_align_align_xinc2_tsize6_128b_cont_test)


  // Class constructor
  function new (string name="dma_ip_1D_ch0_align_align_xinc2_tsize6_128b_cont_test", uvm_component parent);
  ...
  virtual function void build_phase(uvm_phase phase);
    `uvm_info ("dma_ip_1D_ch0_align_align_xinc2_tsize6_128b_cont_test", "Build phase entered", UVM_HIGH)
    super.build_phase(phase);
  endfunction


endclass:dma_ip_1D_ch0_align_align_xinc2_tsize6_128b_cont_test



`endif // GUARD_DMA_IP_1D_CH0_ALIGN_ALIGN_XINC2_TSIZE6_128B_CONT_TEST_SV
