...
//   This test is effectively, the dma_ip_1D_ch0_align_align_xinc1_tsize0_64b_cont_test with new constraints and a run-phase defined 
// Owner: Sultan Khan

`ifndef GUARD_DMA_IP_1D_CH0_ALIGN_ALIGN_XINC1_TSIZE0_64B_CONT_TEST_SV
`define GUARD_DMA_IP_1D_CH0_ALIGN_ALIGN_XINC1_TSIZE0_64B_CONT_TEST_SV

class dma_ip_1D_ch0_align_align_xinc1_tsize0_64b_cont_test extends dma_ip_rand_transfers_test;
  ...
  constraint xinc_values_c {
    src_xaddrinc  inside {64};		 // 64-bytes. So entire 512-bit data bus to be utlized
    dst_xaddrinc  inside {64};
  }

  // XBYTESIZE Selection
  constraint xbytesize_values_c {
    src_xbytesize  inside {64};    // 64-bytes. So entire 512-bit data bus to be utlized
    dst_xbytesize  inside {64};
  }
  ...
  `uvm_component_utils(dma_ip_1D_ch0_align_align_xinc1_tsize0_64b_cont_test)


  // Class constructor
  function new (string name="dma_ip_1D_ch0_align_align_xinc1_tsize0_64b_cont_test", uvm_component parent);
  ...
  virtual function void build_phase(uvm_phase phase);
    `uvm_info ("dma_ip_1D_ch0_align_align_xinc1_tsize0_64b_cont_test", "Build phase entered", UVM_HIGH)
    super.build_phase(phase);
  endfunction


endclass:dma_ip_1D_ch0_align_align_xinc1_tsize0_64b_cont_test



`endif // GUARD_DMA_IP_1D_CH0_ALIGN_ALIGN_XINC1_TSIZE0_64B_CONT_TEST_SV
