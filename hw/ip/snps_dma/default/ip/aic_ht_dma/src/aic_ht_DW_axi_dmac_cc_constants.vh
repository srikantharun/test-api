...
//==============================================================================
`ifndef AIC_HT___GUARD__DW_AXI_DMAC_CC_CONSTANTS__VH__
`define AIC_HT___GUARD__DW_AXI_DMAC_CC_CONSTANTS__VH__
...
`define AIC_HT_DMAX_NUM_CHANNELS 2
...
`define AIC_HT_DMAX_MSTIF_MODE 1
...
`define AIC_HT_DMAX_NUM_MASTER_IF 2
...
`define AIC_HT_DMAX_SLVIF_MODE 0
...
`define AIC_HT_DMAX_SLVIF_CLOCK_MODE 0


`define AIC_HT_DMAX_APB3_APB4 0
...
`define AIC_HT_DMAX_S_2_C_SYNC_DEPTH 2
...
//  - 3: Three-stage synchronization, all stages positive edge. 
//  - 4: Four-stage synchronization, all stages positive edge.
`define AIC_HT_DMAX_C_2_S_SYNC_DEPTH 2
...
`define AIC_HT_DMAX_MSTIF1_CLOCK_MODE 0
...
//  - 3: Three-stage synchronization, all stages positive edge. 
//  - 4: Four-stage synchronization, all stages positive edge.
`define AIC_HT_DMAX_M1_2_C_SYNC_DEPTH 2
...
//  - 3: Three-stage synchronization, all stages positive edge. 
//  - 4: Four-stage synchronization, all stages positive edge.
`define AIC_HT_DMAX_C_2_M1_SYNC_DEPTH 2
...
`define AIC_HT_DMAX_MSTIF2_CLOCK_MODE 0
...
//  - 3: Three-stage synchronization, all stages positive edge. 
//  - 4: Four-stage synchronization, all stages positive edge.
`define AIC_HT_DMAX_M2_2_C_SYNC_DEPTH 2
...
//  - 3: Three-stage synchronization, all stages positive edge. 
//  - 4: Four-stage synchronization, all stages positive edge
`define AIC_HT_DMAX_C_2_M2_SYNC_DEPTH 2
...
`define AIC_HT_DMAX_UNALIGNED_XFER_EN 0
...
`define AIC_HT_DMAX_ARB_TIMING_OPT 0
...
`define AIC_HT_DMAX_MULT_ARB_EN 0
...
`define AIC_HT_DMAX_MSTIF1_OSR_LMT 32
...
// CHx_CFG.SRC_OSR_LMT and CHx_CFG.DST_OSR_LMT. 
//  This parameter does not limit the outstanding read requests on the AXI interface.
`define AIC_HT_DMAX_MSTIF2_OSR_LMT 32
...
// the I/O.
`define AIC_HT_DMAX_NUM_HS_IF 0
...
`define AIC_HT_DMAX_ASYNC_HS_EN 0
...
`define AIC_HT_DMAX_HS_SAME_ASYNC_CLK 1
...
//  - 3: Three-stage synchronization, all stages positive edge. 
//  - 4: Four-stage synchronization, all stages positive edge
`define AIC_HT_DMAX_HS_2_C_SYNC_DEPTH 2
...
//  - 3: Three-stage synchronization, all stages positive edge. 
//  - 4: Four-stage synchronization, all stages positive edge
`define AIC_HT_DMAX_C_2_HS_SYNC_DEPTH 2
...
`define AIC_HT_DMAX_HS1_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS2_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS3_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS4_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS5_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS6_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS7_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS8_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS9_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS10_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS11_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS12_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS13_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS14_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS15_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS16_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS17_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS18_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS19_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS20_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS21_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS22_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS23_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS24_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS25_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS26_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS27_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS28_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS29_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS30_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS31_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS32_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS33_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS34_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS35_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS36_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS37_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS38_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS39_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS40_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS41_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS42_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS43_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS44_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS45_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS46_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS47_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS48_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS49_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS50_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS51_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS52_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS53_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS54_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS55_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS56_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS57_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS58_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS59_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS60_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS61_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS62_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS63_ASYNC_CLK 1
...
`define AIC_HT_DMAX_HS64_ASYNC_CLK 1
...
// output. 
// Bitwise OR of all the bits of DMAC_CommonReg_IntStatusReg register is driven onto the respective "intr_cmnreg" output.
`define AIC_HT_DMAX_INTR_IO_TYPE 1
...
// DW_axi_dmac.
`define AIC_HT_DMAX_INTR_SYNC2SLVCLK 0
...
`define AIC_HT_DMAX_SLVIF_STATUS_OP_EN 0
...
`define AIC_HT_DMAX_CORE_STATUS_OP_EN 0
...
`define AIC_HT_DMAX_HOLD_IO_EN 0
...
`define AIC_HT_DMAX_ENCODED_COMP_PARAMS_EN 0
...
`define AIC_HT_DMAX_DEBUG_REGS_EN 0
...
`define AIC_HT_DMAX_CH_ABORT_EN 0
...
`define AIC_HT_DMAX_STATIC_ENDIAN_SELECT_MSTIF 1
...
//  - 0: Little Endian 
//  - 1: Big Endian BE-8
`define AIC_HT_DMAX_ENDIAN_FORMAT_MSTIF 0
...
`define AIC_HT_DMAX_LLI_ENDIAN_SELECTION_PIN_EN 0
...
`define AIC_HT_DMAX_CH_MEM_EXT 1
...
`define AIC_HT_DMAX_S_DATA_WIDTH 64
...
`define AIC_HT_DMAX_OPT_TIMING 1
...
`define AIC_HT_DMAX_HW_VIRT_EN 0
...
`define AIC_HT_DMAX_HW_VIRT_VMID_EN 0
...
`define AIC_HT_DMAX_VMID_WIDTH 1
...
`define AIC_HT_DMAX_CHEN_REORG 0
...
`define AIC_HT_DMAX_CHPRIOR_REORG 0
...
`define AIC_HT_DMAX_SAFETY_FEATURE_EN 0
...
`define AIC_HT_DMAX_ADV_SAFETY_FEATURE_EN 0
...
`define AIC_HT_DMAX_SFTY_INTR_IO_TYPE 0
...
`define AIC_HT_DMAX_PARITY_PROT_EN 0
...
`define AIC_HT_DMAX_DEF_PARITY_MODE 1'h0
...
`define AIC_HT_DMAX_DEF_PARITY_EN 1'h1
...
// two cycles.
`define AIC_HT_DMAX_HWDATA_PIPE_LINE 0
...
`define AIC_HT_DMAX_ADDR_PARITY_PROT_EN 0
...
`define AIC_HT_DMAX_ECC_PROT_EN 0
...
// channels.
`define AIC_HT_DMAX_ECC_MEMIF_EN 0
...
// channels.
`define AIC_HT_DMAX_ECC_UIDMEMIF_EN 0
...
`define AIC_HT_DMAX_ECC_MXIF_EN 0
...
`define AIC_HT_DMAX_MXIF_ECC_PAR_EN 0
...
`define AIC_HT_DMAX_MXIF_ECC_PAR_MODE 1
...
`define AIC_HT_DMAX_MXIF_PAR_MODE 1
...
//  - Even Parity 
//  - Odd Parity
`define AIC_HT_DMAX_MXIF_PAR_TYPE 1
...
`define AIC_HT_DMAX_MXIF_ECC_GRAN_TYPE 0
...
`define AIC_HT_DMAX_MXIF_READY_VALID_PAR_EN 0
...
//  - Even Parity 
//  - Odd Parity
`define AIC_HT_DMAX_MXIF_READY_VALID_PAR_TYPE 1
...
`define AIC_HT_DMAX_LAST_WRITE_ECC_EN 0
...
`define AIC_HT_DMAX_ECC_DIAG_EN 0
...
`define AIC_HT_DMAX_CH_MEM_REGOUT 1
...
`define AIC_HT_DMAX_ECC_ERR_INJ_EN 0
...
`define AIC_HT_DMAX_LS_PROT_EN 0
...
`define AIC_HT_DMAX_LS_DIAG_EN 0
...
`define AIC_HT_DMAX_M_ADDR_WIDTH 40
...
`define AIC_HT_DMAX_M_DATA_WIDTH 512
...
`define AIC_HT_DMAX_M_ID_WIDTH 6
...
`define AIC_HT_DMAX_M_BURSTLEN_WIDTH 8
...
`define AIC_HT_DMAX_M_ADDR_FIFO_DEPTH 4
...
`define AIC_HT_DMAX_M_DATA_FIFO_DEPTH 4
...
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_M_BRESP_FIFO_DEPTH 4
...
`define AIC_HT_DMAX_ENABLE_LAST_WRITE 0
...
`define AIC_HT_DMAX_DEBUG_PORTS_EN 1
...
`define AIC_HT_DMAX_CHNL_CSLP_EN 1
...
`define AIC_HT_DMAX_SBIU_CSLP_EN 1
...
`define AIC_HT_DMAX_MXIF_CSLP_EN 1
...
`define AIC_HT_DMAX_GLCH_LPDLY_WIDTH 4
...
`define AIC_HT_DMAX_SBIU_LPDLY_WIDTH 4
...
`define AIC_HT_DMAX_MXIF_LPDLY_WIDTH 4
...
`define AIC_HT_DMAX_GLCH_LPDLY 4
...
`define AIC_HT_DMAX_SBIU_LPDLY 4
...
`define AIC_HT_DMAX_MXIF_LPDLY 4
...
`define AIC_HT_DMAX_LLI_AUTO_RESUME_REQ_CNT 0

//Log2(DMAX_LLI_AUTO_RESUME_REQ_CNT)

`define AIC_HT_LOG2_DMAX_LLI_AUTO_RESUME_REQ_CNT 1
...
`define AIC_HT_DMAX_CH1_FIFO_DEPTH 128
...
// CH(x)_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH1_MAX_MSIZE 256
...
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH1_MAX_BLOCK_TS 131071
...
`define AIC_HT_DMAX_CH1_MAX_AMBA_BURST_LENGTH 64
...
`define AIC_HT_DMAX_CH1_LOCK_EN 0
...
// 
`define AIC_HT_DMAX_CH1_TT_FC 4'h0
...
`define AIC_HT_DMAX_CH1_TT 1


// Name:         DMAX_CH1_SMS
// Default:      No Hardcode (DMAX_NUM_MASTER_IF == 1 ? 0 : 2)
...
`define AIC_HT_DMAX_CH1_SMS 2'h2
...
// optimization of the implementation.
`define AIC_HT_DMAX_CH1_DMS 2'h2
...
`define AIC_HT_DMAX_CH1_SHADOW_REG_EN 1
...
// the implementation.
`define AIC_HT_DMAX_CH1_MULTI_BLK_EN 1
...
// 
`define AIC_HT_DMAX_CH1_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH1_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH1_SRC_MULTI_BLK_TYPE 4
...
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH1_LLI_PREFETCH_EN 1
...
`define AIC_HT_DMAX_CH1_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH1_SRC_STAT_EN 0
...
`define AIC_HT_DMAX_CH1_DST_STAT_EN 0
...
`define AIC_HT_DMAX_CH1_LLI_WB_EN 1
...
// order.
`define AIC_HT_DMAX_CH1_RD_UID_EN 1
...
`define AIC_HT_DMAX_CH1_WR_UID_EN 1
...
`define AIC_HT_DMAX_CH1_RD_UID 4
...
`define AIC_HT_DMAX_CH1_WR_UID 4


// Name:         DMAX_CH1_REORDER_BUFF_DEPTH
// Default:      128 (DMAX_CH1_FIFO_DEPTH)
// Values:       4 8 16 32 64 128 256
// Enabled:      DMAX_CH1_RD_UID_EN==1
// 
...
`define AIC_HT_DMAX_CH1_REORDER_BUFF_DEPTH 128
...
`define AIC_HT_DMAX_CH1_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH2_FIFO_DEPTH 128
...
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH2_MAX_MSIZE 256
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH2_MAX_BLOCK_TS 131071
...
`define AIC_HT_DMAX_CH2_MAX_AMBA_BURST_LENGTH 64
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH2_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH2_TT_FC 4'h0
...
// optimization of the implementation
`define AIC_HT_DMAX_CH2_SMS 2'h2
...
// optimization of the implementation.
`define AIC_HT_DMAX_CH2_DMS 2'h2
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH2_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH2_MULTI_BLK_EN 1
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH2_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH2_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH2_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH2_LLI_PREFETCH_EN 1
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH2_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH2_SRC_STAT_EN 0
...
// multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH2_DST_STAT_EN 0
...
`define AIC_HT_DMAX_CH2_LLI_WB_EN 1
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH2_RD_UID_EN 1
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH2_WR_UID_EN 1
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH2_RD_UID 4
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH2_WR_UID 4


// Name:         DMAX_CH2_REORDER_BUFF_DEPTH
// Default:      128 (DMAX_CH2_FIFO_DEPTH)
// Values:       4 8 16 32 64 128 256
// Enabled:      DMAX_CH2_RD_UID_EN==1
// 
// This parameter allows user to configure the re-ordering buffer depth. Setting appropriate value based on the system 
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH2_REORDER_BUFF_DEPTH 128
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH2_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH3_FIFO_DEPTH 8
...
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH3_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH3_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH3_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH3_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH3_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH3_SMS 2'h2
...
// optimization of the implementation.
`define AIC_HT_DMAX_CH3_DMS 2'h2
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH3_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH3_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH3_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH3_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH3_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH3_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH3_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH3_SRC_STAT_EN 0
...
// multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH3_DST_STAT_EN 0
...
// end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either source 
// or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH3_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH3_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH3_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH3_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH3_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH3_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH3_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH4_FIFO_DEPTH 8
...
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH4_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH4_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH4_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH4_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH4_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH4_SMS 2'h2
...
// optimization of the implementation.
`define AIC_HT_DMAX_CH4_DMS 2'h2
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH4_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH4_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH4_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH4_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH4_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH4_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH4_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH4_SRC_STAT_EN 0
...
// multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH4_DST_STAT_EN 0
...
// end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either source 
// or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH4_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH4_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH4_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH4_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH4_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH4_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH4_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH5_FIFO_DEPTH 8
...
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH5_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH5_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH5_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH5_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH5_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH5_SMS 2'h2
...
// optimization of the implementation.
`define AIC_HT_DMAX_CH5_DMS 2'h2
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH5_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH5_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH5_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH5_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH5_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH5_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH5_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH5_SRC_STAT_EN 0
...
// multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH5_DST_STAT_EN 0
...
// end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either source 
// or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH5_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH5_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH5_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH5_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH5_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH5_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH5_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH6_FIFO_DEPTH 8
...
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH6_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH6_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH6_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH6_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH6_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH6_SMS 2'h2
...
// optimization of the implementation.
`define AIC_HT_DMAX_CH6_DMS 2'h2
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH6_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH6_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH6_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH6_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH6_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH6_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH6_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH6_SRC_STAT_EN 0
...
// multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH6_DST_STAT_EN 0
...
// end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either source 
// or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH6_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH6_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH6_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH6_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH6_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH6_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH6_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH7_FIFO_DEPTH 8
...
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH7_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH7_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH7_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH7_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH7_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH7_SMS 2'h2
...
// optimization of the implementation.
`define AIC_HT_DMAX_CH7_DMS 2'h2
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH7_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH7_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH7_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH7_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH7_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH7_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH7_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH7_SRC_STAT_EN 0
...
// multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH7_DST_STAT_EN 0
...
// end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either source 
// or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH7_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH7_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH7_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH7_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH7_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH7_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH7_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH8_FIFO_DEPTH 8
...
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH8_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH8_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH8_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH8_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH8_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH8_SMS 2'h2
...
// optimization of the implementation.
`define AIC_HT_DMAX_CH8_DMS 2'h2
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH8_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH8_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH8_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH8_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH8_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH8_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH8_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH8_SRC_STAT_EN 0
...
// multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH8_DST_STAT_EN 0
...
// end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either source 
// or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH8_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH8_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH8_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH8_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH8_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH8_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH8_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH9_FIFO_DEPTH 8
...
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH9_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH9_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH9_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH9_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH9_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH9_SMS 2'h2
...
// optimization of the implementation.
`define AIC_HT_DMAX_CH9_DMS 2'h2
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH9_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH9_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH9_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH9_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH9_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH9_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH9_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH9_SRC_STAT_EN 0
...
// multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH9_DST_STAT_EN 0
...
// end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either source 
// or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH9_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH9_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH9_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH9_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH9_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH9_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH9_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH10_FIFO_DEPTH 8
...
// CH10_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH10_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH10_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH10_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH10_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH10_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH10_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH10_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH10_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH10_DTW 32
...
// implementation.
`define AIC_HT_DMAX_CH10_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH10_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH10_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH10_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH10_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH10_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH10_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH10_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH10_DST_STAT_EN 0
...
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH10_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH10_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH10_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH10_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH10_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH10_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH10_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH11_FIFO_DEPTH 8
...
// CH11_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH11_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH11_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH11_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH11_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH11_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH11_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH11_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH11_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH11_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH11_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH11_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH11_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH11_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH11_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH11_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH11_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH11_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH11_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH11_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH11_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH11_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH11_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH11_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH11_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH11_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH12_FIFO_DEPTH 8
...
// CH12_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH12_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH12_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH12_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH12_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH12_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH12_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH12_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH12_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH12_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH12_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH12_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH12_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH12_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH12_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH12_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH12_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH12_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH12_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH12_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH12_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH12_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH12_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH12_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH12_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH12_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH13_FIFO_DEPTH 8
...
// CH13_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH13_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH13_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH13_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH13_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH13_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH13_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH13_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH13_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH13_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH13_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH13_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH13_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH13_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH13_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH13_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH13_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH13_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH13_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH13_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH13_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH13_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH13_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH13_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH13_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH13_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH14_FIFO_DEPTH 8
...
// CH14_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH14_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH14_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH14_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH14_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH14_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH14_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH14_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH14_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH14_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH14_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH14_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH14_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH14_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH14_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH14_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH14_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH14_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH14_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH14_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH14_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH14_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH14_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH14_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH14_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH14_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH15_FIFO_DEPTH 8
...
// CH15_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH15_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH15_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH15_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH15_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH15_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH15_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH15_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH15_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH15_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH15_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH15_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH15_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH15_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH15_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH15_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH15_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH15_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH15_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH15_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH15_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH15_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH15_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH15_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH15_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH15_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH16_FIFO_DEPTH 8
...
// CH16_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH16_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH16_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH16_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH16_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH16_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH16_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH16_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH16_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH16_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH16_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH16_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH16_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH16_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH16_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH16_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH16_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH16_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH16_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH16_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH16_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH16_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH16_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH16_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH16_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH16_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH17_FIFO_DEPTH 8
...
// CH17_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH17_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH17_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH17_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH17_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH17_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH17_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH17_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH17_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH17_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH17_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH17_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH17_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH17_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH17_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH17_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH17_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH17_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH17_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH17_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH17_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH17_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH17_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH17_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH17_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH17_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH18_FIFO_DEPTH 8
...
// CH18_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH18_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH18_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH18_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH18_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH18_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH18_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH18_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH18_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH18_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH18_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH18_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH18_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH18_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH18_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH18_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH18_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH18_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH18_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH18_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH18_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH18_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH18_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH18_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH18_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH18_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH19_FIFO_DEPTH 8
...
// CH19_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH19_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH19_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH19_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH19_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH19_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH19_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH19_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH19_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH19_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH19_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH19_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH19_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH19_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH19_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH19_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH19_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH19_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH19_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH19_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH19_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH19_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH19_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH19_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH19_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH19_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH20_FIFO_DEPTH 8
...
// CH20_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH20_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH20_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH20_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH20_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH20_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH20_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH20_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH20_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH20_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH20_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH20_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH20_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH20_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH20_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH20_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH20_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH20_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH20_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH20_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH20_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH20_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH20_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH20_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH20_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH20_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH21_FIFO_DEPTH 8
...
// CH21_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH21_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH21_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH21_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH21_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH21_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH21_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH21_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH21_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH21_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH21_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH21_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH21_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH21_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH21_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH21_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH21_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH21_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH21_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH21_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH21_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH21_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH21_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH21_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH21_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH21_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH22_FIFO_DEPTH 8
...
// CH22_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH22_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH22_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH22_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH22_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH22_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH22_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH22_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH22_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH22_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH22_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH22_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH22_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH22_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH22_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH22_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH22_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH22_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH22_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH22_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH22_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH22_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH22_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH22_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH22_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH22_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH23_FIFO_DEPTH 8
...
// CH23_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH23_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH23_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH23_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH23_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH23_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH23_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH23_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH23_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH23_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH23_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH23_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH23_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH23_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH23_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH23_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH23_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH23_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH23_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH23_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH23_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH23_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH23_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH23_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH23_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH23_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH24_FIFO_DEPTH 8
...
// CH24_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH24_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH24_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH24_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH24_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH24_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH24_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH24_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH24_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH24_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH24_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH24_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH24_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH24_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH24_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH24_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH24_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH24_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH24_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH24_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH24_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH24_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH24_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH24_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH24_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH24_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH25_FIFO_DEPTH 8
...
// CH25_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH25_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH25_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH25_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH25_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH25_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH25_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH25_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH25_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH25_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH25_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH25_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH25_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH25_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH25_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH25_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH25_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH25_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH25_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH25_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH25_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH25_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH25_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH25_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH25_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH25_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH26_FIFO_DEPTH 8
...
// CH26_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH26_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH26_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH26_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH26_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH26_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH26_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH26_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH26_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH26_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH26_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH26_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH26_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH26_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH26_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH26_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH26_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH26_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH26_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH26_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH26_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH26_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH26_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH26_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH26_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH26_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH27_FIFO_DEPTH 8
...
// CH27_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH27_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH27_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH27_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH27_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH27_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH27_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH27_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH27_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH27_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH27_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH27_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH27_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH27_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH27_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH27_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH27_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH27_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH27_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH27_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH27_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH27_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH27_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH27_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH27_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH27_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH28_FIFO_DEPTH 8
...
// CH28_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH28_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH28_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH28_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH28_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH28_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH28_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH28_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH28_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH28_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH28_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH28_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH28_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH28_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH28_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH28_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH28_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH28_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH28_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH28_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH28_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH28_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH28_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH28_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH28_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH28_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH29_FIFO_DEPTH 8
...
// CH29_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH29_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH29_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH29_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH29_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH29_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH29_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH29_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH29_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH29_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH29_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH29_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH29_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH29_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH29_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH29_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH29_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH29_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH29_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH29_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH29_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH29_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH29_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH29_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH29_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH29_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH30_FIFO_DEPTH 8
...
// CH30_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH30_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH30_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH30_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH30_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH30_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH30_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH30_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH30_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH30_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH30_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH30_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH30_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH30_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH30_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH30_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH30_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH30_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH30_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH30_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH30_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH30_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH30_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH30_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH30_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH30_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH31_FIFO_DEPTH 8
...
// CH31_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH31_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH31_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH31_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH31_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH31_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH31_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH31_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH31_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH31_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH31_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH31_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH31_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH31_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH31_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH31_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH31_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH31_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH31_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH31_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH31_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH31_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH31_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH31_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH31_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH31_CRC_EN 0
...
// implementation.
`define AIC_HT_DMAX_CH32_FIFO_DEPTH 8
...
// CH32_CTL.DST_MSIZE). 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH32_MAX_MSIZE 8
...
//  the saturated value. 
// Setting appropriate value based on the system requirement allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH32_MAX_BLOCK_TS 31
...
`define AIC_HT_DMAX_CH32_MAX_AMBA_BURST_LENGTH 8
...
// DW_axi_dmac to lock the arbitration for the manager bus interface over the DMA transfer, block transfer, or transaction. 
// When set to No (0), this option allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH32_LOCK_EN 0
...
// 0x8      No Hardcode       No Hardcode 
// 
`define AIC_HT_DMAX_CH32_TT_FC 4'h8
...
// optimization of the implementation
`define AIC_HT_DMAX_CH32_SMS 2'h2
...
// logic optimization of the implementation.
`define AIC_HT_DMAX_CH32_DMS 2'h2
...
// can program the source transfer width. Hardcoding the source transfer width allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH32_STW 32
...
// software can program the destination transfer width. Hardcoding the destination transfer width allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH32_DTW 32
...
// register based multi-block transfer is used. Setting this parameter to 0 allows some logic optimization of the 
// implementation.
`define AIC_HT_DMAX_CH32_SHADOW_REG_EN 0
...
// the implementation.
`define AIC_HT_DMAX_CH32_MULTI_BLK_EN 0
...
// 0xd                  Linked List                 Linked List 
// 
`define AIC_HT_DMAX_CH32_MULTI_BLK_TYPE 4'h0
...
`define AIC_HT_DMAX_CH32_DST_MULTI_BLK_TYPE 4
...
`define AIC_HT_DMAX_CH32_SRC_MULTI_BLK_TYPE 4
...
// This parameter needs to be enabled only if linked-list-based multi-block transfer is used. Setting this parameter to 0 
// allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH32_LLI_PREFETCH_EN 0
...
//  the access does not cross one complete LLI structure of 64 bytes. DW_axi_dmac fetches the entire LLI (40 bytes) in one 
//  AXI burst if the burst length is not limited by other settings.
`define AIC_HT_DMAX_CH32_LMS 2'h2
...
// optimization of the  
// implementation.
`define AIC_HT_DMAX_CH32_SRC_STAT_EN 0
...
// linked-list-based multiblock transfer is used by either source or destination peripheral. Setting this parameter to 0 allows some logic 
// optimization of the implementation.
`define AIC_HT_DMAX_CH32_DST_STAT_EN 0
...
// the end of every block transfer. Write back happens only if linked-list-based multi-block transfer is used by either 
// source or destination peripheral. Setting this parameter to 0 allows some logic optimization of the implementation.
`define AIC_HT_DMAX_CH32_LLI_WB_EN 0
...
// Channel will generate the AXI transfers with the unique AXI ID. This will allow Source memory to provide read data out of 
// order.
`define AIC_HT_DMAX_CH32_RD_UID_EN 0
...
// and Data Channel will generate the AXI transfers with the unique AXI ID. This will allow Destination memory to provide 
// write response out of order.
`define AIC_HT_DMAX_CH32_WR_UID_EN 0
...
// affects the depth of the re-ordering buffer - hence area, so this feature and depth of the unique ID must be chosen 
// carefully based on the requirement only for the required channel.
`define AIC_HT_DMAX_CH32_RD_UID 2
...
// 
// This parameter allows user to select the number of AXI Write Channel Unique ID's supported.
`define AIC_HT_DMAX_CH32_WR_UID 2
...
// requirement allows some logic optimization of the implementation. The number of AXI Read unique ID's generated are limited by 
// the Source Transfer Width, read burst length programmed, depth of the re-ordering buffer, and DMAX_CH(x)_RD_UID.
`define AIC_HT_DMAX_CH32_REORDER_BUFF_DEPTH 8
...
// 
// This parameter is used to enable CRC feature for Channel x. When set to 1, CRC logic is included for Channel x.
`define AIC_HT_DMAX_CH32_CRC_EN 0
...
`define AIC_HT_DMAX_CRC_POLYNOMIAL 7'h1
...
`define AIC_HT_USE_FOUNDATION 0
...
`define AIC_HT_DMAX_HAS_LLI_PARAM 1


//Log2(DMAX_NUM_CHANNELS)

`define AIC_HT_LOG2_DMAX_NUM_CHANNELS 1
...
`define AIC_HT_DMAX_CH1_HAS_LLI 1
...
`define AIC_HT_DMAX_CH2_HAS_LLI 1
...
`define AIC_HT_DMAX_CH3_HAS_LLI 0
...
`define AIC_HT_DMAX_CH4_HAS_LLI 0
...
`define AIC_HT_DMAX_CH5_HAS_LLI 0
...
`define AIC_HT_DMAX_CH6_HAS_LLI 0
...
`define AIC_HT_DMAX_CH7_HAS_LLI 0
...
`define AIC_HT_DMAX_CH8_HAS_LLI 0
...
`define AIC_HT_DMAX_CH9_HAS_LLI 0
...
`define AIC_HT_DMAX_CH10_HAS_LLI 0
...
`define AIC_HT_DMAX_CH11_HAS_LLI 0
...
`define AIC_HT_DMAX_CH12_HAS_LLI 0
...
`define AIC_HT_DMAX_CH13_HAS_LLI 0
...
`define AIC_HT_DMAX_CH14_HAS_LLI 0
...
`define AIC_HT_DMAX_CH15_HAS_LLI 0
...
`define AIC_HT_DMAX_CH16_HAS_LLI 0
...
`define AIC_HT_DMAX_CH17_HAS_LLI 0
...
`define AIC_HT_DMAX_CH18_HAS_LLI 0
...
`define AIC_HT_DMAX_CH19_HAS_LLI 0
...
`define AIC_HT_DMAX_CH20_HAS_LLI 0
...
`define AIC_HT_DMAX_CH21_HAS_LLI 0
...
`define AIC_HT_DMAX_CH22_HAS_LLI 0
...
`define AIC_HT_DMAX_CH23_HAS_LLI 0
...
`define AIC_HT_DMAX_CH24_HAS_LLI 0
...
`define AIC_HT_DMAX_CH25_HAS_LLI 0
...
`define AIC_HT_DMAX_CH26_HAS_LLI 0
...
`define AIC_HT_DMAX_CH27_HAS_LLI 0
...
`define AIC_HT_DMAX_CH28_HAS_LLI 0
...
`define AIC_HT_DMAX_CH29_HAS_LLI 0
...
`define AIC_HT_DMAX_CH30_HAS_LLI 0
...
`define AIC_HT_DMAX_CH31_HAS_LLI 0
...
`define AIC_HT_DMAX_CH32_HAS_LLI 0

//AXI DMAC has Read UID Parameter
//DMAC will have Read UID if at least one of the enabled channels has DMAX_CHx_RD_UID_EN == 1

`define AIC_HT_DMAX_HAS_RUID_PARAM 1

//AXI DMAC has Read UID Support
`define AIC_HT_DMAX_HAS_RUID


`define AIC_HT_LOG2_DMAX_CH1_RD_UID 2

`define AIC_HT_LOG2_DMAX_CH2_RD_UID 2

`define AIC_HT_LOG2_DMAX_CH3_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH4_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH5_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH6_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH7_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH8_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH9_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH10_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH11_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH12_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH13_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH14_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH15_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH16_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH17_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH18_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH19_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH20_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH21_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH22_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH23_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH24_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH25_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH26_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH27_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH28_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH29_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH30_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH31_RD_UID 1

`define AIC_HT_LOG2_DMAX_CH32_RD_UID 1

//Max. Read UID Parameter supported in DW_axi_dmac

`define AIC_HT_LOG2_DMAX_MAX_RUID 2

//Max. Read UID Parameter supported in DW_axi_dmac

`define AIC_HT_RD_UID_TBL_WIDTH 11
...
`define AIC_HT_DMAX_HAS_WUID_PARAM 1

//AXI DMAC has Write UID Support
`define AIC_HT_DMAX_HAS_WUID


`define AIC_HT_LOG2_DMAX_CH1_WR_UID 2

`define AIC_HT_LOG2_DMAX_CH2_WR_UID 2

`define AIC_HT_LOG2_DMAX_CH3_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH4_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH5_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH6_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH7_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH8_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH9_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH10_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH11_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH12_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH13_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH14_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH15_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH16_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH17_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH18_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH19_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH20_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH21_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH22_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH23_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH24_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH25_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH26_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH27_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH28_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH29_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH30_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH31_WR_UID 1

`define AIC_HT_LOG2_DMAX_CH32_WR_UID 1

//Max. Write UID Parameter supported in DW_axi_dmac

`define AIC_HT_LOG2_DMAX_MAX_WUID 2

`define AIC_HT_DMAX_HAS_UID


`define AIC_HT_DMAX_HS_IF_UPDT 0

`define AIC_HT_DMAX_NO_BCM36_4SEMISTATIC 1

//Internal Verification Specific Parameters

`define AIC_HT_DMAX_S_2_C_VERIF_EN 1


`define AIC_HT_DMAX_C_2_S_VERIF_EN 1


`define AIC_HT_DMAX_M1_2_C_VERIF_EN 1


`define AIC_HT_DMAX_C_2_M1_VERIF_EN 1


`define AIC_HT_DMAX_M2_2_C_VERIF_EN 1


`define AIC_HT_DMAX_C_2_M2_VERIF_EN 1


`define AIC_HT_DMAX_HS_2_C_VERIF_EN 1


`define AIC_HT_DMAX_C_2_HS_VERIF_EN 1


`define AIC_HT_ECC_EI_MEM_WIDTH 4


`define AIC_HT_ECC_EI_CH_WIDTH 5


`define AIC_HT_ECC_EI_POINTS_WIDTH 3


`define AIC_HT_ECC_BIT_SEL_WIDTH 9
