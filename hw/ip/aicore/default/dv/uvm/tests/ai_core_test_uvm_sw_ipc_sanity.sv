`ifndef AI_CORE_TEST_UVM_SW_IPC_SANITY_SV
`define AI_CORE_TEST_UVM_SW_IPC_SANITY_SV

class fw_test_uvm_sw_ipc_sanity extends ai_core_base_test;
  ...
  task basic_test();
    ...
    ref_data_arr[0] = {32'hdeadbeef};
    ref_data_arr[1] = {32'hcafedeca};
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    // TODO: Also run on non-APU cores.
    // no need to wait fork: uvm_sw_ipc handles end of simulation
  endtask


endclass

`endif  // AI_CORE_TEST_UVM_SW_IPC_SANITY_SV
