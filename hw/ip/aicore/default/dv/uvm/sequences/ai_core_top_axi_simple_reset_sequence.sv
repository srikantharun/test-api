...
/**
 * Abstract:
 * class ai_core_top_axi_simple_reset_sequence defines a virtual sequence.
 * 
 * The ai_core_top_axi_simple_reset_sequence drives the reset pin through one
 * activation cycle.
 *
 * The ai_core_top_axi_simple_reset_sequence is configured as the default sequence for the
...
class ai_core_top_axi_simple_reset_sequence extends uvm_sequence;

  /** UVM Object Utility macro */
  `uvm_object_utils(ai_core_top_axi_simple_reset_sequence)

  /** Declare a typed sequencer object that the sequence can access */
  `uvm_declare_p_sequencer(ai_core_top_axi_virtual_sequencer)

  /** Class Constructor */
  function new (string name = "ai_core_top_axi_simple_reset_sequence");
    super.new(name);
  endfunction : new
...
`endif
  ...
  virtual task body();
    ...
    repeat(4) @(posedge p_sequencer.reset_mp.clk);
...
endclass: ai_core_top_axi_simple_reset_sequence
