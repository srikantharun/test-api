...
/**
 * Abstract:
 * ai_core_top_axi_master_directed_sequence is used by test to provide initiator
...
class ai_core_top_axi_master_directed_sequence extends svt_axi_master_base_sequence;
  ...
  `uvm_object_utils(ai_core_top_axi_master_directed_sequence)

  /** Class Constructor */
  function new(string name="ai_core_top_axi_master_directed_sequence");
    super.new(name);
  endfunction
...
endclass: ai_core_top_axi_master_directed_sequence
