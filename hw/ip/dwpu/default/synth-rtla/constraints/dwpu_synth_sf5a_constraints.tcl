...
# Sanity i/o constraints for the DWPU IP
...
set_case_analysis 0 [get_ports i_mcs[0]]
set_case_analysis 0 [get_ports i_mcs[1]]

set_case_analysis 0 [get_ports i_mcsw]
set_case_analysis 0 [get_ports i_ret]
set_case_analysis 0 [get_ports i_pde]
set_case_analysis 0 [get_ports i_se]

set_case_analysis 0 [get_ports i_adme[0]]
set_case_analysis 0 [get_ports i_adme[1]]
set_case_analysis 1 [get_ports i_adme[2]]
