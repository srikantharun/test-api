...
`ifndef GUARD_DWPU_CUST_SVT_AXI_SYSTEM_CONFIGURATION_SV
`define GUARD_DWPU_CUST_SVT_AXI_SYSTEM_CONFIGURATION_SV
// Class
class dwpu_cust_svt_axi_system_configuration extends svt_axi_system_configuration;

  // Factory registration
  `uvm_object_utils(dwpu_cust_svt_axi_system_configuration)

  // Class Constructor
  function new(string name = "dwpu_cust_svt_axi_system_configuration");
    super.new(name);
    ...
    this.master_cfg[1].tdata_width   = AXI_STREAM_IFD0_DATA_WIDTH;
    `ifdef AI_CORE_TOP_ENV_CHECK
      this.master_cfg[1].is_active     = 0;
    `else
...
endclass
`endif  //GUARD_DWPU_CUST_SVT_AXI_SYSTEM_CONFIGURATION_SV
