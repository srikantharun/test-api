...
`ifndef GUARD_DWPU_AXI_VIRTUAL_SEQUENCER_SV
`define GUARD_DWPU_AXI_VIRTUAL_SEQUENCER_SV

class dwpu_axi_virtual_sequencer extends uvm_sequencer;
  ...
  `uvm_component_utils(dwpu_axi_virtual_sequencer)
  function new(string name = "dwpu_axi_virtual_sequencer", uvm_component parent = null);
...
`endif  // GUARD_DPWPU_AXI_VIRTUAL_SEQUENCER_SV
