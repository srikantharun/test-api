// MVM prgmode 2 test does the UTu multiplication
`ifndef __AI_CORE_MVM_SINGLE_MATRIX_MULTIPLICATION_PRGMODE_2_TEST__
`define __AI_CORE_MVM_SINGLE_MATRIX_MULTIPLICATION_PRGMODE_2_TEST__

class ai_core_mvm_single_matrix_multiplication_prgmode_2_test extends ai_core_mvm_base_test;
  // Registration with the factory
  `uvm_component_utils(ai_core_mvm_single_matrix_multiplication_prgmode_2_test)
  // Class constructor
  function new (string name="ai_core_mvm_single_matrix_multiplication_prgmode_2_test", uvm_component parent);
    super.new (name, parent);
  endfunction : new
  // Build phase
  virtual function void build_phase(uvm_phase phase);
    `uvm_info ("ai_core_mvm_single_matrix_multiplication_prgmode_2_test", "Build phase entered", UVM_HIGH)
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    super.run_phase(phase);
      ...
      if (!mvm_prg_cmd_tb_data_h.randomize with {mvm_prg_cmd_struct.wb_t_pw == col_len_intr-1;
					     ...
					     mvm_prg_cmd_struct.extra == 2; //extra byte has prgmode 2
						})
	...
	`uvm_info("PRGMODE",$sformatf("prgmode is %s", mvm_if.prgmode),UVM_LOW)
      end else begin
...
endclass:ai_core_mvm_single_matrix_multiplication_prgmode_2_test
