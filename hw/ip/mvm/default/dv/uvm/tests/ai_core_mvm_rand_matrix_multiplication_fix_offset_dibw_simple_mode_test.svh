...
`ifndef __AI_CORE_MVM_RAND_MATRIX_MULTIPLICATION_FIX_OFFSET_DIBW_SIMPLE_MODE_TEST__
`define __AI_CORE_MVM_RAND_MATRIX_MULTIPLICATION_FIX_OFFSET_DIBW_SIMPLE_MODE_TEST__

class ai_core_mvm_rand_matrix_multiplication_fix_offset_dibw_simple_mode_test extends ai_core_mvm_base_test;
  // Registration with the factory
  `uvm_component_utils(ai_core_mvm_rand_matrix_multiplication_fix_offset_dibw_simple_mode_test)
   ...
   int ifdw_burst_len;
  // Class constructor
  function new (string name="ai_core_mvm_rand_matrix_multiplication_fix_offset_dibw_simple_mode_test", uvm_component parent);
    super.new (name, parent);
  endfunction : new
  // Build phase
  virtual function void build_phase(uvm_phase phase);
    `uvm_info ("ai_core_mvm_rand_matrix_multiplication_fix_offset_dibw_simple_mode_test", "Build phase entered", UVM_HIGH)
...
task prepare_prg_packet_and_send_ifdw;
    if(ifdw==0) begin 
      if (!mvm_prg_cmd_tb_data_h.randomize with {mvm_prg_cmd_struct.a_t_pw == 0; 
...
endclass:ai_core_mvm_rand_matrix_multiplication_fix_offset_dibw_simple_mode_test

`endif	// __AI_CORE_MVM_RAND_MATRIX_MULTIPLICATION_FIX_OFFSET_DIBW_SIMPLE_MODE_TEST__
