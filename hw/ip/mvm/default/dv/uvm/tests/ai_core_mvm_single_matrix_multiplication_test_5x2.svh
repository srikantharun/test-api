...
`ifndef __AI_CORE_MVM_SINGLE_MATRIX_MULTIPLICATION_TEST__
`define __AI_CORE_MVM_SINGLE_MATRIX_MULTIPLICATION_TEST__

class ai_core_mvm_single_matrix_multiplication_test extends ai_core_mvm_base_test;
  // Registration with the factory
  `uvm_component_utils(ai_core_mvm_single_matrix_multiplication_test)
  // Class constructor
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    super.run_phase(phase);
      ...
      if(!axi_wr_seq.randomize() with {
        ...
        cfg_data[1] == 64'h0000_0104_0102_0000;
      })
...
endclass:ai_core_mvm_single_matrix_multiplication_test
