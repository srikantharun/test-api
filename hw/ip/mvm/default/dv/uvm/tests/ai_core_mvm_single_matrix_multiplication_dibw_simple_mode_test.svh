...
`ifndef __AI_CORE_MVM_SINGLE_MATRIX_MULTIPLICATION_DIBW_SIMPLE_MODE_TEST__
`define __AI_CORE_MVM_SINGLE_MATRIX_MULTIPLICATION_DIBW_SIMPLE_MODE_TEST__

class ai_core_mvm_single_matrix_multiplication_dibw_simple_mode_test extends ai_core_mvm_base_test;
  // Registration with the factory
  `uvm_component_utils(ai_core_mvm_single_matrix_multiplication_dibw_simple_mode_test)
  // Class constructor
  function new (string name="ai_core_mvm_single_matrix_multiplication_dibw_simple_mode_test", uvm_component parent);
    super.new (name, parent);
  endfunction : new
  // Build phase
  virtual function void build_phase(uvm_phase phase);
    `uvm_info ("ai_core_mvm_single_matrix_multiplication_dibw_simple_mode_test", "Build phase entered", UVM_HIGH)
    ...
    super.run_phase(phase);
      ...
      if(!axi_wr_seq.randomize() with {
       ...
       // cfg_data[1] == 64'h0000_0000_0000_0000; //weight set 0 and extra 0 (simple mode)
        cfg_data[1] == 64'h0000_0001_0000_0000; //weight set 0 and extra 0 (simple mode)
      })
      ...
      if(!axi_wr_seq.randomize() with {
        ...
        cfg_data[1] == 64'h0000_0001_0400_0000; //weight set 0 and extra 0 (simple mode)
      })
        `uvm_fatal("run_phase", "Failed to randomize");
      axi_wr_seq.start(env.axi_system_env.master[0].sequencer);
...
endclass:ai_core_mvm_single_matrix_multiplication_dibw_simple_mode_test

`endif	// __AI_CORE_MVM_SINGLE_MATRIX_MULTIPLICATION_DIBW_SIMPLE_MODE_TEST__
