...
`ifndef __AI_CORE_MVM_CONCURRENT_PRG_EXE_RANDOM_MATRIX_MULTIPLICATION_TEST__
`define __AI_CORE_MVM_CONCURRENT_PRG_EXE_RANDOM_MATRIX_MULTIPLICATION_TEST__

class ai_core_mvm_concurrent_prg_exe_random_matrix_multiplication_test extends ai_core_mvm_base_test;
  // Registration with the factory
  `uvm_component_utils(ai_core_mvm_concurrent_prg_exe_random_matrix_multiplication_test)
      ...
      bit prg_wt_set;
  // Class constructor
  function new (string name="ai_core_mvm_concurrent_prg_exe_random_matrix_multiplication_test", uvm_component parent);
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    super.run_phase(phase);
      ...
      `uvm_info("MVM_CONCURRENT_PRG_EXE_RANDOM_TEST",$sformatf("MVM parallel random matrix multiplication starting"), UVM_LOW)
      #100ns;
...
endclass:ai_core_mvm_concurrent_prg_exe_random_matrix_multiplication_test
