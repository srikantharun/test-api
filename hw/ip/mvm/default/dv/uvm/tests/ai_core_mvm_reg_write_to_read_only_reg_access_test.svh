// MVM reg_burst accesee test-case class
`ifndef __AI_CORE_MVM_REG_WRITE_TO_READ_ONLY_REG_ACCESS_TEST__
`define __AI_CORE_MVM_REG_WRITE_TO_READ_ONLY_REG_ACCESS_TEST__

class ai_core_mvm_reg_write_to_read_only_reg_access_test extends ai_core_mvm_base_test;
  // Registration with the factory
  `uvm_component_utils(ai_core_mvm_reg_write_to_read_only_reg_access_test)
  ...
  // Class constructor
  function new (string name="ai_core_mvm_reg_write_to_read_only_reg_access_test", uvm_component parent);
    super.new (name, parent);
  endfunction : new
  // Build phase
  virtual function void build_phase(uvm_phase phase);
    `uvm_info ("ai_core_mvm_reg_write_to_read_only_reg_access_test", "Build phase entered", UVM_HIGH)
...
endclass:ai_core_mvm_reg_write_to_read_only_reg_access_test

`endif	// __AI_CORE_MVM_REG_WRITE_TO_READ_ONLY_REG_ACCESS_TEST__
