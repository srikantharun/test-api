...
`ifndef __AI_CORE_MVM_RAND_MATRIX_MULTIPLICATION_DIBW_SIMPLE_MODE_BROADCAST_TEST__
`define __AI_CORE_MVM_RAND_MATRIX_MULTIPLICATION_DIBW_SIMPLE_MODE_BROADCAST_TEST__

class ai_core_mvm_rand_matrix_multiplication_dibw_simple_mode_broadcast_test extends ai_core_mvm_base_test;
  // Registration with the factory
  `uvm_component_utils(ai_core_mvm_rand_matrix_multiplication_dibw_simple_mode_broadcast_test)
   ...
   int ifdw_burst_len;
  // Class constructor
  function new (string name="ai_core_mvm_rand_matrix_multiplication_dibw_simple_mode_broadcast_test", uvm_component parent);
    super.new (name, parent);
  endfunction : new
  // Build phase
  virtual function void build_phase(uvm_phase phase);
    `uvm_info ("ai_core_mvm_rand_matrix_multiplication_dibw_simple_mode_broadcast_test", "Build phase entered", UVM_HIGH)
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    super.run_phase(phase);
     ...
     #100ns;
      ...
      wait_for_prg_status;
      uvm_report_info(get_type_name(), $psprintf("IFDW  PRG STATUS READ FINISHED "), UVM_LOW);
...
task prepare_prg_packet_and_send_ifdw;
   if (!mvm_prg_cmd_tb_data_h.randomize with {mvm_prg_cmd_struct.a_t_pw < 4; 
                                              ...
                                              mvm_prg_cmd_struct.extra == 8; //broadast mode enabled 
                                             }) 
  ...
  task prepare_exe_instr;
    ...
    foreach(mvm_exe_instr_tb_data_packet_h.mvm_exe_instr_addr[i]) begin
      if (!mvm_exe_instr_tb_data_h.randomize with {mvm_exe_instr_struct.a_s == mvm_prg_cmd_tb_data_h.mvm_prg_cmd_struct.a_s[1:0];   
                                                   mvm_exe_instr_struct.a_u_pw >= mvm_prg_cmd_tb_data_h.mvm_prg_cmd_struct.a_u_pw[3:0];
                                                   mvm_exe_instr_struct.wb_u_pw <= mvm_prg_cmd_tb_data_h.mvm_prg_cmd_struct.wb_u_pw[3:0] ;
                                                   mvm_exe_instr_struct.a_u_pw <= mvm_prg_cmd_tb_data_h.mvm_prg_cmd_struct.a_u_pw[3:0] + mvm_prg_cmd_tb_data_h.mvm_prg_cmd_struct.wb_u_pw[3:0] ;
                                                   mvm_exe_instr_struct.a_u_pw + mvm_exe_instr_struct.wb_u_pw <= mvm_prg_cmd_tb_data_h.mvm_prg_cmd_struct.a_u_pw[3:0] + mvm_prg_cmd_tb_data_h.mvm_prg_cmd_struct.wb_u_pw[3:0] ;
                                                   mvm_exe_instr_struct.a_t_pw >= mvm_prg_cmd_tb_data_h.mvm_prg_cmd_struct.a_t_pw[2:0];
                                                   mvm_exe_instr_struct.wb_t_pw <= mvm_prg_cmd_tb_data_h.mvm_prg_cmd_struct.wb_t_pw[2:0] ;
                                                   mvm_exe_instr_struct.a_t_pw <= mvm_prg_cmd_tb_data_h.mvm_prg_cmd_struct.a_t_pw[2:0] + mvm_prg_cmd_tb_data_h.mvm_prg_cmd_struct.wb_t_pw[2:0] ;
                                                   mvm_exe_instr_struct.a_t_pw + mvm_exe_instr_struct.wb_t_pw <= mvm_prg_cmd_tb_data_h.mvm_prg_cmd_struct.a_t_pw[2:0] + mvm_prg_cmd_tb_data_h.mvm_prg_cmd_struct.wb_t_pw[2:0] ;       } )
         `uvm_fatal("run_phase", "Failed to randomize");
...
endclass:ai_core_mvm_rand_matrix_multiplication_dibw_simple_mode_broadcast_test

`endif	// __AI_CORE_MVM_RAND_MATRIX_MULTIPLICATION_DIBW_SIMPLE_MODE_BROADCAST_TEST__
