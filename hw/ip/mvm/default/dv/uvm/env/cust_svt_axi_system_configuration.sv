...
`endif
    ...
    this.master_cfg[0].data_width = AXI_LT_DATA_WIDTH;
    this.master_cfg[0].addr_width = AXI_LT_ADDR_WIDTH;
    ...
    this.master_cfg[1].tdata_width   = AXI_STREAM_IFDW_DATA_WIDTH;
    ...
    this.master_cfg[1].transaction_coverage_enable = 0;

    // AXI Master 2 IFD0
    this.master_cfg[2].axi_interface_type = svt_axi_port_configuration::AXI4_STREAM;
    this.master_cfg[2].tdata_width   = AXI_STREAM_IFD0_DATA_WIDTH;
    ...
    this.master_cfg[2].transaction_coverage_enable = 0;

    // AXI Master 3 IFD2
    this.master_cfg[3].axi_interface_type = svt_axi_port_configuration::AXI4_STREAM;
    this.master_cfg[3].tdata_width   = AXI_STREAM_IFD2_DATA_WIDTH;
    this.master_cfg[3].is_active     = 1;
    this.master_cfg[3].tkeep_enable  = 0;
    this.master_cfg[3].tstrb_enable  = 0;
    this.master_cfg[3].tid_enable    = 0;
    this.master_cfg[3].tdest_enable  = 0;
    this.master_cfg[3].tuser_enable  = 0;
    this.master_cfg[3].protocol_checks_enable = 1;
    this.master_cfg[3].transaction_coverage_enable = 0;
...
`ifdef SLAVE_AGENT
    ...
    if ( ($test$plusargs("iau_tready_high")) ) begin
