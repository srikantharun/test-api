...
class axi_master_stream_base_sequence #(parameter int ADDR_WIDTH = 512) extends svt_axi_master_base_sequence;

  /** Parameter that controls the number of transactions that will be generated */
  rand int unsigned sequence_length = 10;
  rand logic    [ADDR_WIDTH-1:0] data [$];
  rand logic      [31:0] burst_length;

  constraint data_c {data.size == burst_length;}

 //Utility and Field macros,
  `uvm_object_utils_begin(axi_master_stream_base_sequence)
