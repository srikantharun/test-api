...
`endif
  ...
  logic rst_nc;
  always_comb rst_nc = i_wr_rst_n | i_rd_rst_n; // ASO-UNUSED_VARIABLE: reset is not always used
  logic impl_nc;
...
`endif
      ...
      for (genvar bank_index = 0; unsigned'(bank_index) < NumAddrBanks; bank_index++) begin : gen_addr_banks
        ...
        ln05lpe_a00_mc_rf2rwp_hsr_rvt_360x48m1b8c1r2_wrapper u_macro (
          ///////////////////////////////
          // Basic pins                //
          ///////////////////////////////
          ///////////////////////////////
    ...
    ////////////////////////////////////////////////////////
    {
      ...
      localparam int unsigned NumAddrBanks   = 16;
      localparam int unsigned BankAddrWidth  = unsigned'($clog2(NumAddrBanks));
      localparam int unsigned BankNumWords   = NumWords / NumAddrBanks;
      localparam int unsigned MacroAddrWidth = unsigned'($clog2(BankNumWords));
...
`endif
      ...
      for (genvar bank_index = 0; unsigned'(bank_index) < NumAddrBanks; bank_index++) begin : gen_addr_banks
        ...
        ln05lpe_a00_mc_rf2rwp_hsr_rvt_360x80m1b8c1r2_wrapper u_macro (
          ///////////////////////////////
          // Basic pins                //
          ///////////////////////////////
          ///////////////////////////////
