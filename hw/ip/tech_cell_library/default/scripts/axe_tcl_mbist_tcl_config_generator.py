...
class TclMbistConfigGenerator(ConfigFileGenerator):
    """
    ...
    def __init__(self, yaml_path: str, output_path: str):
        ...
        logger.debug(f"TclMbistConfigGenerator initialized with YAML path: {yaml_path} and output path: {output_path}")
    ...
    def format_memory_configuration(self, mem_ip_values):
        ...
        for suffix in formats:
            for subkey, subvalues_t in mem_ip_values.items():
                ...
                resolved_values = self.resolve_memory_values(subvalues, self.config['paths'], suffix)
                ...
                configuration_lines.append(f"    set {subkey}_{suffix.upper()} \"{resolved_values_string} \"")
    ...
    def resolve_memory_values(self, values: List[Dict[str, str]], paths_config: Dict[str, str], suffix: str ) -> List[str]:
        """
        ...
        Parameters:
            ...
            suffix (str): A str containing the three file formats required for mbist flow.
        Returns:
