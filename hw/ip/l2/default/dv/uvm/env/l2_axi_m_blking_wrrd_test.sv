// L2 AXI blocking write/read test
class l2_axi_m_blking_wrrd_test extends l2_base_test;

  // Factory registration
  `uvm_component_utils (l2_axi_m_blking_wrrd_test)

  // Class Constructor
  function new (string name="l2_axi_m_blking_wrrd_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    uvm_config_db#(int unsigned)::set(this, "env.axi_system_env.master[0].sequencer.svt_axi_master_blocking_write_read_sequence", "sequence_length", 1000);
...
endclass:l2_axi_m_blking_wrrd_test
