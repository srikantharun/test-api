class l2_parallel_wr_rd_check extends l2_base_test;

  //Registration with the factory
  `uvm_component_utils(l2_parallel_wr_rd_check)
  ...
  //class constructor
  function new (string name = "l2_parallel_wr_rd_check", uvm_component parent);
