// L2 AXI random test-case class
class l2_axi_rnd_test extends l2_base_test;

  // Registration with the factory
  `uvm_component_utils (l2_axi_rnd_test)

  // Class Constructor
  function new (string name="l2_axi_rnd_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    uvm_config_db#(int unsigned)::set(this, "env.axi_system_env.master[0].sequencer.svt_axi_master_random_sequence", "sequence_length", 10000);
