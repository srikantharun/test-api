`ifndef GUARD_CUST_L2_SVT_APB_SYSTEM_CONFIG_SV
`define GUARD_CUST_L2_SVT_APB_SYSTEM_CONFIG_SV
// Class
class cust_l2_svt_apb_system_cfg extends svt_apb_system_configuration;

  // Factory registration
  `uvm_object_utils (cust_l2_svt_apb_system_cfg)

  // Class Constructor
  function new (string name = "cust_l2_svt_apb_system_cfg");
...
`endif //GUARD_CUST_L2_SVT_APB_SYSTEM_CONFIG_SV
