...
%   if ((field.hwaccess.value[1] == HwAccess.NONE and\
       ...
       not field.swaccess.allows_write())):
      // constant reg
      ${reg_inst}.add_hdl_path_slice("${reg_field_name}_qs", ${field.bits.lsb}, ${field_size}, 0);
%   elif not reg.shadowed:
      ${reg_inst}.add_hdl_path_slice("u_${reg_field_name}.q${"s" if reg.hwext else ""}", ${field.bits.lsb}, ${field_size}, 0);
%   endif
%   if reg.shadowed and not reg.hwext:
      ${reg_inst}.add_hdl_path_slice("u_${reg_field_name}.committed_reg.q", ${field.bits.lsb}, ${field_size}, 0);
      ${reg_inst}.add_hdl_path_slice("u_${reg_field_name}.shadow_reg.q", ${field.bits.lsb}, ${field_size}, 0);
%   endif
% endfor
