...
if { $CHECK_MANUAL_CHANGES == 0 } {
    source /data/europa/pd/europa/constraints/dev_noc_ddr_west_p_0p8/export/clocks/${DESIGN}_shift_port_clocks.tcl
    ...
    set_clock_groups -asynchronous -name clk_1 -group [get_clocks {noc_clk }]  -group [get_clocks {ijtag_tck}] -group [get_clocks {test_clk}] 
