...
set_dft_signal -type Constant  -active_state 0 -hookup_pin ${AXVAR_DESIGN_NAME}_rtl2_tessent_ssn_scan_host_sh_inst/edt_update -view spec
set_dft_signal -type Constant  -active_state 0 -hookup_pin ${AXVAR_DESIGN_NAME}_rtl2_tessent_ssn_scan_host_sh_inst/edt_update -view exist
