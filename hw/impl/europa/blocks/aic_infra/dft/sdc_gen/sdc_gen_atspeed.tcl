...
read_verilog /data/europa/pd/aic_infra_p/block_build/dev_bronze_AM/build/fc/compile/results/aic_infra_p.mapped.v.gz
...
if { $CHECK_MANUAL_CHANGES == 0 } {
    ...
    #source $env(DFT_HOME)/aic_infra/Latest/tsdb/logic_test/tsdb_outdir/dft_inserted_designs/${DESIGN}_rtl2.dft_inserted_design/${DESIGN}.hierfix.sdc
