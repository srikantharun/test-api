...
set DESIGN_BASE aic_infra
set DESIGN ${DESIGN_BASE}_p
set DFT_HOME [getenv DFT_HOME]
set DFT_RELEASE "/data/releases/europa/dft/bronze/aic_infra/202412111017"
set SI_NETLIST  "/data/europa/pd/aic_infra_p/block_build/dev_bronze_AM/build/fc/compile/results/aic_infra_p.insert_dft.v"
...
#open_tsdb $DFT_HOME/$DESIGN_BASE/Latest/tsdb/logic_test/tsdb_outdir
