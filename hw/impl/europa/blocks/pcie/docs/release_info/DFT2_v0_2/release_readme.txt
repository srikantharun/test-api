...
as well as DFT constraints (atspeed, shift and mbist). mbist constraints are merged with functional constraints
while atspeed and shift should be executed standalne. Currently only functional constraints are fixed.
