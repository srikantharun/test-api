...
#Warning: No clock objects matched 'i_ref_clk' (SEL-004)
#Warning: No clock objects matched 'tck' (SEL-004)
#Warning: No clock objects matched 'ssn_bus_clk' (SEL-004)
#Warning: No clock objects matched 'i_clk' (SEL-004)
    ...
    set_clock_groups -asynchronous -name clk_1 -group [get_clocks $i_ref_clk] -group [get_clocks $tck] -group [get_clocks {ssn_clk $i_clk}]
