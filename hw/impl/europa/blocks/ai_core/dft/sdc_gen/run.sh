...
#srun -c8 pt_shell -file sdc_gen_ltest_disable.tcl -output_log_file sdc_gen_ltest_disable.log
# PT always prints 1 error, ignore it
#grep -q "Diagnostics summary: 1 error" sdc_gen_ltest_disable.log || (echo "Error: Unexpected errors in sdc_gen_ltest_disable" && exit 1)
...
for mode in Mbist Atspeed Shift ; do
