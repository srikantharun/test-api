...
if { $CHECK_MANUAL_CHANGES == 0 } {
    ...
    ##source /data/releases/europa/dft/nightly/ai_core/202411132250/tsdb/logic_test/tsdb_outdir/dft_inserted_designs/ai_core_p_rtl2.dft_inserted_design/ai_core_p.hierfix.sdc
