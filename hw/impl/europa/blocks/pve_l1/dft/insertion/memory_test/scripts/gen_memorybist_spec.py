...
# Initialize parser
parser = argparse.ArgumentParser(description="Generate MemoryBist specification for L1 main memory array.")
...
parser.add_argument(
  '-f',
  default=os.path.join(REPO_ROOT, 'hw/impl/europa/blocks/pve_l1/dft/insertion/memory_test/data/memory_grouping.hjson'),
...
def get_macro_string(mbank):
   bank = mbank%4
   minibank = mbank//4
   return f'u_pve_l1/u_l1/u_l1_mem/g_sbank[{bank}].u_sub_bank/g_mini_bank[{minibank}].u_mini_bank/g_macro[0].u_macro/gen_macro.u_macro'
