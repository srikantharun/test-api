  ...
  SSN {
    ...
    Datapath (d1) {
      ...
      ScanHost (sh) {
        ...
        ChainGroup (gi_pve_cva6v_0_0) {
	        input_chain_count : 12;
	        output_chain_count : 12;
	      }
        ChainGroup (gi_pve_cva6v_1_0) {
	        input_chain_count : 12;
	        output_chain_count : 12;
	      }
        ChainGroup (gi_pve_cva6v_2_0) {
	        input_chain_count : 12;
	        output_chain_count : 12;
	      }
        ChainGroup (gi_pve_cva6v_3_0) {
	        input_chain_count : 12;
	        output_chain_count : 12;
	      }
        ChainGroup (gi_pve_cva6v_0_1) {
	        input_chain_count : 12;
	        output_chain_count : 12;
	      }
        ChainGroup (gi_pve_cva6v_1_1) {
	        input_chain_count : 12;
	        output_chain_count : 12;
	      }
        ChainGroup (gi_pve_cva6v_2_1) {
	        input_chain_count : 12;
	        output_chain_count : 12;
	      }
        ChainGroup (gi_pve_cva6v_3_1) {
	        input_chain_count : 12;
	        output_chain_count : 12;
	      }
        ChainGroup (gi_pve_l1_0) {
	        input_chain_count : 12;
	        output_chain_count : 12;
	      }
        ChainGroup (gi_pve_l1_1) {
	        input_chain_count : 12;
	        output_chain_count : 12;
	      }
        ChainGroup (gi_pve_l1_2) {
	        input_chain_count : 12;
	        output_chain_count : 12;
	      }
        ChainGroup (gi_pve_l1_3) {
	        input_chain_count : 12;
	        output_chain_count : 12;
	      }
        ChainGroup (gx) {
        ...
        Connections {
          ChainGroup (gi_pve_cva6v_0_0) {
            to_scan_in : "u_pve/\g_cluster[0].u_cluster /\g_cpu[0].u_cva6v /scan_in";
            from_scan_out : "u_pve/\g_cluster[0].u_cluster /\g_cpu[0].u_cva6v /scan_out";
          }
          ChainGroup (gi_pve_cva6v_1_0) {
            to_scan_in : "u_pve/\g_cluster[1].u_cluster /\g_cpu[0].u_cva6v /scan_in";
            from_scan_out : "u_pve/\g_cluster[1].u_cluster /\g_cpu[0].u_cva6v /scan_out";
          }
          ChainGroup (gi_pve_cva6v_2_0) {
            to_scan_in : "u_pve/\g_cluster[2].u_cluster /\g_cpu[0].u_cva6v /scan_in";
            from_scan_out : "u_pve/\g_cluster[2].u_cluster /\g_cpu[0].u_cva6v /scan_out";
          }
          ChainGroup (gi_pve_cva6v_3_0) {
            to_scan_in : "u_pve/\g_cluster[3].u_cluster /\g_cpu[0].u_cva6v /scan_in";
            from_scan_out : "u_pve/\g_cluster[3].u_cluster /\g_cpu[0].u_cva6v /scan_out";
          }
          ChainGroup (gi_pve_cva6v_0_1) {
            to_scan_in : "u_pve/\g_cluster[0].u_cluster /\g_cpu[1].u_cva6v /scan_in";
            from_scan_out : "u_pve/\g_cluster[0].u_cluster /\g_cpu[1].u_cva6v /scan_out";
          }
          ChainGroup (gi_pve_cva6v_1_1) {
            to_scan_in : "u_pve/\g_cluster[1].u_cluster /\g_cpu[1].u_cva6v /scan_in";
            from_scan_out : "u_pve/\g_cluster[1].u_cluster /\g_cpu[1].u_cva6v /scan_out";
          }
          ChainGroup (gi_pve_cva6v_2_1) {
            to_scan_in : "u_pve/\g_cluster[2].u_cluster /\g_cpu[1].u_cva6v /scan_in";
            from_scan_out : "u_pve/\g_cluster[2].u_cluster /\g_cpu[1].u_cva6v /scan_out";
          }
          ChainGroup (gi_pve_cva6v_3_1) {
            to_scan_in : "u_pve/\g_cluster[3].u_cluster /\g_cpu[1].u_cva6v /scan_in";
            from_scan_out : "u_pve/\g_cluster[3].u_cluster /\g_cpu[1].u_cva6v /scan_out";
          }
          ChainGroup (gi_pve_l1_0) {
            to_scan_in : "u_pve/\g_cluster[0].u_cluster /u_pve_l1/scan_in";
            from_scan_out : "u_pve/\g_cluster[0].u_cluster /u_pve_l1/scan_out";
          }
          ChainGroup (gi_pve_l1_1) {
            to_scan_in : "u_pve/\g_cluster[1].u_cluster /u_pve_l1/scan_in";
            from_scan_out : "u_pve/\g_cluster[1].u_cluster /u_pve_l1/scan_out";
          }
          ChainGroup (gi_pve_l1_2) {
            to_scan_in : "u_pve/\g_cluster[2].u_cluster /u_pve_l1/scan_in";
            from_scan_out : "u_pve/\g_cluster[2].u_cluster /u_pve_l1/scan_out";
          }
          ChainGroup (gi_pve_l1_3) {
            to_scan_in : "u_pve/\g_cluster[3].u_cluster /u_pve_l1/scan_in";
            from_scan_out : "u_pve/\g_cluster[3].u_cluster /u_pve_l1/scan_out";
          }
        }
      }
...
proc process_dft_specification.post_insertion {[get_current_design] args} {
  ...
  foreach_in_collection cell $wrapper_cells {
    ...
    if {[regexp {tessent_persistent_cell_0_d*} $leaf]} {
      echo $leaf
      delete_connection $leaf
      create_connection pve_p_rtl2_tessent_occ_i_clk_inst/clock_out $leaf
    }
  }

  delete_connection u_pve/scan_en
  create_connection pve_p_rtl2_tessent_ssn_scan_host_sh_inst/scan_en u_pve/scan_en
}
