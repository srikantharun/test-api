...
if { $CHECK_MANUAL_CHANGES == 0 } {
    ...
    source $env(DFT_HOME)/pve_cva6v/202411121318/tsdb/logic_test/tsdb_outdir/dft_inserted_designs/pve_cva6v_p_rtl2.dft_inserted_design/pve_cva6v_p.hierfix.sdc
