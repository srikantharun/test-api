...
## Tessent renames the path of an include file in hw/impl/europa/blocks/pve_cva6v/dft/insertion/memory_test/tsdb_outdir/dft_inserted_designs/pve_cva6v_p_rtl1.dft_inserted_design/modified_rtl_files/data_foundry/pve_cva6v_p_cva6v_top.sv
## I am using sed to revert it, until we find a permanent solution

#exec sed -i "s|pve_cva6v_p_registers_1.svh|raptor_cells/registers.svh|g" ${GIT_ROOT}/hw/impl/europa/blocks/pve_cva6v/dft/insertion/memory_test/tsdb_outdir/dft_inserted_designs/pve_cva6v_p_rtl1.dft_inserted_design/modified_rtl_files/data_foundry/pve_cva6v_p_cva6v_top.sv
