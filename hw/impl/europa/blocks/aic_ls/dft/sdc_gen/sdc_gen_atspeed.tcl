...
#
# Description: PT script to process DFT constraints for LS.
...
read_verilog /data/europa/pd/aic_ls_p/block_build/dev_bronze_AM/build/fc/compile/results/aic_ls_p.mapped.v.gz
...
if { $CHECK_MANUAL_CHANGES == 0 } {
    ...
    #source /data/releases/europa/dft/bronze/aic_ls/Latest/tsdb/logic_test/tsdb_outdir/dft_inserted_designs/${DESIGN}_rtl2.dft_inserted_design/${DESIGN}.hierfix.sdc
