...
if { $CHECK_MANUAL_CHANGES == 0 } {
    ...
    source /data/europa/pd/europa/constraints/dev_soc_mgmt_p/export_250130/clocks/soc_mgmt_p_shift_port_clocks.tcl
    source /data/europa/pd/europa/constraints/dev_soc_mgmt_p/export_250130/clocks/soc_mgmt_p_shift_pin_clocks.tcl
    ...
    set_clock_groups -asynchronous -name clk_1 -group [get_clocks {ssn_clk}]  \
