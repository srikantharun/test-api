...
// -------------------------------------------------------------------------
// -- Revision: $Id: //dwh/ddr_iip/umctl5/DWC_ddrctl_lpddr54_MAIN_BR/DWC_ddr_umctl5/src/xpi/field_packer13.sv#1 $
// -------------------------------------------------------------------------
// Description:
//     other sizes of field_packer are available in the following location:
//     src/unused_modules/DWC_ddr_umctl2_field_packer.v
`include "DWC_ddrctl_all_defs.svh"
module field_packer13
  (
   // Outputs
   out0,out1,out2,out3,out4,out5,out6,out7,out8,out9,out10,out11,out12,pack_out,
   // Inputs
   in0,in1,in2,in3,in4,in5,in6,in7,in8,in9,in10,in11,in12,pack_in
   );
  ...
  localparam WALL = W0+W1+W2+W3+W4+W5+W6+W7+W8+W9+W10+W11+W12;
...
//SMD: Self determined expression '(W1 + W0)' found in module 'field_packer13'
