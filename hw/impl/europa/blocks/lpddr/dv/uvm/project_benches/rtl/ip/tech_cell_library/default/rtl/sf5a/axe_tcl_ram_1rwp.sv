...
/* TODO(jmartins, Bronze, Figure out if SPM is able to use the same memory as APU)
    ////////////////////////////
    // SPM memory macro -- 2k //
    ////////////////////////////
    {
...
`endif
    ...
    //////////////////////////////
    {
      ...
      ln05lpe_a00_mc_rf1rp_hsr_rvt_296x122m2b1c1r2_wrapper u_macro (
        ...
        .WEN   (wr_enable_n),        // Write enable, active low
        .A     (address),            // Address input bus
        .DI    (wr_data[121:0]),     // Data input bus  TODO: slices
        .DOUT  (o_rd_data[121:0]),   // Data output bus TODO: slices
        ///////////////////////////////
        // Margin Adjustment Pins    //
        ///////////////////////////////
        .MCS   (axe_tcl_pkg::MCS),   // Margin control selection
    ...
    //////////////////////////////
    {
      ...
      ln05lpe_a00_mc_rf1rp_hsr_rvt_256x124m2b1c1r2_wrapper u_macro (
        ...
        .WEN   (wr_enable_n),        // Write enable, active low
        .A     (address),            // Address input bus
        .DI    (wr_data[123:0]),     // Data input bus  TODO: slicing
        .DOUT  (o_rd_data[123:0]),   // Data output bus TODO: slicing
        ///////////////////////////////
        // Margin Adjustment Pins    //
        ///////////////////////////////
        .MCS   (axe_tcl_pkg::MCS),   // Margin control selection
    ...
    //////////////////////////////
    {
      ...
      ln05lpe_a00_mc_rf1rp_hsr_rvt_248x102m2b1c1r2_wrapper u_macro (
        ...
        .WEN   (wr_enable_n),        // Write enable, active low
        .A     (address),            // Address input bus
        .DI    (wr_data[101:0]),     // Data input bus  TODO: slicing
        .DOUT  (o_rd_data[101:0]),   // Data output bus TODO: slicing
        ///////////////////////////////
        // Margin Adjustment Pins    //
        ///////////////////////////////
        .MCS   (axe_tcl_pkg::MCS),   // Margin control selection
    ...
    //////////////////////////////
    {
      ...
      ln05lpe_a00_mc_rf1rp_hsr_rvt_200x14m2b1c1r2_wrapper u_macro (
        ...
        .WEN   (wr_enable_n),        // Write enable, active low
        .A     (address),            // Address input bus
        .DI    (wr_data[13:0]),      // Data input bus  TODO: slicing
        .DOUT  (o_rd_data[13:0]),    // Data output bus TODO: slicing
        ///////////////////////////////
        // Margin Adjustment Pins    //
        ///////////////////////////////
        .MCS   (axe_tcl_pkg::MCS),   // Margin control selection
    ...
    //////////////////////////////
    {
      ...
      ln05lpe_a00_mc_rf1rp_hsr_rvt_32x74m2b1c1r2_wrapper u_macro (
        ...
        .WEN   (wr_enable_n),        // Write enable, active low
        .A     (address),            // Address input bus
        .DI    (wr_data[73:0]),      // Data input bus  TODO: slicing
        .DOUT  (o_rd_data[73:0]),    // Data output bus TODO: slicing
        ///////////////////////////////
        // Margin Adjustment Pins    //
        ///////////////////////////////
        .MCS   (axe_tcl_pkg::MCS),   // Margin control selection
    ...
    ///////////////////////////////////////////////
    {
      ...
      ln05lpe_a00_mc_rf1rwp_hsr_rvt_256x60m2b1c1r2_wrapper u_macro (
        ...
        .CSN   (chip_select_n),      // Chip enable, active low
        .WEN   (wr_enable_n),        // Write enable, active low
        .BWEN  (wr_bit_enable_n[59:0]), // Write mask enable input bus TODO: slices
        .A     (address),            // Address input bus
        .DI    (wr_data[59:0]),      // Data input bus  TODO: slices
        .DOUT  (o_rd_data[59:0]),    // Data output bus TODO: slices
        ///////////////////////////////
        // Margin Adjustment Pins    //
        ///////////////////////////////
        .MCS   (axe_tcl_pkg::MCS),   // Margin control selection
    ...
    ///////////////////////////////////////////////
    {
      ...
      ln05lpe_a00_mc_rf1rwp_hsr_rvt_64x98m2b1c1r2_wrapper u_macro (
        ...
        .CSN   (chip_select_n),      // Chip enable, active low
        .WEN   (wr_enable_n),        // Write enable, active low
        .BWEN  (wr_bit_enable_n[97:0]), // Write mask enable input bus // TODO: slices
        .A     (address),            // Address input bus
        .DI    (wr_data[97:0]),      // Data input bus  // TODO: slices
        .DOUT  (o_rd_data[97:0]),    // Data output bus // TODO: slices
        ///////////////////////////////
        // Margin Adjustment Pins    //
        ///////////////////////////////
        .MCS   (axe_tcl_pkg::MCS),   // Margin control selection
    ...
    ///////////////////////////////////////////////
    {
      ...
      ln05lpe_a00_mc_rf1rwp_hsr_rvt_64x58m2b1c1r2_wrapper u_macro (
        ...
        .CSN   (chip_select_n),      // Chip enable, active low
        .WEN   (wr_enable_n),        // Write enable, active low
        .BWEN  (wr_bit_enable_n[57:0]), // Write mask enable input bus TODO: slices
        .A     (address),            // Address input bus
        .DI    (wr_data[57:0]),      // Data input bus  TODO: slices
        .DOUT  (o_rd_data[57:0]),    // Data output bus TODO: slices
        ///////////////////////////////
        // Margin Adjustment Pins    //
        ///////////////////////////////
        .MCS   (axe_tcl_pkg::MCS),   // Margin control selection
