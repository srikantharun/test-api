...
//
// Description : DWC_ddrctl_bcm57.v Verilog module for DWC_ddrctl
//
// DesignWare IP ID: 85ad50f4
//
////////////////////////////////////////////////////////////////////////////////



  module DWC_ddrctl_bcm57 (
        clk,
        rst_n,
        wr_n,
        data_in,
...
// SJ: Current release uses ordered list for parameters, the design is checked and verified without errors
   ...
   parameter integer DATA_WIDTH = 4;    // RANGE 1 to 8192
   parameter integer DEPTH = 8;         // RANGE 2 to 2048
   parameter integer MEM_MODE = 0;      // RANGE 0 to 3
   parameter integer ADDR_WIDTH = 3;    // RANGE 1 to 11
...
// SMD: Width of index is larger than what is required to represent the max value
// SJ: The variable indexing the vector/array is made sure to be OK.
