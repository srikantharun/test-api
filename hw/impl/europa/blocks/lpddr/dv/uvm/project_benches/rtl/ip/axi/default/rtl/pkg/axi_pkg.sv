...
package axi_pkg;
  ...
  function automatic axi_largest_addr_t axi_wrap_boundary(
    ...
    `ifndef SYNTHESIS
    // TODO(wroennin): Align with verif on macro name
  ...
  function automatic axi_largest_addr_t axi_beat_addr(
    ...
    // TODO(wroennin): check that these calculations are correct with the shifts!
    ret_addr = addr;
    wrp_bond = '0;
    tnx_size = '0;
  ...
  // TODO(wroennin): Have a discussion if atomics should be categorized differently.
  // ATOP[5:0]
