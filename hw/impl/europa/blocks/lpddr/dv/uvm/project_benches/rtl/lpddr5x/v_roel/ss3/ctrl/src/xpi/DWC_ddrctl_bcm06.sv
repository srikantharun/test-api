...
//
// Description : DWC_ddrctl_bcm06.v Verilog module for DWC_ddrctl
//
// DesignWare IP ID: 97d25f72
//
////////////////////////////////////////////////////////////////////////////////

module DWC_ddrctl_bcm06 (
    clk,
    rst_n,
    init_n,
    push_req_n,
...
parameter integer DEPTH  = 4;           // RANGE 2 to 16777216
parameter integer ERR_MODE  =  0 ;      // RANGE 0 to 2
parameter integer ADDR_WIDTH = 2;       // RANGE 1 to 24
localparam ERR_MODE_L2B = ERR_MODE & 3;
...
generate
  if (ERR_MODE_L2B  == 0) begin : GEN_EM_EQ0
...
`ifndef SYNTHESIS
  ...
  DWC_ddrctl_sva12_b P_RESET_PUSH(
    .clk(clk),
    .rst_n(rst_n),
    .init_n(init_n),
    .req_n(push_req_n)
  ...
  DWC_ddrctl_sva12_b P_RESET_POP(
    .clk(clk),
    .rst_n(rst_n),
    .init_n(init_n),
    .req_n(pop_req_n)
