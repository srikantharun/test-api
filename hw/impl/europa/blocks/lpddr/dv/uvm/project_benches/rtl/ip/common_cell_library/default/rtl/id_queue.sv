...
module id_queue #(
  ...
  // Sanitation //
  ////////////////
  if (ID_WIDTH == 0) $fatal(1, "Parameter: 'ID_WIDTH' The ID must at least be one bit wide!;");
  if (CAPACITY == 0) $fatal(1, "Parameter: 'CAPACITY' The queue must have capacity of at least one entry!;");
  ...
  ////////////////////////
    ...
    localparam int unsigned HtIdxWidth = cc_math_pkg::index_width(HtCapacity);
    localparam int unsigned LdIdxWidth = cc_math_pkg::index_width(CAPACITY);
    ...
    cc_decode_onehot #(
      ...
      .i_onehot(idx_matches_in_id),
      .o_binary(match_in_idx),
      .o_empty (/*open*/),
      .o_error (/*open*/)
    );
    cc_decode_onehot #(
      ...
      .i_onehot(idx_matches_out_id),
      .o_binary(match_out_idx),
      .o_empty (/*open*/),
      .o_error (/*open*/)
    );
