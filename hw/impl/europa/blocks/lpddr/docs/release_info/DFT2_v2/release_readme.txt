...
- Fixed missing *obs and *intr IO constraints in func mode. Flagged in solvnet case 01786908 
- Add scan atspeed and scan shift timing constraints
- Fixes to scan insertion scripts.
