...
- DFT constraint update to match latest mapped netlist on SNPS side
- DFT scan scripting update to intercept PHY requirement of uncompressed scan chain
- DFT pipeline stage added for ssn output
- DFT update ext-test scan chain from 11 to 10.
