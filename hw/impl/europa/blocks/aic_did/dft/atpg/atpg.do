...
set DESIGN_BASE aic_did
set DESIGN ${DESIGN_BASE}_p
set DFT_HOME [getenv DFT_HOME]
set DFT_RELEASE "/data/releases/europa/dft/bronze/aic_did/202412110726"
set SI_NETLIST "/data/europa/pd/aic_did_p/block_build/dev_alfonso/build/fc/compile/results/aic_did_p.insert_dft.v"
