...
puts "INFO: constraining '{o_*_axi* o_*_tok_* o_*_obs o_irq o_ts_* o_acd_sync}' against 'fast_clk'"
set_output_delay -min 0.042 -clock fast_clk [get_ports {o_*_axi* o_*_tok_* o_*_obs o_irq o_ts_* o_acd_sync}]
set_output_delay -max 0.583 -clock fast_clk [get_ports {o_*_axi* o_*_tok_* o_*_obs o_irq o_ts_* o_acd_sync}]
...
set_false_path  -to [get_ports o_sram_prn]
