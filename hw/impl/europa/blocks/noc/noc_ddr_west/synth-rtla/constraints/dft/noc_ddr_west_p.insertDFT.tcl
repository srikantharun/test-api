##########################################################################################
# Script: noc_ddr_west_p.insertDFT.tcl
#
...
# Resets
set_dft_signal -type Reset -active_state 0 -port i_ddr_wpll_aon_rst_n -view spec
set_dft_signal -type Reset -active_state 0 -port i_ddr_wpll_aon_rst_n -view exist
set_dft_signal -type Reset -active_state 0 -port i_lpddr_graph_0_aon_rst_n -view spec
set_dft_signal -type Reset -active_state 0 -port i_lpddr_graph_0_aon_rst_n -view exist
set_dft_signal -type Reset -active_state 0 -port i_lpddr_graph_0_rst_n -view spec
set_dft_signal -type Reset -active_state 0 -port i_lpddr_graph_0_rst_n -view exist
set_dft_signal -type Reset -active_state 0 -port i_lpddr_graph_1_aon_rst_n -view spec
set_dft_signal -type Reset -active_state 0 -port i_lpddr_graph_1_aon_rst_n -view exist
set_dft_signal -type Reset -active_state 0 -port i_lpddr_graph_1_rst_n -view spec
set_dft_signal -type Reset -active_state 0 -port i_lpddr_graph_1_rst_n -view exist
set_dft_signal -type Reset -active_state 0 -port i_lpddr_graph_2_aon_rst_n -view spec
set_dft_signal -type Reset -active_state 0 -port i_lpddr_graph_2_aon_rst_n -view exist
set_dft_signal -type Reset -active_state 0 -port i_lpddr_graph_2_rst_n -view spec
set_dft_signal -type Reset -active_state 0 -port i_lpddr_graph_2_rst_n -view exist
set_dft_signal -type Reset -active_state 0 -port i_lpddr_graph_3_aon_rst_n -view spec
set_dft_signal -type Reset -active_state 0 -port i_lpddr_graph_3_aon_rst_n -view exist
set_dft_signal -type Reset -active_state 0 -port i_lpddr_graph_3_rst_n -view spec
set_dft_signal -type Reset -active_state 0 -port i_lpddr_graph_3_rst_n -view exist
...
# Clocks
set_dft_signal -type ScanClock -port i_ddr_wpll_aon_clk -timing {45 55} -view spec
set_dft_signal -type ScanClock -port i_ddr_wpll_aon_clk -timing {45 55} -view exist
set_dft_signal -type ScanClock -port i_lpddr_graph_0_aon_clk -timing {45 55} -view spec
set_dft_signal -type ScanClock -port i_lpddr_graph_0_aon_clk -timing {45 55} -view exist
set_dft_signal -type ScanClock -port i_lpddr_graph_0_clk -timing {45 55} -view spec
set_dft_signal -type ScanClock -port i_lpddr_graph_0_clk -timing {45 55} -view exist
set_dft_signal -type ScanClock -port i_lpddr_graph_1_aon_clk -timing {45 55} -view spec
set_dft_signal -type ScanClock -port i_lpddr_graph_1_aon_clk -timing {45 55} -view exist
set_dft_signal -type ScanClock -port i_lpddr_graph_1_clk -timing {45 55} -view spec
set_dft_signal -type ScanClock -port i_lpddr_graph_1_clk -timing {45 55} -view exist
set_dft_signal -type ScanClock -port i_lpddr_graph_2_aon_clk -timing {45 55} -view spec
set_dft_signal -type ScanClock -port i_lpddr_graph_2_aon_clk -timing {45 55} -view exist
set_dft_signal -type ScanClock -port i_lpddr_graph_2_clk -timing {45 55} -view spec
set_dft_signal -type ScanClock -port i_lpddr_graph_2_clk -timing {45 55} -view exist
set_dft_signal -type ScanClock -port i_lpddr_graph_3_aon_clk -timing {45 55} -view spec
set_dft_signal -type ScanClock -port i_lpddr_graph_3_aon_clk -timing {45 55} -view exist
set_dft_signal -type ScanClock -port i_lpddr_graph_3_clk -timing {45 55} -view spec
set_dft_signal -type ScanClock -port i_lpddr_graph_3_clk -timing {45 55} -view exist
