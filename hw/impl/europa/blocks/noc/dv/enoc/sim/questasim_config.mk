...
VSIM_VLOG_OPTS_EXT += -suppress 7060,2147,13262,2577,2897,7070,2388
...
VSIM_VOPT_OPTS_EXT += -suppress 3838,12003,7045
...
#(vsim-16053) Assoc. array key '32'hxxxxxxxx' must not contain X's or Z's.
VSIM_ELAB_OPTS_EXT += -suppress 16053,3837
