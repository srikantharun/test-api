...
if { $CHECK_MANUAL_CHANGES == 0 } {
    source /data/europa/pd/europa/constraints/dev_noc_soc_p_0.9/clocks/results/atspeed/noc_soc_p_port_clocks.tcl
    set i_clk [get_attribute -objects [get_ports i_noc_clk] -name clocks]

  
source /data/releases/europa/dft/bronze/noc_soc/202412102059/tsdb/logic_test/tsdb_outdir/dft_inserted_designs/noc_soc_p_rtl2.dft_inserted_design/${DESIGN}.hierfix.sdc
