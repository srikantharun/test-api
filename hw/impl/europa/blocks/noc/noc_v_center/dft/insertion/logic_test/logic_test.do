...
if { $USE_MBIST_TSDB == 0 } {
    ...
    add_clock 0 i_sdma_0_aon_clk -period 20ns
    add_clock 0 i_sdma_0_clk -period 0.833ns
    add_clock 0 i_sdma_1_aon_clk -period 20ns
    add_clock 0 i_sdma_1_clk -period 0.833ns

    add_input_constraints i_noc_rst_n          -c1
    add_input_constraints i_sdma_0_aon_rst_n   -c1
    add_input_constraints i_sdma_0_rst_n       -c1
    add_input_constraints i_sdma_1_aon_rst_n   -c1
    add_input_constraints i_sdma_1_rst_n       -c1
}
