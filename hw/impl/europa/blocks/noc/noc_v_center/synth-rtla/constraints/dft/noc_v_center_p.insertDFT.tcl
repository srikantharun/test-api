##########################################################################################
# Script: noc_v_center.insertDFT.tcl
#
...
set_dft_signal -type Reset -active_state 0 -port i_sdma_0_aon_rst_n -view spec
set_dft_signal -type Reset -active_state 0 -port i_sdma_0_aon_rst_n -view exist
set_dft_signal -type Reset -active_state 0 -port i_sdma_0_rst_n -view spec
set_dft_signal -type Reset -active_state 0 -port i_sdma_0_rst_n -view exist
set_dft_signal -type Reset -active_state 0 -port i_sdma_1_aon_rst_n -view spec
set_dft_signal -type Reset -active_state 0 -port i_sdma_1_aon_rst_n -view exist
set_dft_signal -type Reset -active_state 0 -port i_sdma_1_rst_n -view spec
set_dft_signal -type Reset -active_state 0 -port i_sdma_1_rst_n -view exist
# Clocks
...
set_dft_signal -type ScanClock -port i_sdma_0_aon_clk -timing {45 55} -view spec
set_dft_signal -type ScanClock -port i_sdma_0_clk -timing {45 55} -view spec
set_dft_signal -type ScanClock -port i_sdma_1_aon_clk -timing {45 55} -view spec
set_dft_signal -type ScanClock -port i_sdma_1_clk -timing {45 55} -view spec
# Scan Enable
