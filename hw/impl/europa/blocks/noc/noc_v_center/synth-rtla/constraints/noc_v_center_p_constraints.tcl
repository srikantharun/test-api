...
set_input_delay -clock "sdma_0_aon_clk" [expr ${sdma_0_aon_clk_P}*0.7] [get_ports "i_sdma_0_aon_rst_n"]
set_input_delay -clock "sdma_0_clk" [expr ${sdma_0_clk_P}*0.7] [get_ports "i_sdma_0_rst_n"]
set_input_delay -clock "sdma_1_aon_clk" [expr ${sdma_1_aon_clk_P}*0.7] [get_ports "i_sdma_1_aon_rst_n"]
set_input_delay -clock "sdma_1_clk" [expr ${sdma_1_clk_P}*0.7] [get_ports "i_sdma_1_rst_n"]
