...
if { $CHECK_MANUAL_CHANGES == 0 } {
    source /data/europa/pd/europa/constraints/dev_noc_ddr_east_p_0p9c/export/clocks/noc_ddr_east_p_shift_port_clocks.tcl 
    ...
    set_clock_groups -asynchronous -name clk_1 -group [get_clocks {tessent_test_clock noc_clk lpddr_ppp_0_clk lpddr_ppp_1_clk lpddr_ppp_2_clk lpddr_ppp_3_clk lpddr_ppp_0_aon_clk lpddr_ppp_1_aon_clk lpddr_ppp_2_aon_clk lpddr_ppp_3_aon_clk soc_periph_aon_clk soc_periph_clk}] -group [get_clocks {ijtag_tck}]
