...
infile=${DFT_HOME}"/noc_h_south/Latest/tsdb/logic_test/tsdb_outdir/dft_inserted_designs/noc_h_south_p_rtl2.dft_inserted_design/noc_h_south_p.sdc"
...
sed -r \
    ...
    $infile > noc_h_south_p.hierfix.sdc
