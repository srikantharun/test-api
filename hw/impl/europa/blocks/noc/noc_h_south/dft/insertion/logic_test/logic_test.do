...
# Mem lib
if {[info exists MEM_LIBS_MEMLIB]} {
  read_mem_libs
}
...
if { $USE_MBIST_TSDB == 0 } {
    add_clock 0 i_aic_0_aon_clk -period 20.000ns
    add_clock 0 i_aic_0_clk -period 0.833ns
    add_clock 0 i_aic_1_aon_clk -period 20.000ns
    add_clock 0 i_aic_1_clk -period 0.833ns
    add_clock 0 i_aic_2_aon_clk -period 20.000ns
    add_clock 0 i_aic_2_clk -period 0.833ns
    add_clock 0 i_aic_3_aon_clk -period 20.000ns
    add_clock 0 i_aic_3_clk -period 0.833ns
    add_clock 0 i_l2_0_aon_clk -period 20.000ns
    add_clock 0 i_l2_0_clk -period 0.833ns
    add_clock 0 i_l2_1_aon_clk -period 20.000ns
    add_clock 0 i_l2_1_clk -period 0.833ns
    add_clock 0 i_l2_2_aon_clk -period 20.000ns
    add_clock 0 i_l2_2_clk -period 0.833ns
    add_clock 0 i_l2_3_aon_clk -period 20.000ns
    add_clock 0 i_l2_3_clk -period 0.833ns
    add_clock 0 i_noc_clk -period 0.833ns

    add_input_constraints i_aic_0_aon_rst_n -C1
    add_input_constraints i_aic_0_rst_n -C1
    add_input_constraints i_aic_1_aon_rst_n -C1
    add_input_constraints i_aic_1_rst_n -C1
    add_input_constraints i_aic_2_aon_rst_n -C1
    add_input_constraints i_aic_2_rst_n -C1
    add_input_constraints i_aic_3_aon_rst_n -C1
    add_input_constraints i_aic_3_rst_n -C1
    add_input_constraints i_l2_0_aon_rst_n -C1
    add_input_constraints i_l2_0_rst_n -C1
    add_input_constraints i_l2_1_aon_rst_n -C1
    add_input_constraints i_l2_1_rst_n -C1
    add_input_constraints i_l2_2_aon_rst_n -C1
    add_input_constraints i_l2_2_rst_n -C1
    add_input_constraints i_l2_3_aon_rst_n -C1
    add_input_constraints i_l2_3_rst_n -C1
