...
if { $USE_MBIST_TSDB == 0 } {
    add_clock 0 i_aic_4_aon_clk -period 20.000ns
    add_clock 0 i_aic_4_clk -period 0.833ns
    add_clock 0 i_aic_5_aon_clk -period 20.000ns
    add_clock 0 i_aic_5_clk -period 0.833ns
    add_clock 0 i_aic_6_aon_clk -period 20.000ns
    add_clock 0 i_aic_6_clk -period 0.833ns
    add_clock 0 i_aic_7_aon_clk -period 20.000ns
    add_clock 0 i_aic_7_clk -period 0.833ns
    add_clock 0 i_l2_4_aon_clk -period 20.000ns
    add_clock 0 i_l2_4_clk -period 0.833ns
    add_clock 0 i_l2_5_aon_clk -period 20.000ns
    add_clock 0 i_l2_5_clk -period 0.833ns
    add_clock 0 i_l2_6_aon_clk -period 20.000ns
    add_clock 0 i_l2_6_clk -period 0.833ns
    add_clock 0 i_l2_7_aon_clk -period 20.000ns
    add_clock 0 i_l2_7_clk -period 0.833ns
    add_clock 0 i_noc_clk -period 0.833ns

    add_input_constraints i_aic_4_aon_rst_n -C1
    add_input_constraints i_aic_4_rst_n -C1
    add_input_constraints i_aic_5_aon_rst_n -C1
    add_input_constraints i_aic_5_rst_n -C1
    add_input_constraints i_aic_6_aon_rst_n -C1
    add_input_constraints i_aic_6_rst_n -C1
    add_input_constraints i_aic_7_aon_rst_n -C1
    add_input_constraints i_aic_7_rst_n -C1
    add_input_constraints i_l2_4_aon_rst_n -C1
    add_input_constraints i_l2_4_rst_n -C1
    add_input_constraints i_l2_5_aon_rst_n -C1
    add_input_constraints i_l2_5_rst_n -C1
    add_input_constraints i_l2_6_aon_rst_n -C1
    add_input_constraints i_l2_6_rst_n -C1
    add_input_constraints i_l2_7_aon_rst_n -C1
    add_input_constraints i_l2_7_rst_n -C1
