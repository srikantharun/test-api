...
if { $CHECK_MANUAL_CHANGES == 0 } {
    source /data/europa/pd/europa/constraints/dev/export/clocks/noc_h_north_p_shift_port_clocks.tcl 
    ...
    set_clock_groups -asynchronous -name clk_1  -group [get_clocks { aic_4_clk aic_5_clk aic_6_clk aic_7_clk l2_4_clk l2_5_clk l2_6_clk l2_7_clk noc_clk}] -group [get_clocks {ijtag_tck}] 
