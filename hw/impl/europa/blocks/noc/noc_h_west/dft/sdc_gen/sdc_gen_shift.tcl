...
if { $CHECK_MANUAL_CHANGES == 0 } {
    source /data/europa/pd/europa/constraints/dev_noc_h_west_p/clocks/results/shift/noc_h_west_p_port_clocks.tcl
    #test_clk will be defined by tessent sdc
    remove_clock test_clk
    
    source /data/releases/europa/dft/bronze/noc_h_west/Latest/tsdb/logic_test/tsdb_outdir/dft_inserted_designs/noc_h_west_p_rtl2.dft_inserted_design/noc_h_west_p.hierfix.sdc 
