##########################################################################################
# Script: sdc_gen_dft_disable.tcl
#
...
#
#              dft disable side sdc for func mode
#
...
if { $CHECK_MANUAL_CHANGES == 0 } {
  ...
  read_sdc ../../synth-rtla/constraints/dft/${DESIGN}.dft_disable.sdc
}
...
#write sdc
write_sdc -nosplit ${DESIGN}.dft_disable.sdc
