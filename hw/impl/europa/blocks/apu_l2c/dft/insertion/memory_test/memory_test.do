...
dofile ./proc_memory_grouping.tcl
...
add_clock 0 i_clk -period 0.833ns ;# 0.833 period in constraint
add_clock 0 i_l2c_banks_clk -period 1.666ns ;# i_clk * 2
add_clock 0 i_aclk -period 0.833ns

add_input_constraints i_rst_n  -c1
add_input_constraints i_arst_n -c1
...
# apply memory grouping
axe_add_memory_grouping
