##########################################################################################
# Script: alg_core_wrapper.insertDFT.tcl
#
...
# Resets
set_dft_signal -type Reset -active_state 0 -port rstn -view spec
set_dft_signal -type Reset -active_state 0 -port rstn -view exist
...
# Clocks
set_dft_signal -type ScanClock -port clk -timing {45 55} -view spec
set_dft_signal -type ScanClock -port clk -timing {45 55} -view exist
...
set_dft_signal -type Constant -active_state 1 -hookup_pin ${AXVAR_DESIGN_NAME}_rtl1_tessent_sib_sti_inst/ltest_to_en -view exist
