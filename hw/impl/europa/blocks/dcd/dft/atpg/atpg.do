...
open_tsdb /data/releases/europa/dft/bronze/dcd_core/202412100911/tsdb/memory_test/tsdb_outdir
open_tsdb /data/releases/europa/dft/bronze/dcd_core/202412100911/tsdb/logic_test/tsdb_outdir
open_tsdb /data/releases/europa/dft/bronze/dcd/202412191150/tsdb/logic_test/tsdb_outdir
open_tsdb /data/releases/europa/dft/bronze/dcd/202412191150/tsdb/logic_test/tsdb_outdir

read_design alg_core_wrapper -design_id ${DESIGN_ID} -no_hdl
read_design dcd_p -design_id ${DESIGN_ID} -no_hdl

read_verilog /data/europa/pd/alg_core_wrapper/block_build/dev_bronze5_run1/build/fc/compile/results/alg_core_wrapper.insert_dft.v.gz
read_verilog /data/europa/pd/dcd_p/block_build/dev_bronze5_run1/build/fc/compile/results/dcd_p.insert_dft.v.gz

set_module_matching_options -prefix_pattern_list {dcd_p_ alg_core_wrapper_ } -suffix_pattern_list {_[0-9]+} -regexp
