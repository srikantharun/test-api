...
read_verilog -format sv2009 $env(DFT_HOME)/dcd_core/Latest/tsdb/logic_test/tsdb_outdir/dft_inserted_designs/alg_core_wrapper_rtl2.dft_inserted_design/alg_core_wrapper.sv09_interface
...
add_clock 0 i_clk -period 1.66ns
add_clock 0 i_mcu_clk -period 0.833ns
