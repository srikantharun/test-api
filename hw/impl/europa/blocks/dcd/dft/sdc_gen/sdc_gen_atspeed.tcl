...
if { $CHECK_MANUAL_CHANGES == 0 } {
    ...
    set tessent_clock_mapping(i_mcu_clk) $i_mcu_clk
    ...
    set_clock_groups -asynchronous -name clk_1 -group [get_clocks $i_mcu_clk] -group [get_clocks $i_clk] -group [get_clocks {ijtag_tck}] -group [get_clocks {ssn_clk}]
