...
#
# Description: PT script to process DFT constraints for SYS_SPM.
...
read_verilog /data/europa/pd/sys_spm_p/block_build/dev_NOV18_dft_bronze_atspeed/build/sys_spm_p.mapped.v.gz
...
if { $CHECK_MANUAL_CHANGES == 0 } {
    ...
    source $env(DFT_HOME)/sys_spm/Latest/tsdb/logic_test/tsdb_outdir/dft_inserted_designs/${DESIGN}_rtl2.dft_inserted_design/${DESIGN}.hierfix.sdc
