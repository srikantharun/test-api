...
open_tsdb $DFT_HOME/sys_spm/Latest/tsdb/memory_test/tsdb_outdir
open_tsdb $DFT_HOME/sys_spm/Latest/tsdb/logic_test/tsdb_outdir

read_design ${DESIGN} -design_id rtl2 -no_hdl

#read_verilog /data/europa/pd/sys_spm_p/block_build/dev_Dec10rerun/build/fc/compile/results/sys_spm_p.insert_dft.v.gz
read_verilog /data/europa/pd/sys_spm_p/block_build/dev_Dec10rerun/export_check/sys_spm_p.insert_dft.v.gz
