...
puts "INFO: constraining '{i_lt_axi_* i_noc_*}' against 'fast_clk'"
set_input_delay -min 0.042 -clock fast_clk [get_ports {i_lt_axi_* i_noc_*}]
set_input_delay -max 0.583 -clock fast_clk [get_ports {i_lt_axi_* i_noc_*}]

puts "INFO: constraining '{o_lt_axi_* o_noc_* o_irq}' against 'fast_clk'"
set_output_delay -min 0.042 -clock fast_clk [get_ports {o_lt_axi_* o_noc_* o_irq}]
set_output_delay -max 0.583 -clock fast_clk [get_ports {o_lt_axi_* o_noc_* o_irq}]
