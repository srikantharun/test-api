...
set DESIGN_BASE aic_mid
set DESIGN ${DESIGN_BASE}_p
set DFT_HOME [getenv DFT_HOME]
set DFT_RELEASE "/data/releases/europa/dft/bronze/aic_mid/202412110920"
set SI_NETLIST  "/data/europa/pd/aic_mid_p/block_build/dev_am_dft/build/fc/compile/results/aic_mid_p.insert_dft.v"
...
report_scan_chains -subchain	    > rpt/scan_chains_subchain.rpt

set_pattern_type -sequential 3
#-multiple_load on

create_pattern
#set_pattern_type -sequential 4; create_pattern
