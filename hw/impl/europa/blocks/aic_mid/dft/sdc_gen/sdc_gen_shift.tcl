...
if { $CHECK_MANUAL_CHANGES == 0 } {
    ...
    source /data/releases/europa/dft/bronze/aic_mid/Latest/tsdb/logic_test/tsdb_outdir/dft_inserted_designs/${DESIGN}_rtl2.dft_inserted_design/${DESIGN}.hierfix.sdc
