...
set_dft_signal -type Reset -active_state 0 -port i_rst_n -view exist
...
set_scan_element false [get_cells -hier *u_bisr_hook_core*ShiftReg_reg*]
set_scan_element false [get_cells -hier *u_bisr_hook_core*retime_reg*]
