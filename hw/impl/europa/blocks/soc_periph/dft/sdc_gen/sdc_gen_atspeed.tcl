...
if { $CHECK_MANUAL_CHANGES == 0 } {
   ...
   set tessent_clock_mapping(ts_tck_tck) ijtag_tck
    ...
    set_clock_groups -asynchronous -name clk_1 -group [get_clocks $i_emmc_clk] -group  [get_clocks $i_periph_clk] -group  [get_clocks $ijtag_tck]
    ...
    set_false_path -from [get_ports i_*_rst_n]
