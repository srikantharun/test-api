...
//==============================================================================
`define soc_periph_dw_axi___GUARD__DW_AXI_X2P_CC_CONSTANTS__VH__
...
`define soc_periph_dw_axi_X2P_AXI_INTERFACE_TYPE 1

//Creates a define if AXI3 is Enabled.

// `define soc_periph_dw_axi_X2P_AXI3_INTERFACE

//Creates a define if AXI4 is Enabled.

`define soc_periph_dw_axi_X2P_AXI4_INTERFACE


//Width of the AXI Lock bus.
//2 bits in AXI3 and 1 bit in AXI4

`define soc_periph_dw_axi_X2P_AXI_LTW 1
...
// on to paddr.
`define soc_periph_dw_axi_X2P_AXI_AW 32
...
`define soc_periph_dw_axi_X2P_AXI_SIDW 4
...
`define soc_periph_dw_axi_X2P_IDLE_VAL 0
...
`define soc_periph_dw_axi_X2P_DEFAULT_VAL 0
...
`define soc_periph_dw_axi_X2P_AXI_DW 64
...
`define soc_periph_dw_axi_X2P_AXI_BLW 8
...
`define soc_periph_dw_axi_X2P_AXI_ENDIANNESS 0

//Creates a define for enabling Big endian

// `define soc_periph_dw_axi_BIV_ENDIAN_ENABLE

//Creates a define for enabling Little endian

`define soc_periph_dw_axi_LITTLE_ENDIAN_ENABLE
...
`define soc_periph_dw_axi_X2P_APB_ADDR_WIDTH 32
...
`define soc_periph_dw_axi_X2P_APB_DATA_WIDTH 32
...
`define soc_periph_dw_axi_X2P_ALLOW_SPARSE_TRANSFER 0

//Creates a define for Allow Sparse transfer on APB interface

// `define soc_periph_dw_axi_X2P_ALLOW_SPARSE_TRANSFER_EN
...
`define soc_periph_dw_axi_X2P_NUM_APB_SLAVES 7
...
`define soc_periph_dw_axi_X2P_AXI_NUM_SLAVES 0
...
`define soc_periph_dw_axi_X2P_AXI_NUM_MASTERS 1
...
`define soc_periph_dw_axi_SIM_AXI_CLK_PERIOD 100

//This is a testbench parameter. The design does not depend on this
//parameter. This parameter specifies the clock period of the APB system

`define soc_periph_dw_axi_SIM_APB_CLK_PERIOD 100
...
`define soc_periph_dw_axi_X2P_CLK_MODE 0
...
`define soc_periph_dw_axi_X2P_DUAL_CLK_SYNC_DEPTH 2


//Creates a define for enabling Single clock mode

// `define soc_periph_dw_axi_X2P_CLK_MODE_2


//Creates a define for enabling dual clock mode

`define soc_periph_dw_axi_X2P_CLK_MODE_0
...
`define soc_periph_dw_axi_X2P_LOWPWR_HS_IF 0


// Legacy low power interface selection

`define soc_periph_dw_axi_X2P_LOWPWR_LEGACY_IF 0

//Creates a define for whether or not the low power handshaking interface
//exists.

// `define soc_periph_dw_axi_X2P_HAS_LOWPWR_HS_IF

//Creates a define for whether or not the legacy low power handshaking
//interface exists.

// `define soc_periph_dw_axi_X2P_HAS_LOWPWR_LEGACY_IF
...
`define soc_periph_dw_axi_X2P_LOWPWR_NOPX_CNT 32'd0

//This is the log2 of (X2P_LOWPWR_NOPX_CNT )

`define soc_periph_dw_axi_X2P_LOG2_LOWPWR_NOPX_CNT 1
...
`define soc_periph_dw_axi_X2P_CMD_QUEUE_DEPTH 4
...
`define soc_periph_dw_axi_X2P_WRITE_BUFFER_DEPTH 2
...
// allowed in only single-clock mode.
`define soc_periph_dw_axi_X2P_WRITE_RESP_BUFFER_DEPTH 2
...
`define soc_periph_dw_axi_X2P_READ_BUFFER_DEPTH 2
...
`define soc_periph_dw_axi_X2P_START_PADDR_S0 64'h0000000003030000
...
`define soc_periph_dw_axi_X2P_END_PADDR_S0 64'h000000000303ffff
...
`define soc_periph_dw_axi_X2P_IS_APB3_S0 0

//Creates a define for enabling APB3 in Slave 0

// `define soc_periph_dw_axi_X2P_APB3_S0
...
`define soc_periph_dw_axi_X2P_START_PADDR_S1 64'h0000000003010000
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_END_PADDR_S1 64'h000000000301ffff
...
`define soc_periph_dw_axi_X2P_IS_APB3_S1 0

//Creates a define for enabling APB3 in Slave 1 

// `define soc_periph_dw_axi_X2P_APB3_S1
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_START_PADDR_S2 64'h0000000003040000
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_END_PADDR_S2 64'h000000000304ffff
...
// according to the AMBA3 specification.
`define soc_periph_dw_axi_X2P_IS_APB3_S2 0

//Creates a define for enabling APB3 in Slave 2

// `define soc_periph_dw_axi_X2P_APB3_S2
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_START_PADDR_S3 64'h0000000003020000
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_END_PADDR_S3 64'h000000000302ffff
...
// according to the AMBA3 specification.
`define soc_periph_dw_axi_X2P_IS_APB3_S3 0

//Creates a define for enabling APB3 in Slave 3

// `define soc_periph_dw_axi_X2P_APB3_S3
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_START_PADDR_S4 64'h0000000003060000
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_END_PADDR_S4 64'h000000000306ffff
...
// according to the AMBA3 specification.
`define soc_periph_dw_axi_X2P_IS_APB3_S4 0

//Creates a define for enabling APB3 in Slave 4

// `define soc_periph_dw_axi_X2P_APB3_S4
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_START_PADDR_S5 64'h0000000003000000
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_END_PADDR_S5 64'h000000000300ffff
...
// according to the AMBA3 specification.
`define soc_periph_dw_axi_X2P_IS_APB3_S5 0

//Creates a define for enabling APB3 in Slave 5

// `define soc_periph_dw_axi_X2P_APB3_S5
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_START_PADDR_S6 64'h0000000003050000
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_END_PADDR_S6 64'h000000000305ffff
...
// according to the AMBA3 specification.
`define soc_periph_dw_axi_X2P_IS_APB3_S6 1

//Creates a define for enabling APB3 in Slave 6

`define soc_periph_dw_axi_X2P_APB3_S6
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_START_PADDR_S7 64'h0000000000002000
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_END_PADDR_S7 64'h00000000000023ff
...
// according to the AMBA3 specification.
`define soc_periph_dw_axi_X2P_IS_APB3_S7 0

//Creates a define for enabling APB3 in Slave 7

// `define soc_periph_dw_axi_X2P_APB3_S7
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_START_PADDR_S8 64'h0000000000002400
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_END_PADDR_S8 64'h00000000000027ff
...
// according to the AMBA3 specification.
`define soc_periph_dw_axi_X2P_IS_APB3_S8 0

//Creates a define for enabling APB3 in Slave 8

// `define soc_periph_dw_axi_X2P_APB3_S8
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_START_PADDR_S9 64'h0000000000002800
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_END_PADDR_S9 64'h0000000000002bff
...
// according to the AMBA3 specification.
`define soc_periph_dw_axi_X2P_IS_APB3_S9 0

//Creates a define for enabling APB3 in Slave 9

// `define soc_periph_dw_axi_X2P_APB3_S9
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_START_PADDR_S10 64'h0000000000002c00
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_END_PADDR_S10 64'h0000000000002fff
...
// according to the AMBA3 specification.
`define soc_periph_dw_axi_X2P_IS_APB3_S10 0

//Creates a define for enabling APB3 in Slave 10

// `define soc_periph_dw_axi_X2P_APB3_S10
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_START_PADDR_S11 64'h0000000000003000
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_END_PADDR_S11 64'h00000000000033ff
...
// according to the AMBA3 specification.
`define soc_periph_dw_axi_X2P_IS_APB3_S11 0

//Creates a define for enabling APB3 in Slave 11

// `define soc_periph_dw_axi_X2P_APB3_S11
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_START_PADDR_S12 64'h0000000000003400
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_END_PADDR_S12 64'h00000000000037ff
...
// according to the AMBA3 specification.
`define soc_periph_dw_axi_X2P_IS_APB3_S12 0

//Creates a define for enabling APB3 in Slave 12

// `define soc_periph_dw_axi_X2P_APB3_S12
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_START_PADDR_S13 64'h0000000000003800
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_END_PADDR_S13 64'h0000000000003bff
...
// according to the AMBA3 specification.
`define soc_periph_dw_axi_X2P_IS_APB3_S13 0

//Creates a define for enabling APB3 in Slave 13

// `define soc_periph_dw_axi_X2P_APB3_S13
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_START_PADDR_S14 64'h0000000000003c00
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_END_PADDR_S14 64'h0000000000003fff
...
// according to the AMBA3 specification.
`define soc_periph_dw_axi_X2P_IS_APB3_S14 0

//Creates a define for enabling APB3 in Slave 14

// `define soc_periph_dw_axi_X2P_APB3_S14
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_START_PADDR_S15 64'h0000000000004000
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define soc_periph_dw_axi_X2P_END_PADDR_S15 64'h00000000000043ff
...
// according to the AMBA3 specification.
`define soc_periph_dw_axi_X2P_IS_APB3_S15 0

//Creates a define for enabling APB3 in Slave 15

// `define soc_periph_dw_axi_X2P_APB3_S15


`define soc_periph_dw_axi_X2P_AXI_START_ADDR 64'h3000000


`define soc_periph_dw_axi_X2P_AXI_END_ADDR 64'h306ffff



// Name:         X2P_START_PADDR_32_S0
// Default:      0x03030000 (X2P_START_PADDR_S0 & 0x00000000ffffffff)
...
`define soc_periph_dw_axi_X2P_START_PADDR_32_S0 32'h03030000


// Name:         X2P_END_PADDR_32_S0
// Default:      0x0303ffff (X2P_END_PADDR_S0 & 0x00000000ffffffff)
...
`define soc_periph_dw_axi_X2P_END_PADDR_32_S0 32'h0303ffff


// Name:         X2P_START_PADDR_32_S1
// Default:      0x03010000 (X2P_START_PADDR_S1 & 0x00000000ffffffff)
// Values:       0x00000000, ..., 0xfffffc00
// Enabled:      0
// 
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_START_PADDR_32_S1 32'h03010000


// Name:         X2P_END_PADDR_32_S1
// Default:      0x0301ffff (X2P_END_PADDR_S1 & 0x00000000ffffffff)
// Values:       0x000003ff, ..., 0xffffffff
// Enabled:      0
// 
// End Address for APB Slave #1 that the component will use to decode the addressed APB Slave. This parameter is 
// non-editable and is used for visual purposes only in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_END_PADDR_32_S1 32'h0301ffff


// Name:         X2P_START_PADDR_32_S2
// Default:      0x03040000 (X2P_START_PADDR_S2 & 0x00000000ffffffff)
// Values:       0x00000000, ..., 0xfffffc00
// Enabled:      0
// 
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_START_PADDR_32_S2 32'h03040000


// Name:         X2P_END_PADDR_32_S2
// Default:      0x0304ffff (X2P_END_PADDR_S2 & 0x00000000ffffffff)
// Values:       0x000003ff, ..., 0xffffffff
// Enabled:      0
// 
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_END_PADDR_32_S2 32'h0304ffff


// Name:         X2P_START_PADDR_32_S3
// Default:      0x03020000 (X2P_START_PADDR_S3 & 0x00000000ffffffff)
// Values:       0x00000000, ..., 0xfffffc00
// Enabled:      0
// 
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_START_PADDR_32_S3 32'h03020000


// Name:         X2P_END_PADDR_32_S3
// Default:      0x0302ffff (X2P_END_PADDR_S3 & 0x00000000ffffffff)
// Values:       0x000003ff, ..., 0xffffffff
// Enabled:      0
// 
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_END_PADDR_32_S3 32'h0302ffff


// Name:         X2P_START_PADDR_32_S4
// Default:      0x03060000 (X2P_START_PADDR_S4 & 0x00000000ffffffff)
// Values:       0x00000000, ..., 0xfffffc00
// Enabled:      0
// 
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_START_PADDR_32_S4 32'h03060000


// Name:         X2P_END_PADDR_32_S4
// Default:      0x0306ffff (X2P_END_PADDR_S4 & 0x00000000ffffffff)
// Values:       0x000003ff, ..., 0xffffffff
// Enabled:      0
// 
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_END_PADDR_32_S4 32'h0306ffff


// Name:         X2P_START_PADDR_32_S5
// Default:      0x03000000 (X2P_START_PADDR_S5 & 0x00000000ffffffff)
// Values:       0x00000000, ..., 0xfffffc00
// Enabled:      0
// 
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_START_PADDR_32_S5 32'h03000000


// Name:         X2P_END_PADDR_32_S5
// Default:      0x0300ffff (X2P_END_PADDR_S5 & 0x00000000ffffffff)
// Values:       0x000003ff, ..., 0xffffffff
// Enabled:      0
// 
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_END_PADDR_32_S5 32'h0300ffff


// Name:         X2P_START_PADDR_32_S6
// Default:      0x03050000 (X2P_START_PADDR_S6 & 0x00000000ffffffff)
// Values:       0x00000000, ..., 0xfffffc00
// Enabled:      0
// 
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_START_PADDR_32_S6 32'h03050000


// Name:         X2P_END_PADDR_32_S6
// Default:      0x0305ffff (X2P_END_PADDR_S6 & 0x00000000ffffffff)
// Values:       0x000003ff, ..., 0xffffffff
// Enabled:      0
// 
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_END_PADDR_32_S6 32'h0305ffff
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_START_PADDR_32_S7 32'h00002000
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_END_PADDR_32_S7 32'h000023ff
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_START_PADDR_32_S8 32'h00002400
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_END_PADDR_32_S8 32'h000027ff
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_START_PADDR_32_S9 32'h00002800
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_END_PADDR_32_S9 32'h00002bff
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_START_PADDR_32_S10 32'h00002c00
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_END_PADDR_32_S10 32'h00002fff
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_START_PADDR_32_S11 32'h00003000
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_END_PADDR_32_S11 32'h000033ff
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_START_PADDR_32_S12 32'h00003400
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_END_PADDR_32_S12 32'h000037ff
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_START_PADDR_32_S13 32'h00003800
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_END_PADDR_32_S13 32'h00003bff
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_START_PADDR_32_S14 32'h00003c00
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_END_PADDR_32_S14 32'h00003fff
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define soc_periph_dw_axi_X2P_START_PADDR_32_S15 32'h00004000
...
`define soc_periph_dw_axi_SIM_A_CLK_PERIOD 100
...
`define soc_periph_dw_axi_SIM_B_CLK_PERIOD 100
...
`define soc_periph_dw_axi_SIM_DEBUG_LEVEL 0

// this enables tests to use a variable seed (related with the OS time) to
// initialize random generators.

`define soc_periph_dw_axi_SIM_USE_VARIABLE_SEED 0
...
`define soc_periph_dw_axi_SIM_RAND_SEED 0


`define soc_periph_dw_axi_SIM_USE_CC_RAND_SEED 0



`define soc_periph_dw_axi_USE_FOUNDATION 0
...
`define soc_periph_dw_axi_SIM_A_TTICK_CLK_CYCLES 100000
`define soc_periph_dw_axi_SIM_B_TTICK_CLK_CYCLES 51

// primary bus memory map
`define soc_periph_dw_axi_SIM_A_START_ADDR_S1 32'h10000000  /* slave A1 */
`define soc_periph_dw_axi_SIM_A_END_ADDR_S1   32'h1fffffff
`define soc_periph_dw_axi_SIM_A_START_ADDR_S2 32'h20000000  /* bridge A->B */
`define soc_periph_dw_axi_SIM_A_END_ADDR_S2   32'h2fffffff
`define soc_periph_dw_axi_SIM_A_START_ADDR_S3 32'h30000000  /* slave A3 */
`define soc_periph_dw_axi_SIM_A_END_ADDR_S3   32'h3fffffff

// secondary bus memory map
`define soc_periph_dw_axi_SIM_B_START_ADDR_S1 32'h20000000  /* slave B1 */
`define soc_periph_dw_axi_SIM_B_END_ADDR_S1   32'h27ffffff
`define soc_periph_dw_axi_SIM_B_START_ADDR_S3 32'h28000000  /* slave B3 */
`define soc_periph_dw_axi_SIM_B_END_ADDR_S3   32'h2fffffff
`define soc_periph_dw_axi_SIM_B_START_ADDR_S2 32'h30000000  /* bridge A->B */
`define soc_periph_dw_axi_SIM_B_END_ADDR_S2   32'h3fffffff
...
`define soc_periph_dw_axi_AXI_TEST_RAND_XACTNS 1000
...
`define soc_periph_dw_axi_AXI_TEST_INACTIVE_SIGNALS 2
...
/*                                       */
/*****************************************/
`define soc_periph_dw_axi_MAX_X2P_AXI_DATA_WIDTH  512
`define soc_periph_dw_axi_MAX_X2P_AXI_ADDR_WIDTH  64
`define soc_periph_dw_axi_MAX_X2P_AXI_ID_WIDTH 20



`define soc_periph_dw_axi_RM_ENDIAN 1
/*****************************************/
/*                                       */
/*          Derived Values               */
/*                                       */
...
`define soc_periph_dw_axi_X2P_AXI_WSTRB_WIDTH  `soc_periph_dw_axi_X2P_AXI_DW/8
`define soc_periph_dw_axi_X2P_APB_WSTRB_WIDTH  `soc_periph_dw_axi_X2P_APB_DATA_WIDTH/8

`define soc_periph_dw_axi_APB_DW_32

`define soc_periph_dw_axi_X2P_AXI_WDFIFO_WIDTH  `soc_periph_dw_axi_X2P_AXI_DW + `soc_periph_dw_axi_X2P_AXI_WSTRB_WIDTH + 1

// the LEN is the cmd queue will be the larger of the write and read
`define soc_periph_dw_axi_LEN_WIDTH `soc_periph_dw_axi_X2P_AXI_BLW

// keep the axi addr width allowing selects to span the whole X2P_AXI_AW range
//`define soc_periph_dw_axi_X2P_CMD_ADDR_WIDTH  `soc_periph_dw_axi_X2P_AXI_AW
//`define soc_periph_dw_axi_X2P_CMD_QUEUE_WIDTH  `soc_periph_dw_axi_X2P_AXI_AW + `soc_periph_dw_axi_X2P_AXI_SIDW + `soc_periph_dw_axi_X2P_AXI_BLW + 2 + 2 + 1
`define soc_periph_dw_axi_X2P_CMD_ADDR_WIDTH  32
`define soc_periph_dw_axi_X2P_CMD_QUEUE_WIDTH 32 + `soc_periph_dw_axi_X2P_AXI_SIDW + `soc_periph_dw_axi_X2P_AXI_BLW + 2 + 2 + 1

// based on the AXI data width define the max SIZE that can be issued
`define soc_periph_dw_axi_X2P_MAX_AXI_SIZE ((`soc_periph_dw_axi_X2P_AXI_DW == 512) ? 6 :((`soc_periph_dw_axi_X2P_AXI_DW == 256) ? 5 : ((`soc_periph_dw_axi_X2P_AXI_DW == 128) ? 4 : ((`soc_periph_dw_axi_X2P_AXI_DW == 64 ? 3 :((`soc_periph_dw_axi_X2P_AXI_DW == 32) ? 2 : ((`soc_periph_dw_axi_X2P_AXI_DW == 16) ? 1: 0)))))))
// provide the fixed size of the APB
`define soc_periph_dw_axi_X2P_APB_SIZE ((`soc_periph_dw_axi_X2P_APB_DATA_WIDTH == 512) ? 6 :((`soc_periph_dw_axi_X2P_APB_DATA_WIDTH == 256) ? 5 : ((`soc_periph_dw_axi_X2P_APB_DATA_WIDTH == 128) ? 4 : ((`soc_periph_dw_axi_X2P_APB_DATA_WIDTH == 64 ? 3 :((`soc_periph_dw_axi_X2P_APB_DATA_WIDTH == 32) ? 2 : ((`soc_periph_dw_axi_X2P_APB_DATA_WIDTH == 16) ? 1: 0)))))))


`define soc_periph_dw_axi_APB_BUS_SIZE ((`soc_periph_dw_axi_X2P_APB_DATA_WIDTH == 32) ? 2 : (`soc_periph_dw_axi_X2P_APB_DATA_WIDTH == 16) ? 1 : 0)


// `define soc_periph_dw_axi_X2P_ENCRYPT
...
`define soc_periph_dw_axi_X2P_HAS_APB3 1


//Used to insert internal tests


`define soc_periph_dw_axi_X2P_VERIF_EN 1
...
`define soc_periph_dw_axi_DWC_NO_TST_MODE

`define soc_periph_dw_axi_DWC_NO_CDC_INIT





`define soc_periph_dw_axi_X2P_AXI_BLW_8
