...
//==============================================================================
`ifndef soc_periph_dw_i2c_1___GUARD__DW_APB_I2C_CC_CONSTANTS__VH__
`define soc_periph_dw_i2c_1___GUARD__DW_APB_I2C_CC_CONSTANTS__VH__
...
`define soc_periph_dw_i2c_1_SLAVE_INTERFACE_TYPE 2
...
`define soc_periph_dw_i2c_1_SLVERR_RESP_EN 0

//APB Interface has APB3 signals

`define soc_periph_dw_i2c_1_IC_HAS_APB3_IF_SIGNALS

//APB Interface has APB4 signals

`define soc_periph_dw_i2c_1_IC_HAS_APB4_IF_SIGNALS

//Component has slave error response enabled

// `define soc_periph_dw_i2c_1_IC_HAS_SLVERR_RESP_EN
...
`define soc_periph_dw_i2c_1_IC_ULTRA_FAST_MODE 1'h0

//Internal Define for Ic CLK Frequency optimization

// `define soc_periph_dw_i2c_1_IC_ULTRA_FAST_MODE_EN
...
`define soc_periph_dw_i2c_1_IC_CLK_FREQ_OPTIMIZATION 1'h0

//Internal Define for Ic CLK Frequency optimization

// `define soc_periph_dw_i2c_1_IC_CLK_FREQ_OPTIMIZATION_EN
...
`define soc_periph_dw_i2c_1_IC_SMBUS 1'h1
...
`define soc_periph_dw_i2c_1_IC_MULTI_SAR_EN 1'h0
...
`define soc_periph_dw_i2c_1_IC_NUM_SARS 2
...
`define soc_periph_dw_i2c_1_IC_CLK_STRETCH_MSAR 0





`define soc_periph_dw_i2c_1_IC_NUM_SARS_GE2



//SMBus General Get UDID command

`define soc_periph_dw_i2c_1_LOG2_IC_NUM_SARS 1

//Lower limit of number of clocks used for high count
//
//

`define soc_periph_dw_i2c_1_IC_HCNT_LO_LIMIT 16'h6

//Lower limit of number of clocks used for low count

`define soc_periph_dw_i2c_1_IC_LCNT_LO_LIMIT 16'h8
...
`define soc_periph_dw_i2c_1_IC_ADD_ENCODED_PARAMS 1'h1
...
`define soc_periph_dw_i2c_1_APB_DATA_WIDTH 32

//Internal Define for APB Data Width 8

// `define soc_periph_dw_i2c_1_APB_DATA_WIDTH_8

//Internal Define for APB Data Width != 8

`define soc_periph_dw_i2c_1_APB_DATA_WIDTH_NOT_8

//Internal Define for APB Data Width 16

// `define soc_periph_dw_i2c_1_APB_DATA_WIDTH_16

//Internal Define for APB Data Width 32

`define soc_periph_dw_i2c_1_APB_DATA_WIDTH_32
...
`define soc_periph_dw_i2c_1_IC_MAX_SPEED_MODE 2'h2
...
`define soc_periph_dw_i2c_1_IC_10BITADDR_MASTER 1'h0
...
`define soc_periph_dw_i2c_1_IC_RESTART_EN 1'h1
...
`define soc_periph_dw_i2c_1_IC_10BITADDR_SLAVE 1'h0
...
`define soc_periph_dw_i2c_1_IC_MASTER_MODE 1'h1
...
`define soc_periph_dw_i2c_1_IC_SLAVE_DISABLE 1'h1
...
`define soc_periph_dw_i2c_1_IC_DEFAULT_SLAVE_ADDR 10'h055
...
// The default values cannot be any of the reserved  
// address locations: 0x00 to 0x07 or 0x78 to 0x7f.
`define soc_periph_dw_i2c_1_IC_DEFAULT_SLAVE_ADDR2 10'h056
...
// The default values cannot be any of the reserved  
// address locations: 0x00 to 0x07 or 0x78 to 0x7f.
`define soc_periph_dw_i2c_1_IC_DEFAULT_SLAVE_ADDR3 10'h057
...
// The default values cannot be any of the reserved  
// address locations: 0x00 to 0x07 or 0x78 to 0x7f.
`define soc_periph_dw_i2c_1_IC_DEFAULT_SLAVE_ADDR4 10'h058
...
`define soc_periph_dw_i2c_1_IC_DEFAULT_TAR_SLAVE_ADDR 10'h055
...
// book.
`define soc_periph_dw_i2c_1_IC_HS_MASTER_CODE 3'h1
...
`define soc_periph_dw_i2c_1_IC_TX_BUFFER_DEPTH 8
...
`define soc_periph_dw_i2c_1_IC_RX_BUFFER_DEPTH 8

//Receive data width of FIFO

`define soc_periph_dw_i2c_1_RX_ABW 3


`define soc_periph_dw_i2c_1_RX_ABW_P1 4

//Write data width of FIFO

`define soc_periph_dw_i2c_1_TX_ABW 3


`define soc_periph_dw_i2c_1_TX_ABW_P1 4
...
`define soc_periph_dw_i2c_1_IC_INTR_POL 1'h1
...
`define soc_periph_dw_i2c_1_IC_INTR_IO 1'h0

`define soc_periph_dw_i2c_1_IC_HAS_INTR_IO0_POL1
...
`define soc_periph_dw_i2c_1_IC_HAS_DMA 1'h0


//DW_apb_i2c module version ID

`define soc_periph_dw_i2c_1_IC_VERSION_ID 32'h3230332a
...
`define soc_periph_dw_i2c_1_IC_TX_TL 8'h0
...
`define soc_periph_dw_i2c_1_IC_RX_TL 8'h0
...
`define soc_periph_dw_i2c_1_IC_USE_COUNTS 1'h0
...
`define soc_periph_dw_i2c_1_IC_CLOCK_PERIOD 100
...
`define soc_periph_dw_i2c_1_IC_SS_SCL_HIGH_COUNT 16'h0028
...
`define soc_periph_dw_i2c_1_IC_SS_SCL_LOW_COUNT 16'h002f
...
`define soc_periph_dw_i2c_1_IC_FS_SCL_HIGH_COUNT 16'h0006
...
`define soc_periph_dw_i2c_1_IC_FS_SCL_LOW_COUNT 16'h000d
...
// pulse width of SCL.
`define soc_periph_dw_i2c_1_IC_CAP_LOADING 100
...
`define soc_periph_dw_i2c_1_IC_HS_SCL_HIGH_COUNT 16'h0006
...
`define soc_periph_dw_i2c_1_IC_HS_SCL_LOW_COUNT 16'h0008
...
`define soc_periph_dw_i2c_1_IC_HC_COUNT_VALUES 1'h0


`define soc_periph_dw_i2c_1_IDENT 2'h0

//Asynchronous clock relationship

`define soc_periph_dw_i2c_1_ASYNC 2'h1

//Synchronous clock relationship

`define soc_periph_dw_i2c_1_SYNC 2'h3
...
`define soc_periph_dw_i2c_1_IC_CLK_TYPE 2'h1


`define soc_periph_dw_i2c_1_IC_SYNC_DEPTH 2


`define soc_periph_dw_i2c_1_IC_VERIF_EN 1
...
`define soc_periph_dw_i2c_1_IC_HAS_ASYNC_FIFO 1'h0


//Modified Depth of the Transmit buffer

`define soc_periph_dw_i2c_1_IC_TX_BUFFER_MOD_DEPTH 8

//Modified Depth of the Receive buffer

`define soc_periph_dw_i2c_1_IC_RX_BUFFER_MOD_DEPTH 8

`define soc_periph_dw_i2c_1_IC_HAS_ASYNC_CLK

//Setting up a clock period for the I2C.

`define soc_periph_dw_i2c_1_IC_CLK_FREQ 100

//LHS of Paddr bus

`define soc_periph_dw_i2c_1_IC_ADDR_SLICE_LHS 4'h7

//LHS of Paddr bus

`define soc_periph_dw_i2c_1_MAX_APB_DATA_WIDTH 6'h20
...
`define soc_periph_dw_i2c_1_I2C_DYNAMIC_TAR_UPDATE 0


`define soc_periph_dw_i2c_1_IC_HAS_MST_ON_HOLD_INTR_OR_SMBUS
...
`define soc_periph_dw_i2c_1_IC_SLV_DATA_NACK_ONLY 1'h0
...
`define soc_periph_dw_i2c_1_IC_RX_FULL_GEN_NACK 1'h0
...
`define soc_periph_dw_i2c_1_IC_EMPTYFIFO_HOLD_MASTER_EN 1

`define soc_periph_dw_i2c_1_IC_HAS_EMPTYFIFO_HOLD
...
`define soc_periph_dw_i2c_1_IC_DEFAULT_SDA_SETUP 8'h64
...
`define soc_periph_dw_i2c_1_IC_DEFAULT_SDA_HOLD 24'h000001


`define soc_periph_dw_i2c_1_IC_DEFAULT_SDA_TX_HOLD 16'h1


`define soc_periph_dw_i2c_1_IC_DEFAULT_SDA_RX_HOLD 8'h0
...
`define soc_periph_dw_i2c_1_IC_DEFAULT_ACK_GENERAL_CALL 1'h1
...
//  ic_rx_over_intr(_n).
`define soc_periph_dw_i2c_1_IC_RX_FULL_HLD_BUS_EN 1'h0




`define soc_periph_dw_i2c_1_IC_HAS_RX_HOLD
...
`define soc_periph_dw_i2c_1_IC_SLV_RESTART_DET_EN 1'h0
...
// ic_intr(_n) signals.
`define soc_periph_dw_i2c_1_IC_STOP_DET_IF_MASTER_ACTIVE 1'h0
...
`define soc_periph_dw_i2c_1_IC_STAT_FOR_CLK_STRETCH 1'h0
...
`define soc_periph_dw_i2c_1_IC_TX_CMD_BLOCK 1'h0
...
`define soc_periph_dw_i2c_1_IC_TX_CMD_BLOCK_DEFAULT 1'h0
...
`define soc_periph_dw_i2c_1_IC_FIRST_DATA_BYTE_STATUS 1'h0
...
`define soc_periph_dw_i2c_1_IC_AVOID_RX_FIFO_FLUSH_ON_TX_ABRT 1'h0
...
`define soc_periph_dw_i2c_1_IC_BUS_CLEAR_FEATURE 1'h1

`define soc_periph_dw_i2c_1_IC_BUS_CLEAR_FEATURE_EN
...
`define soc_periph_dw_i2c_1_IC_SCL_STUCK_TIMEOUT_DEFAULT 32'hffffffff
...
`define soc_periph_dw_i2c_1_IC_SDA_STUCK_TIMEOUT_DEFAULT 32'hffffffff
...
// register.
`define soc_periph_dw_i2c_1_IC_DEVICE_ID 1'h0
...
`define soc_periph_dw_i2c_1_IC_DEVICE_ID_VALUE 24'h0

`define soc_periph_dw_i2c_1_IC_SMBUS_EN
...
`define soc_periph_dw_i2c_1_IC_SMBUS_CLK_LOW_SEXT_DEFAULT 32'hffffffff
...
`define soc_periph_dw_i2c_1_IC_SMBUS_CLK_LOW_MEXT_DEFAULT 32'hffffffff
...
`define soc_periph_dw_i2c_1_IC_SMBUS_RST_IDLE_CNT_DEFAULT 16'hffff
...
`define soc_periph_dw_i2c_1_IC_SMBUS_SUSPEND_ALERT 1'h0

//Internal Define for SMBus optional signals

// `define soc_periph_dw_i2c_1_IC_SMBUS_SUSPEND_ALERT_EN
...
`define soc_periph_dw_i2c_1_IC_OPTIONAL_SAR 1'h0
...
`define soc_periph_dw_i2c_1_IC_OPTIONAL_SAR_DEFAULT 7'h0
...
// Slave mode only.
`define soc_periph_dw_i2c_1_IC_SMBUS_ARP 1'h0
...
`define soc_periph_dw_i2c_1_IC_SMBUS_UDID_HC 1'h1

//DMAC has Debug Ports Define 
`define soc_periph_dw_i2c_1_IC_SMBUS_HAS_UDID_HC

//`ifndef soc_periph_dw_i2c_1_IC_SMBUS_HAS_UDID_HC
//UDID width

`define soc_periph_dw_i2c_1_IC_SMBUS_UDID_BITS 128
//`endif
...
`define soc_periph_dw_i2c_1_IC_SMBUS_UDID_MSB 96'h0
...
// process in SMBus ARP mode (Lower 32bits of UDID).
`define soc_periph_dw_i2c_1_IC_SMBUS_UDID_LSB_DEFAULT 32'hffffffff
...
`define soc_periph_dw_i2c_1_IC_PERSISTANT_SLV_ADDR_DEFAULT 1'h0
...
`define soc_periph_dw_i2c_1_IC_PERSISTANT_SLV_ADDR2_DEFAULT 1'h0
...
`define soc_periph_dw_i2c_1_IC_PERSISTANT_SLV_ADDR3_DEFAULT 1'h0
...
`define soc_periph_dw_i2c_1_IC_PERSISTANT_SLV_ADDR4_DEFAULT 1'h0
...
`define soc_periph_dw_i2c_1_IC_UFM_SCL_HIGH_COUNT 16'h0006
...
// The value must be calculated based on the I2C data rate desired and I2C clock frequency. 
// When parameter IC_USE_COUNTS = 0, this parameter is automatically calculated using the IC_CLOCK_PERIOD parameter.
`define soc_periph_dw_i2c_1_IC_UFM_SCL_LOW_COUNT 16'h0008
...
`define soc_periph_dw_i2c_1_IC_UFM_TBUF_CNT_DEFAULT 16'h8
// -----------------------------------------------------------
// -- Regsiter bit Width macros
// -----------------------------------------------------------
//ic_con register bit width

`define soc_periph_dw_i2c_1_IC_CON_RS 12

//SMB extension for ic_con register bit width

`define soc_periph_dw_i2c_1_IC_SMBUS_CON_EXT_RS 4

//ic_tar register bit width

`define soc_periph_dw_i2c_1_IC_TAR_RS 12


`define soc_periph_dw_i2c_1_IC_TAR_RS_INT 12

//ic_sar optional register bit width

`define soc_periph_dw_i2c_1_IC_SAR_OPT_RS 7

//ic_sar register bit width

`define soc_periph_dw_i2c_1_IC_SAR_RS 10

//ic_hs_maddr register bit width

`define soc_periph_dw_i2c_1_IC_HS_MADDR_RS 3

//ic_data_cmd Receiver register bit width

`define soc_periph_dw_i2c_1_IC_DATA_CMD_RS 11

//ic_data_cmd Transmit register bit width

`define soc_periph_dw_i2c_1_IC_DATA_TX_CMD_RS 11

//ic_data_cmd register valid data bit width

`define soc_periph_dw_i2c_1_IC_DATA_RS 8

//ic_data_cmd register register FIFO bit width

`define soc_periph_dw_i2c_1_IC_DATA_FIFO_RS 8

//ic_ss_hcnt register bit width

`define soc_periph_dw_i2c_1_IC_SS_HCNT_RS 16

//ic_ss_lcnt register bit width

`define soc_periph_dw_i2c_1_IC_SS_LCNT_RS 16

//ic_fs_hcnt register bit width

`define soc_periph_dw_i2c_1_IC_FS_HCNT_RS 16

//ic_fs_lcnt register bit width

`define soc_periph_dw_i2c_1_IC_FS_LCNT_RS 16

//ic_hs_hcnt register bit width

`define soc_periph_dw_i2c_1_IC_HS_HCNT_RS 16

//ic_hs_lcnt register bit width

`define soc_periph_dw_i2c_1_IC_HS_LCNT_RS 16

//ic_intr_stat register bit width

`define soc_periph_dw_i2c_1_IC_INTR_STAT_RS 15

//ic_intr_mask register bit width

`define soc_periph_dw_i2c_1_IC_INTR_MASK_RS 15

//ic_raw_intr_stat register bit width

`define soc_periph_dw_i2c_1_IC_RAW_INTR_STAT_RS 15

//ic_smbus_intr_* register bit width

`define soc_periph_dw_i2c_1_IC_SMBUS_INTR_RS 4

//ic_rx_tl register bit width

`define soc_periph_dw_i2c_1_IC_RX_TL_RS 8

//ic_tx_tl register bit width

`define soc_periph_dw_i2c_1_IC_TX_TL_RS 8

//ic_clr_intr register bit width

`define soc_periph_dw_i2c_1_IC_CLR_INTR_RS 1

//ic_clr_rx_under register bit width

`define soc_periph_dw_i2c_1_IC_CLR_RX_UNDER_RS 1

//ic_clr_rx_over register bit width

`define soc_periph_dw_i2c_1_IC_CLR_RX_OVER_RS 1

//ic_clr_tx_over register bit width

`define soc_periph_dw_i2c_1_IC_CLR_TX_OVER_RS 1

//ic_clr_rd_req register bit width

`define soc_periph_dw_i2c_1_IC_CLR_RD_REQ_RS 1

//ic_clr_tx_abrt register bit width

`define soc_periph_dw_i2c_1_IC_CLR_TX_ABRT_RS 1

//ic_clr_rx_done register bit width

`define soc_periph_dw_i2c_1_IC_CLR_RX_DONE_RS 1

//ic_clr_activity register bit width

`define soc_periph_dw_i2c_1_IC_CLR_ACTIVITY_RS 1

//ic_clr_stop_det register bit width

`define soc_periph_dw_i2c_1_IC_CLR_STOP_DET_RS 1

//ic_clr_stop_det register bit width

`define soc_periph_dw_i2c_1_IC_CLR_RESTART_DET_RS 1

//ic_clr_start_det register bit width

`define soc_periph_dw_i2c_1_IC_CLR_START_DET_RS 1

//ic_clr_gen_call register bit width

`define soc_periph_dw_i2c_1_IC_CLR_GEN_CALL_RS 1

//ic_enable register bit width

`define soc_periph_dw_i2c_1_IC_ENABLE_RS 4


`define soc_periph_dw_i2c_1_IC_ENABLE_SMBUS_RS 3

//ic_enable internal register bit width for sync module

`define soc_periph_dw_i2c_1_IC_ENABLE_RS_INT 2

// ic_status register bit width

`define soc_periph_dw_i2c_1_IC_STATUS_RS 12

//ic_sreset register bit width

`define soc_periph_dw_i2c_1_IC_SRESET_RS 3

//ic_device_id register width

//ic_tx_abrt_source register bit width

`define soc_periph_dw_i2c_1_IC_TX_ABRT_SOURCE_RS 18

//PAT START
//ic_slv_data_nack_only register bit width

`define soc_periph_dw_i2c_1_IC_SLV_DATA_NACK_ONLY_RS 1
//PAT END

//ic_version_id register bit width

`define soc_periph_dw_i2c_1_IC_VERSION_ID_RS 32

//ic_version_id register bit width

`define soc_periph_dw_i2c_1_IC_DMA_CR_RS 2

//ic_version_id register bit width

`define soc_periph_dw_i2c_1_IC_DMA_TDLR_RS 3

//ic_version_id register bit width

`define soc_periph_dw_i2c_1_IC_DMA_RDLR_RS 3

//SDA setup time setting; used when SCL is held

`define soc_periph_dw_i2c_1_IC_SDA_SETUP_RS 8

//internal SDA hold time setting; used when I2C acts as transmitter

`define soc_periph_dw_i2c_1_IC_SDA_TX_HOLD_RS 16

//internal SDA hold time setting; used when I2C acts as receiver

`define soc_periph_dw_i2c_1_IC_SDA_RX_HOLD_RS 8

//SDA hold time setting; used when I2cis acting as either Master or receiver

`define soc_periph_dw_i2c_1_IC_SDA_HOLD_RS 24

//Acknowledgement of General Call addresses

`define soc_periph_dw_i2c_1_IC_ACK_GENERAL_CALL_RS 1

//IC_ENABLE_STATUS

`define soc_periph_dw_i2c_1_IC_ENABLE_STATUS_RS 3

//IC_SMBUS_TIMEOUT Register size

`define soc_periph_dw_i2c_1_IC_SMBUS_TIMEOUT_RS 32

//IC_SMBUS_RST_IDLE_CNT Register size

`define soc_periph_dw_i2c_1_IC_SMBUS_RST_IDLE_CNT_RS 16

//IC_SMBUS_SUS_ALERT_CTRL Register size

`define soc_periph_dw_i2c_1_IC_SMBUS_SUS_ALERT_RS 2

//IC_SMBUS_UDID_LSB Register size

`define soc_periph_dw_i2c_1_IC_SMBUS_UDID_LSB_RS 32

//ic_con_smbus register width value

`define soc_periph_dw_i2c_1_IC_SMBUS_UDID_RS 144

//SMBus Host Slave Address

`define soc_periph_dw_i2c_1_IC_SMBUS_HOST_SLAVE_ADDRESS 7'h8

//SMBus write Device Default Address

`define soc_periph_dw_i2c_1_IC_SMBUS_DEVICE_DEFAULT_ADDRESS 8'hc2

//SMBus Read Device Default Address

`define soc_periph_dw_i2c_1_IC_SMBUS_RD_DEVICE_DEFAULT_ADDRESS 8'hc3

//SMBus Prepare to ARP command

`define soc_periph_dw_i2c_1_IC_SMBUS_PREPARE_TO_ARP_CMD 8'h1

//SMBus General Reset command

`define soc_periph_dw_i2c_1_IC_SMBUS_GEN_RESET_CMD 8'h2

//SMBus General Get UDID command

`define soc_periph_dw_i2c_1_IC_SMBUS_GEN_GET_UDID_CMD 8'h3

//SMBus General Assign address command

`define soc_periph_dw_i2c_1_IC_SMBUS_ASSGN_ADDR_CMD 8'h4

//SMBus UDID byte count

`define soc_periph_dw_i2c_1_IC_SMBUS_UDID_BYTE_COUNT 5'h11

//SMBus UDID byte count plus 1

`define soc_periph_dw_i2c_1_IC_SMBUS_UDID_BYTE_COUNT_PLS1 5'h12

//SMBus UDID byte count width

`define soc_periph_dw_i2c_1_IC_SMBUS_UDID_BYTE_COUNT_LOG2 5

//SMBUS Alert Response address

`define soc_periph_dw_i2c_1_SMB_ALERT_ADDRESS 7'hc
...
`define soc_periph_dw_i2c_1_IC_CON_IN 20'h65

//ic_tar register reset value

`define soc_periph_dw_i2c_1_IC_TAR_IN 13'h55

//ic_tar register reset value

`define soc_periph_dw_i2c_1_IC_TAR_IN_RAL 44'h55

//ic_sar register reset value

`define soc_periph_dw_i2c_1_IC_SAR_IN 10'h55

//ic_sar2 register reset value

`define soc_periph_dw_i2c_1_IC_SAR2_IN 10'h56



//ic_sar register reset value

`define soc_periph_dw_i2c_1_IC_SAR_OPT_IN 7'h0

//ic_hs_maddr register reset value

`define soc_periph_dw_i2c_1_IC_HS_MADDR_IN 3'h1

//ic_ss_hcnt register reset value

`define soc_periph_dw_i2c_1_IC_SS_HCNT_IN 16'h28

//ic_ss_lcnt register reset value

`define soc_periph_dw_i2c_1_IC_SS_LCNT_IN 16'h2f

//ic_fs_hcnt register reset value

`define soc_periph_dw_i2c_1_IC_FS_HCNT_IN 16'h6

//ic_fs_lcnt register reset value

`define soc_periph_dw_i2c_1_IC_FS_LCNT_IN 16'hd

//ic_hs_hcnt register reset value

`define soc_periph_dw_i2c_1_IC_HS_HCNT_IN 16'h6

//ic_hs_lcnt register reset value

`define soc_periph_dw_i2c_1_IC_HS_LCNT_IN 16'h8

//ic_rx_tl register reset value

`define soc_periph_dw_i2c_1_IC_RX_TL_IN 8'h0

//ic_tx_tl register reset value

`define soc_periph_dw_i2c_1_IC_TX_TL_IN 8'h0

//ic_status register reset value

`define soc_periph_dw_i2c_1_IC_STATUS_IN 21'h6

//IC_ENABLE register reset value

`define soc_periph_dw_i2c_1_IC_ENABLE_IN 3'h0

//Indicates a High Speed Mode Address value

`define soc_periph_dw_i2c_1_IC_HS_CODE 5'h1

//Indicates a 10 bit address transfer

`define soc_periph_dw_i2c_1_IC_SLV_ADDR_10BIT 5'h1e

//General Call I2C bus Code

`define soc_periph_dw_i2c_1_IC_GENERAL_CALL 8'h0

//Start Byte I2C bus Code

`define soc_periph_dw_i2c_1_IC_START_BYTE 8'h1

//DEVICE-ID I2C bus Code

`define soc_periph_dw_i2c_1_IC_DEVICE_ID_BYTE 7'h7c

//I2C Version ID

`define soc_periph_dw_i2c_1_IC_VERSION_ID_IN 32'h3230332a

//Speed up my simulation

`define soc_periph_dw_i2c_1_IC_SPEED_SIM 1'h1

//Random Seed For Simulations. Anything between 1 and 500.

`define soc_periph_dw_i2c_1_IC_RAND_SEED 1

//Determines if simulation max is one hour

`define soc_periph_dw_i2c_1_IC_RUN_FOR_ONE_HOUR 1'h1

//Determines if the I2C VIP VMT models are instaniated

`define soc_periph_dw_i2c_1_IC_VMT_MODEL_INCLUDED 1'h0

//Encoded APB Data Width

`define soc_periph_dw_i2c_1_ENCODED_APB_DATA_WIDTH 2'h2

//Encoded value of the transmit buffer depth

`define soc_periph_dw_i2c_1_ENCODED_IC_TX_BUFFER_DEPTH 8'h7

//Encoded value of the receiver buffer depth

`define soc_periph_dw_i2c_1_ENCODED_IC_RX_BUFFER_DEPTH 8'h7

//ic_comp_param_1 register reset value

`define soc_periph_dw_i2c_1_IC_COMP_PARAM_1_IN 24'h7078a

//ic_comp_param_1 register reset value

`define soc_periph_dw_i2c_1_IC_COMP_PARAM_UFM_1_IN 24'h70782

//Lower limit of number of clocks used for spike suppression in SS and FS

`define soc_periph_dw_i2c_1_IC_FS_SPKLEN_LO_LIMIT 8'h1

//Lower limit of number of clocks used for spike suppression in HS

`define soc_periph_dw_i2c_1_IC_HS_SPKLEN_LO_LIMIT 8'h1

//Duration (in ns) of longest spike to be suppressed in SS and FS

`define soc_periph_dw_i2c_1_IC_FS_MAX_SPKLEN 50

//Duration (in ns) of longest spike to be suppressed in HS

`define soc_periph_dw_i2c_1_IC_HS_MAX_SPKLEN 10
...
`define soc_periph_dw_i2c_1_IC_DEFAULT_FS_SPKLEN 8'h1
...
// of IC_CLOCK_PERIOD.
`define soc_periph_dw_i2c_1_IC_DEFAULT_HS_SPKLEN 8'h1
...
`define soc_periph_dw_i2c_1_IC_DEFAULT_UFM_SPKLEN 8'h1


//ic_fs_spklen width

`define soc_periph_dw_i2c_1_IC_FS_SPKLEN_RS 8

//ic_hs_spklen width

`define soc_periph_dw_i2c_1_IC_HS_SPKLEN_RS 8

//Larger of IC_HS_SPKLEN_RS and IC_FS_SPKLEN_RS

`define soc_periph_dw_i2c_1_IC_SPKLEN_RS 8

//ic_scl_sda_timeout width

`define soc_periph_dw_i2c_1_IC_SCL_SDA_TIMEOUT_RS 32

//Creates a define for enabling low power interface

// `define soc_periph_dw_i2c_1_IC_HIGHSPEED_MODE_EN
...
`define soc_periph_dw_i2c_1_REG_TIMEOUT_WIDTH 4

//Slave has non-zero reg_timeout_width

// `define soc_periph_dw_i2c_1_IC_HAS_POSITIVE_REG_TIMEOUT_WIDTH
...
`define soc_periph_dw_i2c_1_HC_REG_TIMEOUT_VALUE 0

//APB Interface has hardcoded timeout reset value

// `define soc_periph_dw_i2c_1_IC_HAS_HC_REG_TIMEOUT_VALUE


`define soc_periph_dw_i2c_1_POW_2_REG_TIMEOUT_WIDTH 15
...
`define soc_periph_dw_i2c_1_REG_TIMEOUT_VALUE 8
...
//BCM defines
`define soc_periph_dw_i2c_1_DWC_NO_TST_MODE

`define soc_periph_dw_i2c_1_DWC_NO_CDC_INIT

`define soc_periph_dw_i2c_1_DWC_BCM06_NO_DIAG_N
...
`define soc_periph_dw_i2c_1_IC_MULTI_SAR_UDID_CTRL 1'h0
...
`define soc_periph_dw_i2c_1_IC_SAR2_SMBUS_UDID_HC 1'h1
...
`define soc_periph_dw_i2c_1_IC_SAR2_SMBUS_UDID_DEFAULT 128'hffff0000ffff0000ffff00003fff0000
...
`define soc_periph_dw_i2c_1_IC_SAR3_SMBUS_UDID_HC 1'h1
...
`define soc_periph_dw_i2c_1_IC_SAR3_SMBUS_UDID_DEFAULT 128'hffff0000ffff0000ffff00007fff0000
...
`define soc_periph_dw_i2c_1_IC_SAR4_SMBUS_UDID_HC 1'h1
...
`define soc_periph_dw_i2c_1_IC_SAR4_SMBUS_UDID_DEFAULT 128'hffff0000ffff0000ffff0000bfff0000
...
`define soc_periph_dw_i2c_1_IC_MSAR_SMBUS_ARP_EN_BITS 0
