...
read_verilog /data/europa/pd/${DESIGN}/block_build/dev_DFT_leo/build/fc/compile/results/${DESIGN}.insert_dft.v.gz
...
if { $CHECK_MANUAL_CHANGES == 0 } {
    ...
    source $env(DFT_HOME)/l2/Latest/tsdb/logic_test/tsdb_outdir/dft_inserted_designs/${DESIGN}_rtl2.dft_inserted_design/${DESIGN}.hierfix.sdc
