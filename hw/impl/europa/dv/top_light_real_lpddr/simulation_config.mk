...
TOP_PLATFORM_NAME := top_light_real_lpddr
...
GLOBAL_DEFINES += +define+AI_CORE_P_0_STUB
GLOBAL_DEFINES += +define+AI_CORE_P_1_STUB
GLOBAL_DEFINES += +define+AI_CORE_P_2_STUB
GLOBAL_DEFINES += +define+AI_CORE_P_3_STUB
GLOBAL_DEFINES += +define+AI_CORE_P_4_STUB
GLOBAL_DEFINES += +define+AI_CORE_P_5_STUB
GLOBAL_DEFINES += +define+AI_CORE_P_6_STUB
GLOBAL_DEFINES += +define+AI_CORE_P_7_STUB
...
GLOBAL_DEFINES += +define+PVE_P_1_STUB

GLOBAL_DEFINES += +define+REAL_LPDDR

#give some time for OTP model to power up
GLOBAL_DEFINES += +define+SOTP_SET_PWR_ON=3

REGRESS_VERIFSDK_PLATFORM=SIM_TOP_LIGHT_REAL_LPDDR

#allow the tests to take more that one hour
SIM_RUN_TIME_MINUTES=600
