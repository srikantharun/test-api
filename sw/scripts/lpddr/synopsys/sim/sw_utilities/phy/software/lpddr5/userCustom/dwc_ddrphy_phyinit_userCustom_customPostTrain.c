 ...
 * dwc_ddrphy_phyinit_userCustom_io_write32() function calls placed within this
 * function.
 *
 ...
 * by PhyInit or training firmware.
 *
 * @param[in] phyctx  Data structure to hold user-defined parameters
 *
 * @param[in] pstate  Current PState being executed
 *
 * \return void
 */
// coverity[misra_c_2012_rule_5_1_violation]
void dwc_ddrphy_phyinit_userCustom_customPostTrainPsLoop(phyinit_config_t *phyctx, int pstate)
{
	...
	dwc_ddrphy_phyinit_cmnt("-----------------------------------------------------\n");
	dwc_ddrphy_phyinit_cmnt("\n");
	dwc_ddrphy_phyinit_cmnt(" dwc_ddrphy_phyihunit_userCustom_customPostTrainPsLoop is a user-editable function.\n");
	dwc_ddrphy_phyinit_cmnt("\n");
	dwc_ddrphy_phyinit_cmnt(" See PhyInit App Note for detailed description and function usage\n");
	dwc_ddrphy_phyinit_cmnt("\n");
	dwc_ddrphy_phyinit_cmnt("-----------------------------------------------------\n");
