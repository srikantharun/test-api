...
// Module IDs
#define ODR_ID_D_ODR                                (MODULE_ID_D_ODR)
#define ODR_ID_M_ODR                                (MODULE_ID_M_ODR)

// Command Formats
#define ODR_COMMAND_FORMAT_ID_DEF_BASED                           (0)
#define ODR_COMMAND_FORMAT_ID_LINEAR                              (1)
#define ODR_COMMAND_FORMAT_ID_THREE_DIM_FALLBACK                  (2)
#define ODR_COMMAND_FORMAT_ID_OFFSET_DEF_BASED                    (3)
#define ODR_COMMAND_FORMAT_ID_FOUR_DIM_FALLBACK                   (4)
...
typedef module_command_header_t odr_command_header_t;

// Formats
//--------------------------------------------------

typedef struct {
  odr_command_header_t header;
  struct {
...
} odr_command_format_def_based_t;
...
} odr_command_format_three_dim_fallback_t;
...
} odr_command_format_offset_def_based_t;
...
} odr_command_format_four_dim_fallback_t;
...
typedef union {
  ...
  odr_command_format_def_based_t def_based;
  odr_command_format_linear_t linear;
  odr_command_format_three_dim_fallback_t three_dim_fallback;
  odr_command_format_offset_def_based_t offset_def_based;
  odr_command_format_four_dim_fallback_t four_dim_fallback;
} odr_command_t;
...
} odr_instruction_format_dim_def_t;
...
} odr_instruction_format_loop_def_t;

// Instructions
//--------------------------------------------------

typedef union {
  odr_instruction_format_dim_def_t dim_def;
  odr_instruction_format_loop_def_t loop_def;
} odr_instruction_t;
...
odr_status_t odr_init(void);

odr_status_t odr_enable_execution(odr_id_t odr_id);
odr_status_t odr_disable_execution(odr_id_t odr_id);
odr_status_t odr_poll_idle(odr_id_t odr_id);

odr_status_t odr_load_command(odr_id_t odr_id, odr_command_t* command);
odr_status_t odr_load_instructions(odr_id_t odr_id, odr_instruction_t instructions[], uint16_t count, uint16_t offset);
