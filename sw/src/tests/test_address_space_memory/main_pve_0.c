...
int main(void) {
  ...
  // run it for 1 pve_0_core since it takes approx 13min to run for each core.
  for (uint32_t pve_core = PVE_0_CLUSTER_0_CORE_0; pve_core < PVE_0_CLUSTER_0_CORE_1; pve_core++){
    start_core(pve_core);
