...
// name='task1' resource=['AI0'] instance='LP_DMA_AI0' type='SNPS_DW' mode='CSR' num_channels=1 channels=[0] source_address=['AICORE_0_L1_BASE'] destination_address=['AICORE_0_L1_BASE+0x8000'] burst_length=[64] osr=[15] src_xbytesize=[16384] dst_xbytesize=[16384] src_ms=[1] dst_ms=[1] src_xaddrinc=None dst_xaddrinc=None tran_size=None xtype=None fillval=None fillval_mode=None ytype=None src_yrowsize=None dst_yrowsize=None src_yaddrstride=None dst_yaddrstride=None
