...
#include <platform.h>
char *arrRef2569 = RANDOM_DATA_2569B;
char *arrInit2569 = INIT_DATA_2569B;
...
// name='task' resource=['AI0'] instance='HP_DMA_AI0' type='AXE' mode='CSR' num_channels=1 channels=[0] source_address=['AICORE_0_L1_BASE+0x11'] destination_address=['AICORE_0_L1_BASE+0x7896'] burst_length=[64] osr=[15] src_xbytesize=[2569] dst_xbytesize=[2569] src_ms=[1] dst_ms=[1] src_xaddrinc=[1] dst_xaddrinc=[1] tran_size=[0] xtype=[1] fillval=None fillval_mode=None ytype=[0] src_yrowsize=[0] dst_yrowsize=[0] src_yaddrstride=[0] dst_yaddrstride=[0]
...
// =============================
uint64_t src_xbytesize_0[] = { DATA_SIZE_2569B };
uint64_t dst_xbytesize_0[] = { DATA_SIZE_2569B };
...
// =============================
uintptr_t src_0[] =  {  (uintptr_t) AICORE_0_L1_BASE+0x11  };
uintptr_t dst_0[] =  {  (uintptr_t) AICORE_0_L1_BASE+0x7896  };
...
// ==================================
prepare_loc_array( (char * ) src_0[0], arrRef2569, DATA_SIZE_2569B );
// Execute DMA task
// =============================
...
// Perform data check
// =============================
check_mem_snapshot(arrRef2569, (char * ) dst_0[0], 0, DATA_SIZE_2569B, get_memory_region_name(dst_0[0]),0);
