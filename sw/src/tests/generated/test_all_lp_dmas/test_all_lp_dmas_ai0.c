...
uintptr_t dst_0[] =  {  (uintptr_t) AICORE_0_SPM_BASE+0x20000  };
...
// Execute DMA task
// =============================
test_snps_dma_multi_channel_sel("task_ai0",(snps_dmac_regs *)get_dma_base_addr("LP_DMA_AI0"), num_channels_0, dmac_ch_num_0, src_0, dst_0, ctl_flags_0, cfg_flags_0, tf_size_0, true);
