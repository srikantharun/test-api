...
// name='task_ai7' resource=['AI7'] instance='LP_DMA_AI7' type='SNPS_DW' mode='CSR' num_channels=1 channels=[0] source_address=['SYS_SPM_BASE'] destination_address=['AICORE_7_SPM_BASE+0x20000'] burst_length=[64] osr=[15] src_xbytesize=[16384] dst_xbytesize=[16384] src_ms=[0] dst_ms=[0] src_xaddrinc=None dst_xaddrinc=None tran_size=None xtype=None fillval=None fillval_mode=None ytype=None src_yrowsize=None dst_yrowsize=None src_yaddrstride=None dst_yaddrstride=None
...
uintptr_t dst_0[] =  {  (uintptr_t) AICORE_7_SPM_BASE+0x20000  };
...
// Execute DMA task
// =============================
test_snps_dma_multi_channel_sel("task_ai7",(snps_dmac_regs *)get_dma_base_addr("LP_DMA_AI7"), num_channels_0, dmac_ch_num_0, src_0, dst_0, ctl_flags_0, cfg_flags_0, tf_size_0, true);
