...
#include <platform.h>
char *arrRef2048 = RANDOM_DATA_2048B;
char *arrInit2048 = INIT_DATA_2048B;
...
// name='aligned_2d' resource=['AI0'] instance='HP_DMA_AI0' type='AXE' mode='CSR' num_channels=1 channels=[0] source_address=['AICORE_0_L1_BASE'] destination_address=['AICORE_0_L1_BASE+0x8000'] burst_length=[64] osr=[15] src_xbytesize=[2048] dst_xbytesize=[2048] src_ms=[1] dst_ms=[1] src_xaddrinc=[1] dst_xaddrinc=[1] tran_size=[0] xtype=[1] fillval=None fillval_mode=None ytype=[1] src_yrowsize=[2] dst_yrowsize=[2] src_yaddrstride=[32768] dst_yaddrstride=[32768]
...
// =============================
uint64_t src_xbytesize_0[] = { DATA_SIZE_2048B };
uint64_t dst_xbytesize_0[] = { DATA_SIZE_2048B };
...
uint64_t src_yaddrstride_0[] = {  32768  };
uint64_t dst_yaddrstride_0[] = {  32768  };
uint64_t src_ms_0[] = {  1  };
uint64_t dst_ms_0[] = {  1  };
uint64_t irq_en_0[] = {1};
...
prepare_loc_array( (char * ) src_0[0]+ i*src_yaddrstride_0[0], arrRef2048, DATA_SIZE_2048B );
}
// Execute DMA task
// =============================

test_axe_dma_multi_channel_sel("aligned_2d", &config_0, true);

// Perform data check
// =============================
for (uint64_t i = 0; i < dst_yrowsize_0[0]; i++) {
  check_mem_snapshot(arrRef2048, (char * ) dst_0[0]+ i*dst_yaddrstride_0[0], 0, DATA_SIZE_2048B, get_memory_region_name(dst_0[0]),0);
}
