...
// name='task' resource=['PVE0'] instance='HP_DMA0_PVE0' type='AXE' mode='CSR' num_channels=4 channels=[0, 1, 2, 3] source_address=['L2_MODULE_0_BASE', 'L2_MODULE_1_BASE', 'L2_MODULE_2_BASE', 'L2_MODULE_3_BASE'] destination_address=['L2_MODULE_4_BASE', 'L2_MODULE_5_BASE', 'L2_MODULE_6_BASE', 'L2_MODULE_7_BASE'] burst_length=[64, 64, 64, 64] osr=[15, 15, 15, 15] src_xbytesize=[512, 512, 512, 512] dst_xbytesize=[512, 512, 512, 512] src_ms=[0, 0, 1, 1] dst_ms=[0, 0, 1, 1] src_xaddrinc=[1, 1, 1, 1] dst_xaddrinc=[1, 1, 1, 1] tran_size=[0, 0, 0, 0] xtype=[1, 1, 1, 1] fillval=None fillval_mode=None ytype=[0, 0, 0, 0] src_yrowsize=[0, 0, 0, 0] dst_yrowsize=[0, 0, 0, 0] src_yaddrstride=[0, 0, 0, 0] dst_yaddrstride=[0, 0, 0, 0]
...
// ================================
// The task executed has the following command:
// name='task' resource=['PVE0'] instance='HP_DMA1_PVE0' type='AXE' mode='CSR' num_channels=4 channels=[0, 1, 2, 3] source_address=['L2_MODULE_0_BASE', 'L2_MODULE_1_BASE', 'L2_MODULE_2_BASE', 'L2_MODULE_3_BASE'] destination_address=['L2_MODULE_4_BASE', 'L2_MODULE_5_BASE', 'L2_MODULE_6_BASE', 'L2_MODULE_7_BASE'] burst_length=[64, 64, 64, 64] osr=[15, 15, 15, 15] src_xbytesize=[512, 512, 512, 512] dst_xbytesize=[512, 512, 512, 512] src_ms=[0, 0, 1, 1] dst_ms=[0, 0, 1, 1] src_xaddrinc=[1, 1, 1, 1] dst_xaddrinc=[1, 1, 1, 1] tran_size=[0, 0, 0, 0] xtype=[1, 1, 1, 1] fillval=None fillval_mode=None ytype=[0, 0, 0, 0] src_yrowsize=[0, 0, 0, 0] dst_yrowsize=[0, 0, 0, 0] src_yaddrstride=[0, 0, 0, 0] dst_yaddrstride=[0, 0, 0, 0]
