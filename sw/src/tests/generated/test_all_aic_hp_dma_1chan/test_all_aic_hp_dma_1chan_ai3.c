...
// =============================
uintptr_t src_0[] =  {  (uintptr_t) L2_MODULE_3_BASE  };
uintptr_t dst_0[] =  {  (uintptr_t) AICORE_3_L1_BASE  };

// Configure the DMA config
// =============================
axe_dma_config config_0 = {
     .dmac = (axe_dma_regs *)get_dma_base_addr("HP_DMA_AI3"),
