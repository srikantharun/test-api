...
// name='task' resource=['AI7'] instance='HP_DMA_AI7' type='AXE' mode='CSR' num_channels=1 channels=[0] source_address=['L2_MODULE_7_BASE'] destination_address=['AICORE_7_L1_BASE'] burst_length=[64] osr=[15] src_xbytesize=[4096] dst_xbytesize=[4096] src_ms=[0] dst_ms=[1] src_xaddrinc=[1] dst_xaddrinc=[1] tran_size=[0] xtype=[1] fillval=None fillval_mode=None ytype=[0] src_yrowsize=[0] dst_yrowsize=[0] src_yaddrstride=[0] dst_yaddrstride=[0]
...
// =============================
uintptr_t src_0[] =  {  (uintptr_t) L2_MODULE_7_BASE  };
uintptr_t dst_0[] =  {  (uintptr_t) AICORE_7_L1_BASE  };

// Configure the DMA config
// =============================
axe_dma_config config_0 = {
     .dmac = (axe_dma_regs *)get_dma_base_addr("HP_DMA_AI7"),
