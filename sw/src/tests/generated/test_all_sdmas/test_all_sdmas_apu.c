...
// name='task1' resource=['APU'] instance='SDMA0' type='AXE' mode='CSR' num_channels=4 channels=[0, 1, 2, 3] source_address=['L2_MODULE_0_BASE', 'L2_MODULE_1_BASE', 'L2_MODULE_2_BASE', 'L2_MODULE_3_BASE'] destination_address=['L2_MODULE_4_BASE', 'L2_MODULE_5_BASE', 'L2_MODULE_6_BASE', 'L2_MODULE_7_BASE'] burst_length=[64, 64, 64, 64] osr=[15, 15, 15, 15] src_xbytesize=[4096, 4096, 4096, 4096] dst_xbytesize=[4096, 4096, 4096, 4096] src_ms=[0, 0, 1, 1] dst_ms=[0, 0, 1, 1] src_xaddrinc=[1, 1, 1, 1] dst_xaddrinc=[1, 1, 1, 1] tran_size=[0, 0, 0, 0] xtype=[1, 1, 1, 1] fillval=None fillval_mode=None ytype=[0, 0, 0, 0] src_yrowsize=[0, 0, 0, 0] dst_yrowsize=[0, 0, 0, 0] src_yaddrstride=[0, 0, 0, 0] dst_yaddrstride=[0, 0, 0, 0]
...
// =============================
uint64_t src_xbytesize_0[] = { DATA_SIZE_4096B, DATA_SIZE_4096B, DATA_SIZE_4096B, DATA_SIZE_4096B };
uint64_t dst_xbytesize_0[] = { DATA_SIZE_4096B, DATA_SIZE_4096B, DATA_SIZE_4096B, DATA_SIZE_4096B };
...
axe_dma_config config_0 = {
     .dmac = (axe_dma_regs *)get_dma_base_addr("SDMA0"),
...
prepare_loc_array( (char * ) src_0[2], arrRef4096, DATA_SIZE_4096B );
prepare_loc_array( (char * ) src_0[3], arrRef4096, DATA_SIZE_4096B );
// Execute DMA task
// =============================
...
check_mem_snapshot(arrRef4096, (char * ) dst_0[2], 0, DATA_SIZE_4096B, get_memory_region_name(dst_0[2]),0);
check_mem_snapshot(arrRef4096, (char * ) dst_0[3], 0, DATA_SIZE_4096B, get_memory_region_name(dst_0[3]),0);


// Task description
// ================================
// The task executed has the following command:
// name='task2' resource=['APU'] instance='SDMA1' type='AXE' mode='CSR' num_channels=4 channels=[0, 1, 2, 3] source_address=['L2_MODULE_0_BASE', 'L2_MODULE_1_BASE', 'L2_MODULE_2_BASE', 'L2_MODULE_3_BASE'] destination_address=['L2_MODULE_4_BASE', 'L2_MODULE_5_BASE', 'L2_MODULE_6_BASE', 'L2_MODULE_7_BASE'] burst_length=[64, 64, 64, 64] osr=[15, 15, 15, 15] src_xbytesize=[4096, 4096, 4096, 4096] dst_xbytesize=[4096, 4096, 4096, 4096] src_ms=[0, 0, 1, 1] dst_ms=[0, 0, 1, 1] src_xaddrinc=[1, 1, 1, 1] dst_xaddrinc=[1, 1, 1, 1] tran_size=[0, 0, 0, 0] xtype=[1, 1, 1, 1] fillval=None fillval_mode=None ytype=[0, 0, 0, 0] src_yrowsize=[0, 0, 0, 0] dst_yrowsize=[0, 0, 0, 0] src_yaddrstride=[0, 0, 0, 0] dst_yaddrstride=[0, 0, 0, 0]
...
// Configure the transfer
// =============================
uint64_t src_xbytesize_1[] = { DATA_SIZE_4096B, DATA_SIZE_4096B, DATA_SIZE_4096B, DATA_SIZE_4096B };
uint64_t dst_xbytesize_1[] = { DATA_SIZE_4096B, DATA_SIZE_4096B, DATA_SIZE_4096B, DATA_SIZE_4096B };
...
axe_dma_config config_1 = {
     .dmac = (axe_dma_regs *)get_dma_base_addr("SDMA1"),
...
// Initialise source and destination
// ==================================
prepare_loc_array( (char * ) src_1[0], arrRef4096, DATA_SIZE_4096B );
prepare_loc_array( (char * ) src_1[1], arrRef4096, DATA_SIZE_4096B );
prepare_loc_array( (char * ) src_1[2], arrRef4096, DATA_SIZE_4096B );
prepare_loc_array( (char * ) src_1[3], arrRef4096, DATA_SIZE_4096B );
// Execute DMA task
// =============================

test_axe_dma_multi_channel_sel("task2", &config_1, true);

// Perform data check
// =============================
check_mem_snapshot(arrRef4096, (char * ) dst_1[0], 0, DATA_SIZE_4096B, get_memory_region_name(dst_1[0]),0);
check_mem_snapshot(arrRef4096, (char * ) dst_1[1], 0, DATA_SIZE_4096B, get_memory_region_name(dst_1[1]),0);
check_mem_snapshot(arrRef4096, (char * ) dst_1[2], 0, DATA_SIZE_4096B, get_memory_region_name(dst_1[2]),0);
check_mem_snapshot(arrRef4096, (char * ) dst_1[3], 0, DATA_SIZE_4096B, get_memory_region_name(dst_1[3]),0);
